# Microsoft.Security @ 2026-08-01-preview

## Resource Microsoft.Security/securityConnectors@2026-08-01-preview
...
## AwsCloudTrailConfiguration
### Properties
* **cloudTrailResourceSets**: [AwsCloudTrailResourceSet](#awscloudtrailresourceset)[]: The existing CloudTrail resource sets. Required when provisioningType is BringYourOwn.
* **deploymentRegion**: string: The AWS region in which the CloudTrail resources are provisioned. Required when
provisioningType is ManualProvisioning or AutoProvisioning.
* **provisioningType**: 'AutoProvisioning' | 'BringYourOwn' | 'ManualProvisioning' | string: The provisioning type for the CloudTrail resources
* **resourceNamePrefix**: string: The resource name prefix used when provisioning the CloudTrail resources

## AwsCloudTrailResourceSet
### Properties
* **kmsKeyArn**: string: The KMS key ARN used for CloudTrail log encryption
* **resourceRegion**: string: The AWS region of the resources in this set
* **s3BucketArn**: string: The S3 bucket ARN in which the CloudTrail logs are stored
* **sqsQueueArn**: string: The SQS queue ARN used for CloudTrail log notifications
...
#### Properties
* **agentlessServerlessPosture**: [DefenderCspmAwsOfferingAgentlessServerlessPosture](#defendercspmawsofferingagentlessserverlessposture): The Microsoft Defender agentless serverless posture configuration
...
* **serverlessContainers**: [DefenderCspmAwsOfferingServerlessContainers](#defendercspmawsofferingserverlesscontainers): The Microsoft Defender serverless containers configuration
...
#### Properties
* **ciem**: [DefenderCspmGcpOfferingCiem](#defendercspmgcpofferingciem): The GCP Defender CSPM Permissions Management configurations
...
* **containerAntiMalwareEnabled**: bool: Is defender anti-malware enabled
...
* **installationMethod**: 'Arc' | 'Helm' | string: The installation method for the Defender for Containers agent.
...
* **securityGatingEnabled**: bool: Is security gating enabled
...
## DefenderCspmAwsOfferingAgentlessServerlessPosture
### Properties
* **cloudRoleArn**: string: The cloud role ARN in AWS for this feature
* **enabled**: bool: Is agentless serverless posture enabled
...
* **cloudTrailAuditLogIngestion**: [AwsCloudTrailConfiguration](#awscloudtrailconfiguration): The CloudTrail audit log ingestion configuration
* **logCollectionOidc**: [DefenderCspmAwsOfferingCiemLogCollectionOidc](#defendercspmawsofferingciemlogcollectionoidc): The AWS log collection OIDC (open id connect) connection configuration

## DefenderCspmAwsOfferingCiemLogCollectionOidc
### Properties
* **cloudRoleArn**: string: The cloud role ARN in AWS used for the log collection oidc connection
...
* **securityFindingsEnabled**: bool: Is security findings enabled for container image assessment

## DefenderCspmAwsOfferingServerlessContainers
### Properties
* **enabled**: bool: Is serverless containers scanning enabled
...
## DefenderCspmGcpOfferingCiem
### Properties
* **ciemOidc**: [DefenderCspmGcpOfferingCiemOidc](#defendercspmgcpofferingciemoidc): The GCP Permissions Management OIDC (open id connect) connection configuration
* **gcpAuditLogIngestion**: [GcpAuditLogConfiguration](#gcpauditlogconfiguration): The GCP audit log ingestion configuration
* **logCollectionOidc**: [DefenderCspmGcpOfferingCiemOidc](#defendercspmgcpofferingciemoidc): The GCP log collection OIDC (open id connect) connection configuration
...
* **enableAuditLogIngestion**: bool: Is audit log ingestion enabled for the Permissions Management offering
...
## DefenderCspmGcpOfferingCiemOidc
### Properties
* **serviceAccountEmailAddress**: string: The service account email address in GCP for this feature
* **workloadIdentityProviderId**: string: The GCP workload identity provider id for this feature
...
## GcpAuditLogConfiguration
### Properties
* **provisioningType**: 'AutoProvisioning' | 'BringYourOwn' | 'ManualProvisioning' | string: The provisioning type for the GCP logging resources
* **resourceNamePrefix**: string: The resource name prefix used when provisioning the GCP logging resources. Required when
provisioningType is ManualProvisioning or AutoProvisioning.
* **resourceSets**: [GcpLoggingResourceSet](#gcploggingresourceset)[]: The existing GCP logging resource sets. Required when provisioningType is BringYourOwn.

## GcpLoggingResourceSet
### Properties
* **pubSubSubscriptionName**: string: The Pub/Sub subscription name in which the GCP logs are stored
