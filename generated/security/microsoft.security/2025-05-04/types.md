# Microsoft.Security @ 2025-05-04

## Resource Microsoft.Security/assessmentMetadata@2025-05-04
* **Valid Scope(s)**: Tenant (ReadOnly), Subscription
### Properties
* **apiVersion**: '2025-05-04' (ReadOnly, DeployTimeConstant): The resource api version
...
### Properties
* **assessmentType**: 'BuiltIn' | 'BuiltInPolicy' | 'Custom' | 'CustomPolicy' | 'CustomerManaged' | 'DynamicBuiltIn' | 'ManualBuiltIn' | 'ManualBuiltInPolicy' | 'ManualCustomPolicy' | 'Unknown' | 'VerifiedPartner' | string (Required): BuiltIn if the assessment based on built-in Azure Policy definition, Custom if the assessment based on custom Azure Policy definition
...
* **level**: 'Critical' | 'High' | 'Low' | 'Medium' | 'None' | string: The risk level
