# Microsoft.Cache @ 2026-05-01-preview

## Resource Microsoft.Cache/redisEnterprise@2026-05-01-preview
...
## Resource Microsoft.Cache/redisEnterprise/databases@2026-05-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string {pattern: "^(?=.{1,60}$)[A-Za-z0-9]+(-[A-Za-z0-9]+)*$"} (Required, DeployTimeConstant): The resource name
* **properties**: [DatabaseCreateProperties](#databasecreateproperties): Other properties of the database.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.Cache/redisEnterprise/databases' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.Cache/redisEnterprise/databases/accessPolicyAssignments@2026-05-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Cache/redisEnterprise/migrations@2026-05-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: 'default' (Required, DeployTimeConstant): The resource name
* **properties**: [MigrationProperties](#migrationproperties): Properties of the migration operation.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.Cache/redisEnterprise/migrations' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.Cache/redisEnterprise/privateEndpointConnections@2026-05-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Function listKeys (Microsoft.Cache/redisEnterprise/databases@2026-05-01-preview)
* **Resource**: Microsoft.Cache/redisEnterprise/databases
* **ApiVersion**: 2026-05-01-preview
* **Output**: [AccessKeys](#accesskeys)

## Function listSkusForScaling (Microsoft.Cache/redisEnterprise@2026-05-01-preview)
...
### Properties
* **accessPolicyName**: string {pattern: "^([a-zA-Z0-9][a-zA-Z0-9-]*[a-zA-Z0-9]|[a-zA-Z0-9])$"}: **Deprecated.** This property always returns "default". Use `accessString` to configure custom Redis ACL permissions instead.
* **accessString**: string: The Redis ACL permissions string applied to this assignment, for example `+@read ~cache:*`. Defaults to `+@all ~*` if not specified.
* **provisioningError**: [AccessPolicyAssignmentProvisioningError](#accesspolicyassignmentprovisioningerror) (ReadOnly): Provisioning error details when the access string failed to apply (e.g., invalid ACL syntax). Null when provisioning succeeded.
...
### Properties
* **code**: string (Required): Machine-readable error code (e.g., "InvalidAccessString").
* **message**: string (Required): Human-readable error message describing the failure.
* **target**: string: The property that caused the error (e.g., "properties.accessString").
...
* **publicNetworkAccess**: 'Disabled' | 'Enabled' | string (Required): Whether or not public network traffic can access the Redis cluster. Only 'Enabled' or 'Disabled' can be set. null is returned only for clusters created using an old API version which do not have this property and cannot be set.
...
* **resourceState**: 'CreateFailed' | 'Creating' | 'DeleteFailed' | 'Deleting' | 'DisableFailed' | 'Disabled' | 'Disabling' | 'EnableFailed' | 'Enabling' | 'Moving' | 'Running' | 'Scaling' | 'ScalingFailed' | 'UpdateFailed' | 'Updating' | string (ReadOnly): Current resource status of the cluster
...
* **clusteringPolicy**: 'EnterpriseCluster' | 'NoCluster' | 'OSSCluster' | string: Clustering policy - default is OSSCluster. This property can be updated only if the current value is NoCluster. If the value is OSSCluster or EnterpriseCluster, it cannot be updated without deleting the database.
...
* **resourceState**: 'CreateFailed' | 'Creating' | 'DeleteFailed' | 'Deleting' | 'DisableFailed' | 'Disabled' | 'Disabling' | 'EnableFailed' | 'Enabling' | 'Moving' | 'Running' | 'Scaling' | 'ScalingFailed' | 'UpdateFailed' | 'Updating' | string (ReadOnly): Current resource status of the database
...
## SkuDetailsList
### Properties
* **skus**: [SkuDetails](#skudetails)[]: List of SKUS available to scale up or scale down.
