# Microsoft.Relay @ 2026-07-01-preview

## Resource Microsoft.Relay/clusters@2026-07-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **location**: string (Required): The geo-location where the resource lives
* **name**: string {minLength: 6, maxLength: 50, pattern: "^(?!.*--)[a-zA-Z][a-zA-Z0-9-]{4,48}[a-zA-Z0-9]$"} (Required, DeployTimeConstant): The resource name
* **properties**: [RelayClusterProperties](#relayclusterproperties): The resource-specific properties for this resource.
* **sku**: [RelayClusterSku](#relayclustersku) (Required): The Relay cluster SKU.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **tags**: [TrackedResourceTags](#trackedresourcetags): Resource tags.
* **type**: 'Microsoft.Relay/clusters' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.Relay/namespaces@2026-07-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Relay/namespaces/authorizationRules@2026-07-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Relay/namespaces/hybridConnections@2026-07-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Relay/namespaces/hybridConnections/authorizationRules@2026-07-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Relay/namespaces/networkRuleSets@2026-07-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Relay/namespaces/privateEndpointConnections@2026-07-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Relay/namespaces/privateLinkResources@2026-07-01-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string (Required, DeployTimeConstant): The resource name
* **properties**: [PrivateLinkResourceProperties](#privatelinkresourceproperties) (ReadOnly): A resource that supports private link capabilities.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.Relay/namespaces/privateLinkResources' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.Relay/namespaces/wcfRelays@2026-07-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Relay/namespaces/wcfRelays/authorizationRules@2026-07-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Function listKeys (Microsoft.Relay/namespaces/authorizationRules@2026-07-01-preview)
* **Resource**: Microsoft.Relay/namespaces/authorizationRules
* **ApiVersion**: 2026-07-01-preview
* **Output**: [AccessKeys](#accesskeys)

## Function listKeys (Microsoft.Relay/namespaces/hybridConnections/authorizationRules@2026-07-01-preview)
* **Resource**: Microsoft.Relay/namespaces/hybridConnections/authorizationRules
* **ApiVersion**: 2026-07-01-preview
* **Output**: [AccessKeys](#accesskeys)

## Function listKeys (Microsoft.Relay/namespaces/wcfRelays/authorizationRules@2026-07-01-preview)
...
* **listenerCount**: int {maxValue: 25} (ReadOnly): The number of listeners for this hybrid connection. Note that min : 1 and max:25 are supported.
...
### Properties
* **metricId**: string (ReadOnly): The metric ID of the Relay cluster.
* **provisioningState**: 'Canceled' | 'Creating' | 'Deleting' | 'Failed' | 'Scaling' | 'Succeeded' | string (ReadOnly): The provisioning state of the Relay cluster.
* **status**: string (ReadOnly): The status of the Relay cluster.
* **supportsScaling**: bool (ReadOnly): Indicates whether the Relay cluster supports capacity scaling.
* **zoneRedundant**: bool: Indicates whether the Relay cluster was created as zone redundant.

## RelayClusterSku
### Properties
* **capacity**: int {minValue: 1}: The number of capacity units assigned to the Relay cluster.
* **name**: 'Dedicated' | string (Required): Name of the Relay cluster SKU.
* **tier**: 'Dedicated' | string: Tier of the Relay cluster SKU.
...
* **listenerCount**: int {maxValue: 25} (ReadOnly): The number of listeners for this relay. Note that min :1 and max:25 are supported.
