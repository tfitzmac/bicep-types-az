...
## Resource Microsoft.OperationalInsights/clusters@2026-03-01
...
## Resource Microsoft.OperationalInsights/queryPacks@2026-03-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.OperationalInsights/queryPacks/queries@2026-03-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.OperationalInsights/workspaces@2026-03-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.OperationalInsights/workspaces/dataExports@2026-03-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.OperationalInsights/workspaces/dataSources@2026-03-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.OperationalInsights/workspaces/linkedServices@2026-03-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.OperationalInsights/workspaces/linkedStorageAccounts@2026-03-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.OperationalInsights/workspaces/networkSecurityPerimeterConfigurations@2026-03-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.OperationalInsights/workspaces/savedSearches@2026-03-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.OperationalInsights/workspaces/storageInsightConfigs@2026-03-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.OperationalInsights/workspaces/summaryLogs@2026-03-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **identity**: [SummaryLogsIdentity](#summarylogsidentity): The managed identity of the summary logs resource. Only user-assigned identity is supported.
* **name**: string {pattern: "[^/]+"} (Required, DeployTimeConstant): The resource name
* **properties**: [SummaryLogsProperties](#summarylogsproperties): Summary rule properties.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.OperationalInsights/workspaces/summaryLogs' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.OperationalInsights/workspaces/tables@2026-03-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Column
### Properties
* **dataTypeHint**: 'armPath' | 'guid' | 'ip' | 'uri' | 'vector16' | string: Column data type logical hint.
...
* **principalId**: string (ReadOnly): The principal ID of resource identity.
* **tenantId**: string (ReadOnly): The tenant ID of resource.
* **type**: 'None' | 'UserAssigned' | string (Required): Type of managed service identity.
* **userAssignedIdentities**: [SummaryLogsIdentityUserAssignedIdentities](#summarylogsidentityuserassignedidentities): The list of user identities associated with the resource. The user identity dictionary key references will be ARM resource ids in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}'.

## SummaryLogsIdentityUserAssignedIdentities
### Properties
### Additional Properties
* **Additional Properties Type**: [SummaryLogsUserIdentityProperties](#summarylogsuseridentityproperties)
...
## TableProperties
### Properties
* **archiveRetentionInDays**: int (ReadOnly): The tables long-term retention in days. Calculated as (totalRetentionInDays-retentionInDays).
* **lastPlanModifiedDate**: string (ReadOnly): The timestamp that table plan was last modified (UTC).
* **plan**: 'Analytics' | 'Auxiliary' | 'Basic' | string: Instruct the system how to handle and charge the logs ingested to this table.
* **protectionLevel**: 'General' | 'Protected' | string: The protection level of the table. Determines the default data access isolation behavior.
...
* **retentionInDays**: int {minValue: 4, maxValue: 730}: In Analytics table: the tables analytics retention in days, between 4 and 730. Setting this property to -1 will default to the workspace retention. In Basic and Auxiliary table: read only property.
...
* **totalRetentionInDays**: int {minValue: 4, maxValue: 4383}: The table total retention in days, between 4 and 4383. Setting this property to -1 will default to retentionInDays.
...
## WorkspaceFeatures
### Properties
* **associations**: string[] (ReadOnly): List of associations for the workspace. Indicates if the workspace is associated with any of the following experiences: MDC, Sentinel, SentinelGraph, etc.
* **clusterResourceId**: string: Dedicated LA cluster resourceId that is linked to the workspaces.
* **dataAuthorizationMode**: bool: Enable Data authorization mode for the workspace.
...
* **publicNetworkAccessForIngestion**: 'Disabled' | 'Enabled' | 'SecuredByPerimeter' | string: The network access type for accessing Log Analytics ingestion.
* **publicNetworkAccessForQuery**: 'Disabled' | 'Enabled' | 'SecuredByPerimeter' | string: The network access type for accessing Log Analytics query.
