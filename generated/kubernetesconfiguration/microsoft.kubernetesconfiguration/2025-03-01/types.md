...
## Resource Microsoft.KubernetesConfiguration/extensions@2025-03-01
...
## AccessDetail
### Properties
* **allowedActions**: string[]: The list of allowed actions for the entity
* **description**: string: The description of the entity
* **entity**: string: The entity to which the access details apply

## AdditionalDetails
### Properties
* **docs**: string: Documentation for the extension.
* **releaseNotes**: string: Release Notes of the extension.
* **troubleshootingGuide**: string: Troubleshooting guide for the extension.
...
## ExtensionProperties
### Properties
* **additionalDetails**: [AdditionalDetails](#additionaldetails): Additional details provided by the publisher of the extension.
...
* **autoUpgradeMode**: 'compatible' | 'none' | 'patch' | string: The upgrade mode for auto upgrade.
...
* **extensionState**: string (ReadOnly): State of the extension on the cluster.
...
* **managementDetails**: [ManagementDetails](#managementdetails): Management details of the extension
...
### Properties
* **clientId**: string: The client ID of resource identity.
* **objectId**: string: The object ID of resource identity.
* **principalId**: string (ReadOnly): The principal ID of resource identity.
* **resourceId**: string: The ID of the resource identity.
* **tenantId**: string (ReadOnly): The tenant ID of resource.
* **type**: 'SystemAssigned' | 'UserAssigned' | 'Workload' | string: The identity type.
...
## ManagementDetails
### Properties
* **accessDetails**: [AccessDetail](#accessdetail)[]: The list of access details of the managing entity
* **category**: string: The category of the managing entity
