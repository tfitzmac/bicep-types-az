# Microsoft.Kubernetes @ 2026-02-01-preview

## Resource Microsoft.Kubernetes/connectedClusters@2026-02-01-preview
...
## Function listClusterUserCredential (Microsoft.Kubernetes/connectedClusters@2026-02-01-preview)
...
* **inboundConnectivityState**: 'Connected' | 'Disconnected' | 'Unknown' | string (ReadOnly): Represents the health status inbound connectivity (relay connection and Kubernetes API).
