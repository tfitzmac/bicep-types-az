# Microsoft.ProviderHub @ 2026-02-01-preview

## Resource Microsoft.ProviderHub/providerMonitorSettings@2026-02-01-preview
...
## Resource Microsoft.ProviderHub/providerRegistrations@2026-02-01-preview
...
## Resource Microsoft.ProviderHub/providerRegistrations/authorizedApplications@2026-02-01-preview
* **Valid Scope(s)**: Subscription
### Properties
* **apiVersion**: '2026-02-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ProviderHub/providerRegistrations/customRollouts@2026-02-01-preview
* **Valid Scope(s)**: Subscription
### Properties
* **apiVersion**: '2026-02-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ProviderHub/providerRegistrations/defaultRollouts@2026-02-01-preview
* **Valid Scope(s)**: Subscription
### Properties
* **apiVersion**: '2026-02-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ProviderHub/providerRegistrations/manifests@2026-02-01-preview
* **Valid Scope(s)**: Subscription
### Properties
* **apiVersion**: '2026-02-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string (Required, DeployTimeConstant): The resource name
* **properties**: [ManifestInfoProperties](#manifestinfoproperties): The manifest properties.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.ProviderHub/providerRegistrations/manifests' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.ProviderHub/providerRegistrations/notificationRegistrations@2026-02-01-preview
* **Valid Scope(s)**: Subscription
### Properties
* **apiVersion**: '2026-02-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ProviderHub/providerRegistrations/operations@2026-02-01-preview
* **Valid Scope(s)**: Subscription
### Properties
* **apiVersion**: '2026-02-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ProviderHub/providerRegistrations/resourcetypeRegistrations@2026-02-01-preview
* **Valid Scope(s)**: Subscription
### Properties
* **apiVersion**: '2026-02-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ProviderHub/providerRegistrations/resourcetypeRegistrations/resourcetypeRegistrations/resourcetypeRegistrations/resourcetypeRegistrations/skus@2026-02-01-preview
* **Valid Scope(s)**: Subscription
### Properties
* **apiVersion**: '2026-02-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ProviderHub/providerRegistrations/resourcetypeRegistrations/resourcetypeRegistrations/resourcetypeRegistrations/skus@2026-02-01-preview
* **Valid Scope(s)**: Subscription
### Properties
* **apiVersion**: '2026-02-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ProviderHub/providerRegistrations/resourcetypeRegistrations/resourcetypeRegistrations/skus@2026-02-01-preview
* **Valid Scope(s)**: Subscription
### Properties
* **apiVersion**: '2026-02-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ProviderHub/providerRegistrations/resourcetypeRegistrations/skus@2026-02-01-preview
* **Valid Scope(s)**: Subscription
### Properties
* **apiVersion**: '2026-02-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## ActionConfiguration
### Properties
* **authorizationAction**: string: Authorization action.
* **maxBatchSize**: int: The maximum batch size.
...
### Properties
* **excludeApplicationIdFromManifest**: bool: Exclude application id from 'providerAuthorizations' section of manifest?
...
## AppliedManifestInfo
### Properties
* **appliedCommitId**: string: Commit id of manifest being applied.
* **manifestAppliedAt**: string: Time at which the manifest was applied.
* **previousCommitId**: string: Commit id of previous manifest.
* **region**: string: Region to which the manifest was applied.
...
* **manifestCheckinSpecification**: [ManifestCheckinSpecification](#manifestcheckinspecification): The manifest checkin specification.
...
* **rolloutId**: string: The rollout id.
...
* **completedRegionsInfo**: [AppliedManifestInfo](#appliedmanifestinfo)[]: Information about the manifests applied to the completed regions.
...
* **redirectMapId**: string: The redirect map id.
* **requiredMembers**: string[] (Required): List of required members for the group id.
* **requiredZoneNames**: string[] (Required): List of required zone names for the group id.
...
* **options**: 'IgnoreEmptyStringLinkedType' | 'NotSpecified' | string (ReadOnly): The options for the linked access check.
...
* **qpsPloc**: [LocalizedOperationDisplayDefinitionQpsPloc](#localizedoperationdisplaydefinitionqpsploc): Display information of the operation for qps-Ploc pseudo locale.
...
### Properties
* **enabled**: bool: Indicates whether the deny assignment configuration is enabled.
* **notActions**: string[]: The actions excluded from the deny assignment.

## ManifestCheckinSpecification
### Properties
* **manifestCheckinOption**: 'AttemptAutomaticManifestCheckin' | 'DoNotAttemptAutomaticManifestCheckin' | string: The manifest checkin option.
* **manifestCheckinParams**: [CheckinManifestParams](#checkinmanifestparams): The manifest checkin params.

## ManifestInfoProperties
### Properties
* **commitId**: string (ReadOnly): The manifest commit identifier.
* **manifest**: string: The manifest.
* **manifestUri**: string (WriteOnly): The URI the manifest content is read from when the manifest is not supplied inline.
...
### Properties
* **groupConnectivityInformation**: [GroupConnectivityInformation](#groupconnectivityinformation)[] (Required): The list of group connectivity information.
* **minApiVersion**: string (Required): The first api version that support private endpoint.
...
* **enablePresetResourceTypes**: bool: Indicates whether automatic registration for the preset resource types is enabled or disabled.
...
* **lifecycleInfo**: [ResourceProviderLifecycleInfo](#resourceproviderlifecycleinfo): The resource provider lifecycle information.
...
* **oboSubscriptionId**: string: The on behalf of subscription id for the resource provider.
...
* **providerType**: 'AuthorizationFree' | 'Decommissioned' | 'External' | 'Hidden' | 'Internal' | 'LegacyRegistrationRequired' | 'NotSpecified' | 'RegistrationFree' | 'TenantOnly' | string: The provider type.
...
### Properties
* **policyName**: 'Cascade' | 'Force' | 'NotSpecified' | 'SoftDelete' | string: The resource deletion policy name.
* **properties**: [ResourceDeletionPolicyProperties](#resourcedeletionpolicyproperties): The resource deletion policy properties.

## ResourceDeletionPolicyProperties
### Properties
* **maximumRetentionTime**: string: The maximum retention time.
* **minimumRetentionTime**: string: The minimum retention time.
...
## ResourceProviderLifecycleInfo
### Properties
* **allowedSubscriptions**: string[]: The list of allowed subscriptions for this resource provider.
* **isolationType**: 'Private' | 'Public' | string: The isolation type.
* **lifecycleStage**: 'GA' | 'InDevelopment' | 'PrivatePreview' | 'PublicPreview' | 'Retired' | string: The lifecycle stage.
* **partnerCategory**: 'FirstParty' | 'ThirdParty' | string: The partner category.
...
* **featureApprovalClaims**: string[]: List of claims to approve or reject feature registration.
* **featureManagementOwners**: string[]: List of feature management owners.
...
* **resourceAccessPolicy**: 'NotSpecified' | string: The resource access policy.
...
### Properties
* **endpointUri**: string: The endpoint uri.
* **extensionCategories**: ('BestMatchOperationBegin' | 'NotSpecified' | 'ResourceBillingNotification' | 'ResourceCreationBegin' | 'ResourceCreationCompleted' | 'ResourceCreationValidate' | 'ResourceDeletionBegin' | 'ResourceDeletionCompleted' | 'ResourceDeletionValidate' | 'ResourceMoveBegin' | 'ResourceMoveCompleted' | 'ResourcePatchBegin' | 'ResourcePatchCompleted' | 'ResourcePatchValidate' | 'ResourcePostAction' | 'ResourceReadBegin' | 'ResourceReadValidate' | 'SubscriptionLifecycleNotification' | 'SubscriptionLifecycleNotificationDeletion' | string)[]: The extension categories.
* **timeout**: string: The timeout.
...
* **denyAssignmentConfiguration**: [ManagedResourceGroupDenyAssignmentConfiguration](#managedresourcegroupdenyassignmentconfiguration): The deny assignment configuration.
* **enabled**: bool: Indicates whether the managed resource group configuration is enabled.
* **resourceGroupLocationOverride**: string: The resource group location override.
...
* **lifecycleInfo**: [ResourceTypeLifecycleInfo](#resourcetypelifecycleinfo): The resource type lifecycle information.
...
* **managedResourceGroupConfiguration**: [ResourceTypeManagedResourceGroupConfiguration](#resourcetypemanagedresourcegroupconfiguration): The managed resource group configuration.
...
* **marketplaceType**: 'AddOn' | 'Bypass' | 'NotSpecified' | 'ProviderHub' | 'Store': The marketplace type.
...
* **privateEndpointConfiguration**: [PrivateEndpointConfiguration](#privateendpointconfiguration): The private endpoint configuration.
* **provisioningState**: 'Accepted' | 'Canceled' | 'Created' | 'Creating' | 'Deleted' | 'Deleting' | 'Failed' | 'MovingResources' | 'NotSpecified' | 'RolloutInProgress' | 'Running' | 'Succeeded' | 'TransientFailure' | string (ReadOnly): The provisioning state.
...
* **resourceDeletionPolicies**: [ResourceDeletionPolicyAndProperties](#resourcedeletionpolicyandproperties)[]: List of resource deletion policies added.
* **resourceDeletionPolicy**: 'Cascade' | 'CascadeDeleteAll' | 'CascadeDeleteProxyOnlyChildren' | 'Force' | 'NotSpecified' | string: The resource deletion policy.
...
* **superScaleEnabled**: bool: Indicates whether super scale is enabled.
...
* **tokenAuthConfiguration**: [TokenAuthConfiguration](#tokenauthconfiguration): The token auth configuration.
* **writeLock**: [WriteLockConfiguration](#writelockconfiguration): The write lock configuration.
...
### Properties
* **actionConfigurations**: [ActionConfiguration](#actionconfiguration)[]: Action Configurations.
* **batchContractVersion**: string: Batch contract version.
* **maxBatchSize**: int: The maximum batch size.
* **maxNestedBatchSize**: int: The maximum nested batch size.
* **requiredFeatures**: string[]: The required features.
...
### Properties
* **apiVersions**: string[]: The api versions.
* **lifecycleInfo**: [SwaggerSpecificationLifecycleInfo](#swaggerspecificationlifecycleinfo): The swagger specification lifecycle information.
* **swaggerSpecFolderUri**: string: The swagger spec folder uri.

## SwaggerSpecificationLifecycleInfo
### Properties
* **lifecycleStage**: 'GA' | 'InDevelopment' | 'PrivatePreview' | 'PublicPreview' | 'Retired' | string: The lifecycle stage.
...
## ThrottlingMetric
### Properties
* **bucketSize**: string: The bucket size.
...
### Properties
* **state**: 'Disabled' | 'Enabled' | string: The state of write lock feature. The feature will ensure a deterministic sequence of write-operation within and across the verbs. Also the feature will ensure that the semantics of synchronous and long-running operations are honored.
