# Microsoft.AAD @ 2026-08-31-preview

## Resource Microsoft.AAD/domainServices@2026-08-31-preview
...
## Resource Microsoft.AAD/domainServices/ouContainer@2026-08-31-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
...
* **syncOnPremSamAccountName**: 'Disabled' | 'Enabled' | string: A flag to determine whether the SyncOnPremSamAccountName feature is active. When enabled, the samAccountName attribute in Entra Domain Services is synchronized from the onPremisesSamAccountName attribute in Entra ID
* **tlsV1**: 'Disabled' | 'Enabled' | string: A flag to determine whether or not TlsV1 is enabled or disabled.

## DomainServiceProperties
### Properties
* **adminGroupObjectId**: string (ReadOnly): The object ID of the administrator group associated with the Domain Services deployment.
...
* **entitlementSourceMode**: 'CurrentThirdParty' | 'LegacyFirstParty' | string (ReadOnly): The source used for filtered synchronization group entitlements.
* **filteredSync**: 'Disabled' | 'Enabled' | string: Enabled or Disabled flag to turn on Group-based filtered sync
* **initialFilteredSyncGroupIds**: string[]: The group IDs used to initialize the filtered synchronization application app roles.
...
* **selfUnsuspendCounter**: int {minValue: 0, maxValue: 5} (ReadOnly): Number of times the customer has self-resumed the domain service. Valid values range from 0 to 5, where 5 is the maximum allowed count before further self-resume is denied and support intervention is required.
