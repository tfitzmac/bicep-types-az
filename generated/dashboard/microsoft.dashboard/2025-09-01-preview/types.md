# Microsoft.Dashboard @ 2025-09-01-preview

## Resource Microsoft.Dashboard/dashboards@2025-09-01-preview
...
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string {pattern: "^[a-zA-Z][a-z0-9A-Z-]{0,28}[a-z0-9A-Z]$"} (Required, DeployTimeConstant): The resource name
* **properties**: [DashboardDefinitionProperties](#dashboarddefinitionproperties): Properties specific to the dashboard definition resource.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.Dashboard/dashboards/dashboardDefinitions' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.Dashboard/grafana@2025-09-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-09-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Dashboard/grafana/integrationFabrics@2025-09-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-09-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Dashboard/grafana/managedPrivateEndpoints@2025-09-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-09-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Dashboard/grafana/privateEndpointConnections@2025-09-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-09-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Dashboard/grafana/privateLinkResources@2025-09-01-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-09-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
### Properties
* **provisioningState**: 'Accepted' | 'Canceled' | 'Creating' | 'Deleted' | 'Deleting' | 'Failed' | 'NotSpecified' | 'Succeeded' | 'Updating' | string (ReadOnly): The provisioning state of the dashboard definition resource.
* **serializedData**: string: The dashboard definition data in JSON format.
...
* **creatorCanAdmin**: 'Disabled' | 'Enabled' | string: The creator will have admin access for the Grafana instance.
