...
## Resource Microsoft.ComputeLimit/locations/features@2026-07-31 (ReadOnly)
* **Valid Scope(s)**: Subscription
### Properties
* **apiVersion**: '2026-07-31' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.ComputeLimit/locations/guestSubscriptions@2026-07-31
* **Valid Scope(s)**: Subscription
### Properties
* **apiVersion**: '2026-07-31' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ComputeLimit/locations/sharedLimitCaps@2026-07-31
* **Valid Scope(s)**: Subscription
### Properties
* **apiVersion**: '2026-07-31' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ComputeLimit/locations/sharedLimitCaps/memberCapOverrides@2026-07-31
* **Valid Scope(s)**: Subscription
### Properties
* **apiVersion**: '2026-07-31' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ComputeLimit/locations/sharedLimits@2026-07-31
* **Valid Scope(s)**: Subscription
### Properties
* **apiVersion**: '2026-07-31' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ComputeLimit/locations/trustedHostSubscriptions@2026-07-31
* **Valid Scope(s)**: Subscription
### Properties
* **apiVersion**: '2026-07-31' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string {pattern: "^[0-9a-fA-F]{8}(-[0-9a-fA-F]{4}){3}-[0-9a-fA-F]{12}$"} (Required, DeployTimeConstant): The resource name
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.ComputeLimit/locations/trustedHostSubscriptions' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.ComputeLimit/locations/vmFamilies@2026-07-31 (ReadOnly)
* **Valid Scope(s)**: Subscription
### Properties
* **apiVersion**: '2026-07-31' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
