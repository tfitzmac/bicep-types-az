# Microsoft.AVS @ 2026-03-01

## Resource Microsoft.AVS/privateClouds@2026-03-01
...
## Resource Microsoft.AVS/privateClouds/addons@2026-03-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AVS/privateClouds/authorizations@2026-03-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AVS/privateClouds/cloudLinks@2026-03-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AVS/privateClouds/clusters@2026-03-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AVS/privateClouds/clusters/datastores@2026-03-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AVS/privateClouds/clusters/hosts@2026-03-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AVS/privateClouds/clusters/placementPolicies@2026-03-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AVS/privateClouds/clusters/virtualMachines@2026-03-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AVS/privateClouds/globalReachConnections@2026-03-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AVS/privateClouds/hcxEnterpriseSites@2026-03-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AVS/privateClouds/iscsiPaths@2026-03-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AVS/privateClouds/licenses@2026-03-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: 'VmwareFirewall' | string (Required, DeployTimeConstant): The resource name
* **properties**: [LicenseProperties](#licenseproperties): The resource-specific properties for this resource.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.AVS/privateClouds/licenses' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.AVS/privateClouds/maintenances@2026-03-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string {pattern: "^[-\w\._]+$"} (Required, DeployTimeConstant): The resource name
* **properties**: [MaintenanceProperties](#maintenanceproperties) (ReadOnly): The resource-specific properties for this resource.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.AVS/privateClouds/maintenances' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.AVS/privateClouds/provisionedNetworks@2026-03-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AVS/privateClouds/pureStoragePolicies@2026-03-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AVS/privateClouds/scriptExecutions@2026-03-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AVS/privateClouds/scriptPackages@2026-03-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AVS/privateClouds/scriptPackages/scriptCmdlets@2026-03-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AVS/privateClouds/workloadNetworks@2026-03-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AVS/privateClouds/workloadNetworks/dhcpConfigurations@2026-03-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AVS/privateClouds/workloadNetworks/dnsServices@2026-03-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AVS/privateClouds/workloadNetworks/dnsZones@2026-03-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AVS/privateClouds/workloadNetworks/gateways@2026-03-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AVS/privateClouds/workloadNetworks/portMirroringProfiles@2026-03-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AVS/privateClouds/workloadNetworks/publicIPs@2026-03-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AVS/privateClouds/workloadNetworks/segments@2026-03-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AVS/privateClouds/workloadNetworks/virtualMachines@2026-03-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AVS/privateClouds/workloadNetworks/vmGroups@2026-03-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Function listAdminCredentials (Microsoft.AVS/privateClouds@2026-03-01)
* **Resource**: Microsoft.AVS/privateClouds
* **ApiVersion**: 2026-03-01
* **Output**: [AdminCredentials](#admincredentials)

## Function listZones (Microsoft.AVS/privateClouds/clusters@2026-03-01)
...
### Properties
* **endsAt**: string (Required, ReadOnly): End date Time
* **reason**: string (ReadOnly): Reason category for blocking maintenance reschedule
* **startsAt**: string (Required, ReadOnly): Start date time
...
#### Properties
* **kind**: 'WindowsServer' (Required): License kind
...
* **licenses**: [HostLicense](#hostlicense)[]: The licenses assigned to the host.
...
### Properties
* **errors**: [ImpactedMaintenanceResourceError](#impactedmaintenanceresourceerror)[] (ReadOnly): A list of errors associated with the impacted resource
* **id**: string (ReadOnly): The ID of the impacted resource

## ImpactedMaintenanceResourceError
### Properties
* **actionRequired**: bool (ReadOnly): Indicates whether action is required by the customer
* **details**: string (ReadOnly): Additional details about the error
* **errorCode**: string (ReadOnly): The error code
* **name**: string (ReadOnly): The name of the error
* **resolutionSteps**: string[] (ReadOnly): Steps to resolve the error
...
## Label
### Properties
* **key**: string {minLength: 1} (Required): The key of the label.
* **value**: string {minLength: 1} (Required): The value of the label.

## LicenseProperties
* **Discriminator**: kind

### Base Properties
* **provisioningState**: 'Canceled' | 'Failed' | 'Succeeded' | string (ReadOnly): The state of the license provisioning

### VmwareFirewallLicenseProperties
#### Properties
* **broadcomContractNumber**: string: The Broadcom contract number associated with the license.
* **broadcomSiteId**: string: The Broadcom site ID associated with the license.
* **cores**: int (Required): Number of cores included in the license, measured per hour
* **endDate**: string (Required): UTC datetime when the license expires
* **kind**: 'VmwareFirewall' (Required): License kind
* **labels**: [Label](#label)[]: Additional labels passed through for license reporting.
* **licenseKey**: string {sensitive}: License key


## MaintenanceActivity
### Properties
* **component**: string (Required, ReadOnly): The component on which the activity is performed
* **impact**: string (ReadOnly): Describes impact of the activity
* **infoLink**: string (ReadOnly): Optional link containing more details about the activity
* **kind**: 'Backup' | 'CertificateRotation' | 'Downgrade' | 'Upgrade' | string (Required, ReadOnly): The type of activity
* **version**: string (Required, ReadOnly): Target version of the component

## MaintenanceFailedCheck
### Properties
* **impactedResources**: [ImpactedMaintenanceResource](#impactedmaintenanceresource)[] (ReadOnly): A list of resources impacted by the failed check
* **name**: string (ReadOnly): The name of the failed check

## MaintenanceGroup
### Properties
* **id**: string (Required, ReadOnly): Unique identifier of the group
* **kind**: 'Consolidation' | 'Logical' | string (Required, ReadOnly): Type of the group
* **name**: string (Required, ReadOnly): Display name of the group
...
#### Properties
* **disabledReason**: string (ReadOnly): Reason disabling refresh for maintenanceReadiness
* **isDisabled**: bool (ReadOnly): If maintenanceReadiness refresh is disabled
* **kind**: 'MaintenanceReadinessRefresh' (Required): The kind of operation
* **message**: string (ReadOnly): Additional message about the operation
* **refreshedByMicrosoft**: bool (ReadOnly): Indicates if the operation was refreshed by Microsoft
* **status**: 'Failed' | 'InProgress' | 'NotApplicable' | 'NotStarted' | string (ReadOnly): Status of the operation

### RescheduleOperation
#### Properties
* **constraints**: [RescheduleOperationConstraint](#rescheduleoperationconstraint)[] (ReadOnly): Constraints for rescheduling maintenance
* **disabledReason**: string (ReadOnly): Reason for reschedule disabled
* **isDisabled**: bool (ReadOnly): If rescheduling is disabled
* **kind**: 'Reschedule' (Required): The kind of operation
* **recommendation**: [MaintenanceRecommendation](#maintenancerecommendation) (ReadOnly): Recommendations for rescheduling maintenance

### ScheduleOperation
#### Properties
* **constraints**: [ScheduleOperationConstraint](#scheduleoperationconstraint)[] (ReadOnly): Constraints for scheduling maintenance
* **disabledReason**: string (ReadOnly): Reason for schedule disabled
* **isDisabled**: bool (ReadOnly): If scheduling is disabled
* **kind**: 'Schedule' (Required): The kind of operation
* **recommendation**: [MaintenanceRecommendation](#maintenancerecommendation) (ReadOnly): Recommendations for scheduling maintenance


## MaintenanceProperties
### Properties
* **activities**: [MaintenanceActivity](#maintenanceactivity)[] (ReadOnly): Activities performed as part of maintenance
* **clusterId**: int (ReadOnly): Cluster ID for on which maintenance will be applied. Empty if maintenance is at private cloud level
* **component**: 'ESXI' | 'NSXT' | 'VCSA' | string (ReadOnly): type of maintenance
* **displayName**: string (ReadOnly): Display name for maintenance
* **estimatedDurationInMinutes**: int (ReadOnly): Estimated time maintenance will take in minutes
* **group**: [MaintenanceGroup](#maintenancegroup) (ReadOnly): Group details if maintenance is part of a group
* **impact**: string (ReadOnly): Impact on the resource during maintenance period
* **infoLink**: string (ReadOnly): Link to maintenance info
* **maintenanceReadiness**: [MaintenanceReadiness](#maintenancereadiness) (ReadOnly): Indicates whether the maintenance is ready to proceed
* **operations**: [MaintenanceManagementOperation](#maintenancemanagementoperation)[] (ReadOnly): Operations on  maintenance
* **provisioningState**: 'Canceled' | 'Failed' | 'Succeeded' | 'Updating' | string (ReadOnly): The provisioning state
* **relationships**: [MaintenanceRelationships](#maintenancerelationships) (ReadOnly): Relationships with other maintenances like dependencies and prerequisites
* **scheduledByMicrosoft**: bool (ReadOnly): If maintenance is scheduled by Microsoft
* **scheduledStartTime**: string (ReadOnly): Scheduled maintenance start time
* **state**: [MaintenanceState](#maintenancestate) (ReadOnly): The state of the maintenance

## MaintenanceReadiness
### Properties
* **failedChecks**: [MaintenanceFailedCheck](#maintenancefailedcheck)[] (ReadOnly): A list of failed checks, if any
* **lastUpdated**: string (ReadOnly): The timestamp of the last readiness update
* **message**: string (ReadOnly): A summary message of the readiness check result
* **status**: 'DataNotAvailable' | 'NotApplicable' | 'NotReady' | 'Ready' | string (Required, ReadOnly): The current readiness status of maintenance
* **type**: 'Precheck' | 'Preflight' | string (Required, ReadOnly): The type of maintenance readiness check

## MaintenanceRecommendation
### Properties
* **maintenanceWindows**: [MaintenanceWindowRecommendation](#maintenancewindowrecommendation)[] (ReadOnly): List of recommended maintenance windows

## MaintenanceRelationships
### Properties
* **dependencies**: string[] (ReadOnly): List of dependent group identifiers
* **prerequisites**: string[] (ReadOnly): List of prerequisite group identifiers

## MaintenanceState
### Properties
* **endedAt**: string: Time when current state ended
* **message**: string: Failure/Success info
* **name**: 'Canceled' | 'Failed' | 'InProgress' | 'NotScheduled' | 'Scheduled' | 'Success' | string: Customer presentable maintenance state
* **startedAt**: string: Time when current state started

## MaintenanceWindowRecommendation
### Properties
* **reason**: string (ReadOnly): Reason for recommending this window
* **startTime**: string (Required, ReadOnly): Recommended start time for maintenance
...
* **vcfLicense**: [VcfLicense](#vcflicense): The private cloud license
...
#### Properties
* **endsAt**: string (Required, ReadOnly): End date Time
* **kind**: 'AvailableWindowForMaintenance' (Required): The kind of operation
* **startsAt**: string (Required, ReadOnly): Start date time

### BlockedWhileRescheduleOperation
#### Properties
* **category**: 'HiPriorityEvent' | 'Holiday' | 'OverlappingMaintenance' | 'QuotaExhausted' | string (Required, ReadOnly): Category of blocked date
* **kind**: 'Blocked' (Required): The kind of operation
* **timeRanges**: [BlockedDatesConstraintTimeRange](#blockeddatesconstrainttimerange)[] (ReadOnly): Date ranges blocked for schedule

### ReschedulingWindowConstraint
#### Properties
* **endsAt**: string (Required, ReadOnly): End date Time
* **kind**: 'ReschedulingWindow' (Required): The kind of operation
* **startsAt**: string (Required, ReadOnly): Start date time

### WeekendReschedulingConstraint
#### Properties
* **disabledReason**: string (ReadOnly): Reason why weekend rescheduling is disabled
* **isDisabled**: bool (ReadOnly): Indicates if rescheduling is disabled on weekends
* **kind**: 'WeekendRescheduling' (Required): The kind of operation
...
#### Properties
* **endsAt**: string (Required, ReadOnly): End date Time
* **kind**: 'SchedulingWindow' (Required): The kind of operation
* **startsAt**: string (Required, ReadOnly): Start date time

### WeekendSchedulingConstraint
#### Properties
* **disabledReason**: string (ReadOnly): Reason why weekend scheduling is disabled
* **isDisabled**: bool (ReadOnly): Indicates if scheduling is disabled on weekends
* **kind**: 'WeekendScheduling' (Required): The kind of operation
...
* **broadcomContractNumber**: string: The Broadcom contract number associated with the license.
* **broadcomSiteId**: string: The Broadcom site ID associated with the license.
* **cores**: int (Required): Number of cores included in the license
* **endDate**: string (Required): UTC datetime when the license expires
* **kind**: 'vcf5' (Required): License kind
* **labels**: [Label](#label)[]: Additional labels passed through for license reporting.
* **licenseKey**: string {sensitive}: License key
