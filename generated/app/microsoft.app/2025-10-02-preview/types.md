# Microsoft.App @ 2025-10-02-preview

## Resource Microsoft.App/builders@2025-10-02-preview
...
## Resource Microsoft.App/builders/builds@2025-10-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-10-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.App/connectedEnvironments@2025-10-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-10-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.App/connectedEnvironments/certificates@2025-10-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-10-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.App/connectedEnvironments/daprComponents@2025-10-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-10-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.App/connectedEnvironments/storages@2025-10-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-10-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.App/containerApps@2025-10-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-10-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **extendedLocation**: [ExtendedLocation](#extendedlocation): The complex type of the extended location.
...
## Resource Microsoft.App/containerApps/authConfigs@2025-10-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-10-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.App/containerApps/builds@2025-10-02-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-10-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.App/containerApps/detectorProperties@2025-10-02-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-10-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
* **kind**: 'functionapp' | 'workflowapp' | string (ReadOnly): Metadata to represent the container app kind, representing if a container app is workflowapp or functionapp.
...
## Resource Microsoft.App/containerApps/detectorProperties/revisions@2025-10-02-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-10-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.App/containerApps/detectors@2025-10-02-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-10-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.App/containerApps/functions@2025-10-02-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-10-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string {pattern: "^[-\w\._\(\)]+$"} (Required, DeployTimeConstant): The resource name
* **properties**: [ContainerAppsFunctionProperties](#containerappsfunctionproperties) (ReadOnly): Function resource specific properties
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.App/containerApps/functions' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.App/containerApps/labelHistory@2025-10-02-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-10-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string {pattern: "^[-\w\._\(\)]+$"} (Required, DeployTimeConstant): The resource name
* **properties**: [LabelHistoryProperties](#labelhistoryproperties) (ReadOnly): Container App Label History resource specific properties
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.App/containerApps/labelHistory' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.App/containerApps/patches@2025-10-02-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-10-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.App/containerApps/resiliencyPolicies@2025-10-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-10-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.App/containerApps/revisions@2025-10-02-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-10-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.App/containerApps/revisions/functions@2025-10-02-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-10-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
* **properties**: [ContainerAppsFunctionProperties](#containerappsfunctionproperties) (ReadOnly): Function resource specific properties
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.App/containerApps/revisions/functions' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.App/containerApps/revisions/replicas@2025-10-02-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-10-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.App/containerApps/sourcecontrols@2025-10-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-10-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.App/jobs@2025-10-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-10-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **extendedLocation**: [ExtendedLocation](#extendedlocation): The complex type of the extended location.
...
## Resource Microsoft.App/jobs/detectorProperties@2025-10-02-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-10-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **extendedLocation**: [ExtendedLocation](#extendedlocation) (ReadOnly): The complex type of the extended location.
...
## Resource Microsoft.App/jobs/detectors@2025-10-02-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-10-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.App/jobs/executions@2025-10-02-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-10-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.App/logicApps@2025-10-02-preview
...
## Resource Microsoft.App/logicApps/workflows@2025-10-02-preview (ReadOnly)
* **Valid Scope(s)**: Extension
### Properties
* **apiVersion**: '2025-10-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **kind**: 'Agentic' | 'Stateful' | 'Stateless' | string (ReadOnly): Gets the logic app hybrid workflow kind.
* **name**: string {minLength: 3, maxLength: 63, pattern: "^[a-z][a-z0-9]*$"} (Required, DeployTimeConstant): The resource name
* **properties**: [WorkflowEnvelopeProperties](#workflowenvelopeproperties) (ReadOnly): Additional workflow properties.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.App/logicApps/workflows' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.App/managedEnvironments@2025-10-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-10-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.App/managedEnvironments/certificates@2025-10-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-10-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.App/managedEnvironments/daprComponents@2025-10-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-10-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.App/managedEnvironments/daprComponents/resiliencyPolicies@2025-10-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-10-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.App/managedEnvironments/daprSubscriptions@2025-10-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-10-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.App/managedEnvironments/detectorProperties@2025-10-02-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-10-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.App/managedEnvironments/detectors@2025-10-02-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-10-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.App/managedEnvironments/dotNetComponents@2025-10-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-10-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.App/managedEnvironments/httpRouteConfigs@2025-10-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-10-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string {minLength: 3, maxLength: 63, pattern: "^[a-z][a-z0-9]*$"} (Required, DeployTimeConstant): The resource name
* **properties**: [HttpRouteConfigProperties](#httprouteconfigproperties): Http Route Config properties
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.App/managedEnvironments/httpRouteConfigs' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.App/managedEnvironments/javaComponents@2025-10-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-10-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.App/managedEnvironments/maintenanceConfigurations@2025-10-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-10-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string {pattern: "^[-\w\._\(\)]+$"} (Required, DeployTimeConstant): The resource name
* **properties**: [ScheduledEntries](#scheduledentries): The resource-specific properties for this resource.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.App/managedEnvironments/maintenanceConfigurations' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.App/managedEnvironments/managedCertificates@2025-10-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-10-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.App/managedEnvironments/privateEndpointConnections@2025-10-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-10-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.App/managedEnvironments/storages@2025-10-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-10-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.App/sessionPools@2025-10-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-10-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Function listCustomHostNameAnalysis (Microsoft.App/containerApps@2025-10-02-preview)
* **Resource**: Microsoft.App/containerApps
* **ApiVersion**: 2025-10-02-preview
* **Output**: [CustomHostnameAnalysisResult](#customhostnameanalysisresult)

## Function listSecrets (Microsoft.App/containerApps@2025-10-02-preview)
* **Resource**: Microsoft.App/containerApps
* **ApiVersion**: 2025-10-02-preview
* **Output**: [SecretsCollection](#secretscollection)

## Function listSecrets (Microsoft.App/jobs@2025-10-02-preview)
* **Resource**: Microsoft.App/jobs
* **ApiVersion**: 2025-10-02-preview
* **Output**: [JobSecretsCollection](#jobsecretscollection)

## Function listSecrets (Microsoft.App/connectedEnvironments/daprComponents@2025-10-02-preview)
* **Resource**: Microsoft.App/connectedEnvironments/daprComponents
* **ApiVersion**: 2025-10-02-preview
* **Output**: [DaprSecretsCollection](#daprsecretscollection)

## Function listSecrets (Microsoft.App/managedEnvironments/daprComponents@2025-10-02-preview)
* **Resource**: Microsoft.App/managedEnvironments/daprComponents
* **ApiVersion**: 2025-10-02-preview
* **Output**: [DaprSecretsCollection](#daprsecretscollection)

## Function listWorkflowsConnections (Microsoft.App/logicApps@2025-10-02-preview)
...
* **accountKeyVaultProperties**: [SecretKeyVaultProperties](#secretkeyvaultproperties): Storage account key stored as an Azure Key Vault secret.
...
* **provisioningState**: 'Canceled' | 'DeleteFailed' | 'Deleting' | 'Failed' | 'Pending' | 'Succeeded' | string (ReadOnly): Provisioning state of the certificate.
...
* **revisionTransitionThreshold**: int {minValue: 1, maxValue: 100}: Optional. The percent of the total number of replicas that must be brought up before revision transition occurs. Defaults to 100 when none is given. Value must be greater than 0 and less than or equal to 100.
...
* **deploymentErrors**: string (ReadOnly): Any errors that occurred during deployment or deployment validation
* **provisioningState**: 'Canceled' | 'Deleting' | 'Failed' | 'InProgress' | 'Succeeded' | string (ReadOnly): Provisioning state of the storage.
...
* **runningStatus**: 'Progressing' | 'Ready' | 'Running' | 'Stopped' | 'Suspended' | string (ReadOnly): Running status of the Container App.
...
### Properties
* **invokeUrlTemplate**: string (ReadOnly): Invoke URL for the function.
...
* **gpu**: int: Required GPU in cores for GPU based app, e.g. 1.0
...
## CustomDomain
### Properties
* **bindingType**: 'Auto' | 'Disabled' | 'SniEnabled' | string: Custom Domain binding type.
...
## Dapr
### Properties
* **appHealth**: [DaprAppHealth](#daprapphealth): Dapr application health check configuration
...
* **maxConcurrency**: int: Maximum number of concurrent requests, events handled by the Dapr sidecar

## DaprAppHealth
### Properties
* **enabled**: bool: Boolean indicating if the health probe is enabled
* **path**: string: Path for the health probe
* **probeIntervalSeconds**: int {minValue: 1}: Interval for the health probe in seconds
* **probeTimeoutMilliseconds**: int {minValue: 1}: Timeout for the health probe in milliseconds
* **threshold**: int {minValue: 1}: Threshold for the health probe
...
### Properties
* **keyVaultConfiguration**: [DiskEncryptionConfigurationKeyVaultConfiguration](#diskencryptionconfigurationkeyvaultconfiguration): The Key Vault that contains your key to use for disk encryption. The Key Vault must be in the same region as the Managed Environment.

## DiskEncryptionConfigurationKeyVaultConfiguration
### Properties
* **auth**: [DiskEncryptionConfigurationKeyVaultConfigurationAuth](#diskencryptionconfigurationkeyvaultconfigurationauth): Configuration properties for the authentication to the Key Vault
* **keyUrl**: string: Key URL pointing to a key in KeyVault. Version segment of the Url is required.

## DiskEncryptionConfigurationKeyVaultConfigurationAuth
### Properties
* **identity**: string: Resource ID of a user-assigned managed identity to authenticate to the Key Vault. The identity must be assigned to the managed environment, in the same tenant as the Key Vault, and it must have the following key permissions on the Key Vault: wrapkey, unwrapkey, get.
...
### Properties
* **lifecycleConfiguration**: [LifecycleConfiguration](#lifecycleconfiguration): The lifecycle configuration of a session in the dynamic session pool
...
## HttpRoute
### Properties
* **action**: [HttpRouteAction](#httprouteaction): Once route is matched, what is the desired action
* **match**: [HttpRouteMatch](#httproutematch): Conditions route will match on

## HttpRouteAction
### Properties
* **prefixRewrite**: string: Rewrite prefix, default is no rewrites
...
## HttpRouteMatch
### Properties
* **caseSensitive**: bool: path case sensitive, default is true
* **path**: string: match on exact path
* **pathSeparatedPrefix**: string: match on all prefix's. Not exact
* **prefix**: string: match on all prefix's. Not exact

## HttpRouteProvisioningErrors
### Properties
* **message**: string (ReadOnly): Description or error message
* **timestamp**: string (ReadOnly): Timestamp error occured at

## HttpRouteRule
### Properties
* **description**: string: Description of rule. Optional.
* **routes**: [HttpRoute](#httproute)[]: Routing configuration that will allow matches on specific paths/headers.
* **targets**: [HttpRouteTarget](#httproutetarget)[]: Targets- container apps, revisions, labels
...
### Properties
* **headerCountLimit**: int: Maximum number of headers per request allowed by the ingress. Must be at least 1. Defaults to 100.
* **requestIdleTimeout**: int: Duration (in minutes) before idle requests are timed out. Must be between 4 and 30 inclusive. Defaults to 4 minutes.
* **terminationGracePeriodSeconds**: int: Time (in seconds) to allow active connections to complete on termination. Must be between 0 and 3600. Defaults to 480 seconds.
* **workloadProfileName**: string: Name of the workload profile used by the ingress component. Required.
...
* **message**: string (ReadOnly): Human readable message indicating details about the current condition of the job execution.
* **reason**: string (ReadOnly): Reason for the current condition of job execution.
...
### Properties
* **records**: [LabelHistoryRecordItem](#labelhistoryrecorditem)[] (ReadOnly): List of label history records.

## LabelHistoryRecordItem
### Properties
* **revision**: string (ReadOnly): Container App revision name that label was applied to.
* **start**: string (ReadOnly): Timestamp describing when the label was applied to the revision.
* **status**: 'Failed' | 'Starting' | 'Succeeded' | string (ReadOnly): Status of the label history record.
* **stop**: string (ReadOnly): Timestamp describing when the label was removed from the revision. Only meaningful when the label is currently applied to the revision.

## LifecycleConfiguration
### Properties
* **cooldownPeriodInSeconds**: int: The cooldown period of a session in seconds when the lifecycle type is 'Timed'.
* **lifecycleType**: 'OnContainerExit' | 'Timed' | string: The lifecycle type of the session pool.
* **maxAlivePeriodInSeconds**: int: The maximum alive period of a session in seconds when the lifecycle type is 'OnContainerExit'.
...
* **availabilityZones**: string[]: The list of availability zones to use for managed environment
* **customDomainConfiguration**: [CustomDomainConfiguration](#customdomainconfiguration): Custom domain configuration for the environment
* **daprAIConnectionString**: string {sensitive}: Application Insights connection string used by Dapr to export Service to Service communication telemetry
...
* **defaultDomain**: string (ReadOnly): Default Domain Name for the cluster
* **deploymentErrors**: string (ReadOnly): Any errors that occurred during deployment or deployment validation
* **diskEncryptionConfiguration**: [DiskEncryptionConfiguration](#diskencryptionconfiguration): Disk encryption configuration for the Managed Environment.
...
* **ingressConfiguration**: [IngressConfiguration](#ingressconfiguration): Ingress configuration for the Managed Environment.
...
* **privateLinkDefaultDomain**: string (ReadOnly): Private Link Default Domain Name for the environment
...
## McpServerSettings
### Properties
* **isMcpServerApiKeyDisabled**: bool: Indicates whether the MCP server API key is disabled.
* **isMcpServerEnabled**: bool: Indicates whether the MCP server is enabled.
* **mcpServerEndpoint**: string (ReadOnly): The endpoint of the MCP server.
...
* **labels**: string[] (ReadOnly): List of labels assigned to this revision.
...
## ScheduledEntries
### Properties
* **scheduledEntries**: [ScheduledEntry](#scheduledentry)[] (Required): List of maintenance schedules for a managed environment.

## ScheduledEntry
### Properties
* **durationHours**: int (Required): Length of maintenance window range from 8 to 24 hours.
* **startHourUtc**: int (Required): Start hour after which managed environment maintenance can start from 0 to 23 hour.
* **weekDay**: 'Friday' | 'Monday' | 'Saturday' | 'Sunday' | 'Thursday' | 'Tuesday' | 'Wednesday' (Required): Day of the week when a managed environment can be patched.
...
### Properties
* **identity**: string: Resource ID of a managed identity to authenticate with Azure Key Vault, or System to use a system-assigned identity.
* **keyVaultUrl**: string: URL pointing to the Azure Key Vault secret.
...
* **image**: string: Container image tag.
* **name**: string: Custom container name.
* **probes**: [SessionProbe](#sessionprobe)[]: List of probes for the container.
...
* **managedIdentitySettings**: [ManagedIdentitySetting](#managedidentitysetting)[]: Optional settings for a Managed Identity that is assigned to the Session pool.
* **mcpServerSettings**: [McpServerSettings](#mcpserversettings): The MCP (Model Context Protocol) server settings of the session pool.
...
* **templateUpdateStatus**: [TemplateUpdateStatus](#templateupdatestatus) (ReadOnly): The template status of the session pool, showing active template, or desired template during session pool update. This is only available if the containerType is CustomContainer.
...
### Properties
* **failureThreshold**: int: Minimum consecutive failures for the probe to be considered failed after having succeeded. Defaults to 3. Minimum value is 1. Maximum value is 10.
* **httpGet**: [SessionProbeHttpGet](#sessionprobehttpget): HTTPGet specifies the http request to perform.
* **initialDelaySeconds**: int: Number of seconds after the container has started before liveness probes are initiated. Minimum value is 1. Maximum value is 60.
* **periodSeconds**: int: How often (in seconds) to perform the probe. Default to 10 seconds. Minimum value is 1. Maximum value is 240.
* **successThreshold**: int: Minimum consecutive successes for the probe to be considered successful after having failed. Defaults to 1. Must be 1 for liveness and startup. Minimum value is 1. Maximum value is 10.
* **tcpSocket**: [SessionProbeTcpSocket](#sessionprobetcpsocket): TCPSocket specifies an action involving a TCP port. TCP hooks not yet supported.
* **terminationGracePeriodSeconds**: int: Optional duration in seconds the pod needs to terminate gracefully upon probe failure. The grace period is the duration in seconds after the processes running in the pod are sent a termination signal and the time when the processes are forcibly halted with a kill signal. Set this value longer than the expected cleanup time for your process. If this value is nil, the pod's terminationGracePeriodSeconds will be used. Otherwise, this value overrides the value provided by the pod spec. Value must be non-negative integer. The value zero indicates stop immediately via the kill signal (no opportunity to shut down). This is an alpha field and requires enabling ProbeTerminationGracePeriod feature gate. Maximum value is 3600 seconds (1 hour)
* **timeoutSeconds**: int: Number of seconds after which the probe times out. Defaults to 1 second. Minimum value is 1. Maximum value is 240.
* **type**: 'Liveness' | 'Startup' | string: Denotes the type of probe. Can be Liveness or Startup, Readiness probe is not supported in sessions. Type must be unique for each probe within the context of a list of probes (SessionProbes).

## SessionProbeHttpGet
### Properties
* **host**: string: Host name to connect to, defaults to the pod IP. You probably want to set "Host" in httpHeaders instead.
* **httpHeaders**: [SessionProbeHttpGetHttpHeadersItem](#sessionprobehttpgethttpheadersitem)[]: Custom headers to set in the request. HTTP allows repeated headers.
* **path**: string: Path to access on the HTTP server.
* **port**: int (Required): Name or number of the port to access on the container. Number must be in the range 1 to 65535. Name must be an IANA_SVC_NAME.
* **scheme**: 'HTTP' | 'HTTPS' | string: Scheme to use for connecting to the host. Defaults to HTTP.
...
## TemplatePoolStatus
### Properties
* **allocatedCount**: int: The allocated count of pods in this pool
* **crashCount**: int: The crash count of pods in this pool
* **expectedCount**: int: The expected count of pods in this pool
* **imagePullFailCount**: int: The image pull fail count of pods in this pool
* **pendingCount**: int: The pending count of pods in this pool
* **readyCount**: int: The ready count of pods in this pool

## TemplateStatus
### Properties
* **containers**: [SessionContainer](#sessioncontainer)[]: List of container definitions for the sessions of this template.
* **createdTime**: string: The creation time of this template.
* **details**: string: The detailed status of this template.
* **ingress**: [SessionIngress](#sessioningress): Session pool ingress configuration of this template.
* **status**: [TemplatePoolStatus](#templatepoolstatus): The status of this template.

## TemplateUpdateStatus
### Properties
* **activeTemplate**: [TemplateStatus](#templatestatus): The status of the current active template.
* **desiredTemplate**: [TemplateStatus](#templatestatus): The status of the desired template during session pool update.
...
### Properties
* **id**: string (ReadOnly): Fully qualified resource ID for the resource. E.g. "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}"
* **kind**: 'Agentic' | 'Stateful' | 'Stateless' | string: Gets the logic app hybrid workflow kind.
* **name**: string (ReadOnly): The name of the resource
...
## WorkloadProfile
### Properties
* **enableFips**: bool: Whether to use a FIPS-enabled OS. Supported only for dedicated workload profiles.
