# Microsoft.IoTOperations @ 2026-07-01

## Resource Microsoft.IoTOperations/instances@2026-07-01
...
## Resource Microsoft.IoTOperations/instances/akriConnectorTemplates@2026-07-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.IoTOperations/instances/akriConnectorTemplates/connectors@2026-07-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01' (ReadOnly, DeployTimeConstant): The resource api version
* **extendedLocation**: [ExtendedLocation](#extendedlocation): Edge location of the resource.
...
## Resource Microsoft.IoTOperations/instances/akriServices@2026-07-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01' (ReadOnly, DeployTimeConstant): The resource api version
* **extendedLocation**: [ExtendedLocation](#extendedlocation): Edge location of the resource.
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string {minLength: 3, maxLength: 63, pattern: "^[a-z0-9][a-z0-9-]*[a-z0-9]$"} (Required, DeployTimeConstant): The resource name
* **properties**: [AkriServiceProperties](#akriserviceproperties): The resource-specific properties for this resource.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.IoTOperations/instances/akriServices' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.IoTOperations/instances/brokers@2026-07-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01' (ReadOnly, DeployTimeConstant): The resource api version
* **extendedLocation**: [ExtendedLocation](#extendedlocation): Edge location of the resource.
...
## Resource Microsoft.IoTOperations/instances/brokers/authentications@2026-07-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01' (ReadOnly, DeployTimeConstant): The resource api version
* **extendedLocation**: [ExtendedLocation](#extendedlocation): Edge location of the resource.
...
## Resource Microsoft.IoTOperations/instances/brokers/authorizations@2026-07-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01' (ReadOnly, DeployTimeConstant): The resource api version
* **extendedLocation**: [ExtendedLocation](#extendedlocation): Edge location of the resource.
...
## Resource Microsoft.IoTOperations/instances/brokers/listeners@2026-07-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01' (ReadOnly, DeployTimeConstant): The resource api version
* **extendedLocation**: [ExtendedLocation](#extendedlocation): Edge location of the resource.
...
## Resource Microsoft.IoTOperations/instances/dataflowEndpoints@2026-07-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01' (ReadOnly, DeployTimeConstant): The resource api version
* **extendedLocation**: [ExtendedLocation](#extendedlocation): Edge location of the resource.
...
## Resource Microsoft.IoTOperations/instances/dataflowProfiles@2026-07-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01' (ReadOnly, DeployTimeConstant): The resource api version
* **extendedLocation**: [ExtendedLocation](#extendedlocation): Edge location of the resource.
...
## Resource Microsoft.IoTOperations/instances/dataflowProfiles/dataflowGraphs@2026-07-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01' (ReadOnly, DeployTimeConstant): The resource api version
* **extendedLocation**: [ExtendedLocation](#extendedlocation): Edge location of the resource.
...
## Resource Microsoft.IoTOperations/instances/dataflowProfiles/dataflows@2026-07-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01' (ReadOnly, DeployTimeConstant): The resource api version
* **extendedLocation**: [ExtendedLocation](#extendedlocation): Edge location of the resource.
...
## Resource Microsoft.IoTOperations/instances/registryEndpoints@2026-07-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01' (ReadOnly, DeployTimeConstant): The resource api version
* **extendedLocation**: [ExtendedLocation](#extendedlocation): Edge location of the resource.
...
* **status**: [AkriConnectorStatus](#akriconnectorstatus) (ReadOnly): The status for the connector.
...
## AkriConnectorStatus
### Properties
* **healthState**: [ResourceHealthStatus](#resourcehealthstatus) (ReadOnly): The health state of the AkriConnector.
...
### Properties
* **command**: string[] (Required): The command to execute inside the container. Exit status of 0 is treated as healthy, non-zero is unhealthy.
...
### Properties
* **exec**: [AkriConnectorTemplateExecAction](#akriconnectortemplateexecaction): Exec specifies a command to execute in the container.
...
* **readinessProbe**: [AkriConnectorTemplateReadinessProbe](#akriconnectortemplatereadinessprobe): Optional readiness probe for the connector container. When set, the operator injects this into the pod spec and uses the pod's `Ready` condition for health reporting instead of crash-based detection.
...
### Properties
* **provisioningState**: 'Accepted' | 'Canceled' | 'Deleting' | 'Failed' | 'Provisioning' | 'Succeeded' | 'Updating' | string (ReadOnly): The status of the last operation.
* **status**: [AkriServiceStatus](#akriservicestatus) (ReadOnly): The status for the service.

## AkriServiceStatus
### Properties
* **healthState**: [ResourceHealthStatus](#resourcehealthstatus) (ReadOnly): The health state of the AkriService.
...
* **healthState**: 'Available' | 'Degraded' | 'Unavailable' | 'Unknown' | string (ReadOnly): The health state of the resource.
* **highPriorityMessagesBackpressureHandling**: 'Accept' | 'Reject' | string: Handling of high-priority messages in the event that regular-priority messages are being backpressured.
...
* **provisioningState**: 'Accepted' | 'Canceled' | 'Deleting' | 'Failed' | 'Provisioning' | 'Succeeded' | 'Updating' | string (ReadOnly): The status of the last operation.
* **status**: [BrokerStatus](#brokerstatus) (ReadOnly): The status for the broker.
...
## BrokerStatus
### Properties
* **healthState**: [ResourceHealthStatus](#resourcehealthstatus) (ReadOnly): The health state of the Broker.
...
* **status**: [DataflowGraphStatus](#dataflowgraphstatus) (ReadOnly): The status for the dataflow graph.
...
## DataflowGraphStatus
### Properties
* **healthState**: [ResourceHealthStatus](#resourcehealthstatus) (ReadOnly): The health state of the DataflowGraph.
...
* **provisioningState**: 'Accepted' | 'Canceled' | 'Deleting' | 'Failed' | 'Provisioning' | 'Succeeded' | 'Updating' | string (ReadOnly): The status of the last operation.
* **status**: [DataflowProfileStatus](#dataflowprofilestatus) (ReadOnly): The status for the dataflow profile.

## DataflowProfileStatus
### Properties
* **healthState**: [ResourceHealthStatus](#resourcehealthstatus) (ReadOnly): The health state of the DataflowProfile.
...
* **provisioningState**: 'Accepted' | 'Canceled' | 'Deleting' | 'Failed' | 'Provisioning' | 'Succeeded' | 'Updating' | string (ReadOnly): The status of the last operation.
* **requestDiskPersistence**: 'Disabled' | 'Enabled' | string: Disk persistence mode.
* **status**: [DataflowStatus](#dataflowstatus) (ReadOnly): The status for the dataflow.
...
## DataflowStatus
### Properties
* **healthState**: [ResourceHealthStatus](#resourcehealthstatus) (ReadOnly): The health state of the Dataflow.
