# Microsoft.StandbyPool @ 2026-04-01

## Resource Microsoft.StandbyPool/standbyContainerGroupPools@2026-04-01
...
## Resource Microsoft.StandbyPool/standbyContainerGroupPools/runtimeViews@2026-04-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.StandbyPool/standbyVirtualMachinePools@2026-04-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.StandbyPool/standbyVirtualMachinePools/runtimeViews@2026-04-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.StandbyPool/standbyVirtualMachinePools/standbyVirtualMachines@2026-04-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
* **provisioningState**: 'Canceled' | 'Deleting' | 'Failed' | 'Succeeded' | string (ReadOnly): The status of the last operation.
* **virtualMachineState**: 'Deallocated' | 'Hibernated' | 'Mix' | 'Running' | string (Required): Specifies the desired state of virtual machines in the pool.
* **vmStateDistribution**: [VmStateDistribution](#vmstatedistribution): Specifies the distribution of virtual machine states in the pool when virtualMachineState is set to Mix.
...
## VmStateDistribution
### Properties
* **deallocatedPercent**: int {minValue: 0, maxValue: 100}: Specifies the percentage of virtual machines in the Deallocated state in the standby pool.
* **hibernatedPercent**: int {minValue: 0, maxValue: 100}: Specifies the percentage of virtual machines in the Hibernated state in the standby pool.
* **runningPercent**: int {minValue: 0, maxValue: 100}: Specifies the percentage of virtual machines in the Running state in the standby pool.
