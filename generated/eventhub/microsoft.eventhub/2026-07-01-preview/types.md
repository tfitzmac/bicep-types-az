...
## Resource Microsoft.EventHub/clusters@2026-07-01-preview
...
## Resource Microsoft.EventHub/clusters/upgradePreferences@2026-07-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: 'default' (Required, DeployTimeConstant): The resource name
* **properties**: [UpgradePreferencesProperties](#upgradepreferencesproperties): Upgrade preference properties for the Event Hubs Dedicated cluster.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.EventHub/clusters/upgradePreferences' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.EventHub/namespaces@2026-07-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.EventHub/namespaces/applicationGroups@2026-07-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.EventHub/namespaces/authorizationRules@2026-07-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.EventHub/namespaces/disasterRecoveryConfigs@2026-07-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.EventHub/namespaces/disasterRecoveryConfigs/authorizationRules@2026-07-01-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.EventHub/namespaces/eventhubs@2026-07-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.EventHub/namespaces/eventhubs/authorizationRules@2026-07-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.EventHub/namespaces/eventhubs/consumergroups@2026-07-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.EventHub/namespaces/eventhubs/fabricShortcuts@2026-07-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
* **properties**: [FabricShortcutProperties](#fabricshortcutproperties): Properties of the Microsoft Fabric shortcut.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.EventHub/namespaces/eventhubs/fabricShortcuts' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.EventHub/namespaces/networkRuleSets@2026-07-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.EventHub/namespaces/networkSecurityPerimeterConfigurations@2026-07-01-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.EventHub/namespaces/privateEndpointConnections@2026-07-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.EventHub/namespaces/schemagroups@2026-07-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Function listKeys (Microsoft.EventHub/namespaces/disasterRecoveryConfigs/authorizationRules@2026-07-01-preview)
* **Resource**: Microsoft.EventHub/namespaces/disasterRecoveryConfigs/authorizationRules
* **ApiVersion**: 2026-07-01-preview
* **Output**: [AccessKeys](#accesskeys)

## Function listKeys (Microsoft.EventHub/namespaces/eventhubs/authorizationRules@2026-07-01-preview)
...
* **zoneRedundant**: bool: A value that indicates whether the cluster is zone redundant.
...
## ExceptionWindow
### Properties
* **action**: 'Allow' | 'Block' (Required): Whether the exception blocks or allows upgrades.
* **date**: string (Required): The UTC date on which the exception starts.
* **durationMinutes**: int {minValue: 480, maxValue: 1440} (Required): The exception duration in minutes. Allow exceptions must be between 480 and 1440 minutes in 60-minute increments. Block exceptions must be 1440 minutes.
* **startTimeOfDay**: string (Required): The UTC time of day at which the exception starts, represented as an ISO 8601 duration since midnight.

## FabricShortcutConfiguration
### Properties
* **artifactId**: string {minLength: 36, maxLength: 36, pattern: "^[0-9a-fA-F]{8}-([0-9a-fA-F]{4}-){3}[0-9a-fA-F]{12}$"} (Required): The Microsoft Fabric artifact ID.
* **artifactName**: string: The Microsoft Fabric artifact name.
* **logAnalyticsResourceId**: string: The resource ID of the Log Analytics workspace.
* **premiumCapacityId**: string: The Microsoft Fabric premium capacity ID.
* **tenantId**: string {minLength: 36, maxLength: 36, pattern: "^[0-9a-fA-F]{8}-([0-9a-fA-F]{4}-){3}[0-9a-fA-F]{12}$"} (Required): The Microsoft Fabric tenant ID.
* **workspaceId**: string {minLength: 36, maxLength: 36, pattern: "^[0-9a-fA-F]{8}-([0-9a-fA-F]{4}-){3}[0-9a-fA-F]{12}$"} (Required): The Microsoft Fabric workspace ID.
* **workspaceName**: string: The Microsoft Fabric workspace name.

## FabricShortcutProperties
### Properties
* **configuration**: [FabricShortcutConfiguration](#fabricshortcutconfiguration) (Required): Microsoft Fabric workspace and artifact configuration.
* **createdAt**: string (ReadOnly): The UTC time when the shortcut was created.
* **modifiedAt**: string (ReadOnly): The UTC time when the shortcut was last modified.
* **shortcutStatus**: 'Approved' | 'Pending' | 'Rejected': The current shortcut status. Only Pending can be supplied on create or update.
* **shortcutType**: 'Entity' | 'Network': The type of the shortcut.
* **statusDescription**: string (ReadOnly): A description of the current shortcut status.
...
## MaintenanceWindow
### Properties
* **dayOfWeek**: 'Friday' | 'Monday' | 'Saturday' | 'Sunday' | 'Thursday' | 'Tuesday' | 'Wednesday' (Required): The UTC day of the week on which the maintenance window starts.
* **durationMinutes**: int {minValue: 480, maxValue: 1440} (Required): The maintenance window duration in minutes. The value must be between 480 and 1440 in 60-minute increments.
* **startTimeOfDay**: string (Required): The UTC time of day at which the maintenance window starts, represented as an ISO 8601 duration since midnight.
...
### Properties
* **exceptionWindows**: [ExceptionWindow](#exceptionwindow)[]: Date-specific exceptions to the recurring maintenance windows.
* **maintenanceWindows**: [MaintenanceWindow](#maintenancewindow)[] {minLength: 1, maxLength: 2}: Recurring weekly maintenance windows in UTC. At least one window must be supplied when preferences are created or updated. A maximum of two windows can be configured, and their combined duration must be at least 16 hours per week.
* **upgradeStatus**: [UpgradeStatus](#upgradestatus) (ReadOnly): The current cluster upgrade status.

## UpgradeStatus
### Properties
* **completesAt**: string: The estimated UTC time when the current upgrade will complete.
* **inProgress**: bool (Required): Whether an upgrade-now override is currently active.
* **pendingUpgrade**: bool (Required): Whether at least one deferred upgrade is waiting for the cluster.
