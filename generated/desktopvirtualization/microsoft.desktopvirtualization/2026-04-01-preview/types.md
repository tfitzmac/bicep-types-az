# Microsoft.DesktopVirtualization @ 2026-04-01-preview

## Resource Microsoft.DesktopVirtualization/appAttachPackages@2026-04-01-preview
...
## Resource Microsoft.DesktopVirtualization/applicationGroups@2026-04-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.DesktopVirtualization/applicationGroups/applications@2026-04-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.DesktopVirtualization/applicationGroups/desktops@2026-04-01-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.DesktopVirtualization/hostPools@2026-04-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): If etag is provided in the response body, it may also be provided as a header per the normal etag convention.  Entity tags are used for comparing two or more entities from the same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields.
...
## Resource Microsoft.DesktopVirtualization/hostPools/activeSessionHostConfigurations@2026-04-01-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.DesktopVirtualization/hostPools/msixPackages@2026-04-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.DesktopVirtualization/hostPools/privateEndpointConnections@2026-04-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.DesktopVirtualization/hostPools/sessionHostConfigurations@2026-04-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.DesktopVirtualization/hostPools/sessionHostManagements@2026-04-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.DesktopVirtualization/hostPools/sessionHosts@2026-04-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string {minLength: 3, maxLength: 48, pattern: "^[A-Za-z0-9@.\-_ ]*$"} (Required, DeployTimeConstant): The resource name
* **properties**: [SessionHostProperties](#sessionhostproperties): Detailed properties for SessionHost
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.DesktopVirtualization/hostPools/sessionHosts' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.DesktopVirtualization/hostPools/sessionHosts/userSessions@2026-04-01-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.DesktopVirtualization/scalingPlans@2026-04-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): If etag is provided in the response body, it may also be provided as a header per the normal etag convention.  Entity tags are used for comparing two or more entities from the same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields.
...
## Resource Microsoft.DesktopVirtualization/scalingPlans/personalSchedules@2026-04-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.DesktopVirtualization/scalingPlans/pooledSchedules@2026-04-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.DesktopVirtualization/workspaces@2026-04-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): If etag is provided in the response body, it may also be provided as a header per the normal etag convention.  Entity tags are used for comparing two or more entities from the same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields.
...
## Resource Microsoft.DesktopVirtualization/workspaces/privateEndpointConnections@2026-04-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Function listRegistrationTokens (Microsoft.DesktopVirtualization/hostPools@2026-04-01-preview)
...
## Function listSingleSessionHostRegistrationTokens (Microsoft.DesktopVirtualization/hostPools/sessionHosts@2026-04-01-preview)
* **Resource**: Microsoft.DesktopVirtualization/hostPools/sessionHosts
* **ApiVersion**: 2026-04-01-preview
* **Input**: [ScopedRegistrationTokenProperties](#scopedregistrationtokenproperties)
* **Output**: [RegistrationTokenList](#registrationtokenlist)
...
* **shortcutsExtension**: [ShortcutsExtension](#shortcutsextension): Additional shortcut settings for the remote application.
...
* **cloudPcResource**: bool (ReadOnly): Is cloud pc resource.
* **conditionalRdpProperty**: string: The conditional RDP properties of the host pool, serialized as a string in the format of `<rdpPropertyName>:<type>:<value>:<conditionType>:<conditionValue>`.
...
## ScopedRegistrationTokenProperties
### Properties
* **expirationTimeInUtc**: string (Required): Expiration time of the registration token in UTC.
...
## ShortcutsExtension
### Properties
* **putShortcutOnDesktop**: bool: Indicates whether to create a desktop shortcut for the remote application.
