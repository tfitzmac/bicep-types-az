...
## Resource Microsoft.Kusto/clusters@2025-02-14
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-02-14' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Kusto/clusters/attachedDatabaseConfigurations@2025-02-14
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-02-14' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Kusto/clusters/databases@2025-02-14
* **Valid Scope(s)**: ResourceGroup
* **Discriminator**: kind
...
## Resource Microsoft.Kusto/clusters/databases/dataConnections@2025-02-14
* **Valid Scope(s)**: ResourceGroup
* **Discriminator**: kind
...
#### Properties
* **kind**: 'EventGridWithManagedIdentity' (Required): Kind of the endpoint for the data connection
* **properties**: [EventGridConnectionWithManagedIdentityProperties](#eventgridconnectionwithmanagedidentityproperties): The properties of the Event Grid data connection with mandatory managed identity.
...
#### Properties
* **kind**: 'EventHubWithManagedIdentity' (Required): Kind of the endpoint for the data connection
* **properties**: [EventHubConnectionWithManagedIdentityProperties](#eventhubconnectionwithmanagedidentityproperties): The Event Hub data connection properties to validate.
...
## Resource Microsoft.Kusto/clusters/databases/principalAssignments@2025-02-14
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-02-14' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Kusto/clusters/databases/scripts@2025-02-14
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-02-14' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Kusto/clusters/managedPrivateEndpoints@2025-02-14
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-02-14' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Kusto/clusters/principalAssignments@2025-02-14
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-02-14' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Kusto/clusters/privateEndpointConnections@2025-02-14
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-02-14' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Kusto/clusters/privateLinkResources@2025-02-14 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-02-14' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Kusto/clusters/sandboxCustomImages@2025-02-14
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-02-14' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Function listCalloutPolicies (Microsoft.Kusto/clusters@2025-02-14)
* **Resource**: Microsoft.Kusto/clusters
* **ApiVersion**: 2025-02-14
* **Output**: [CalloutPoliciesList](#calloutpolicieslist)

## Function listFollowerDatabases (Microsoft.Kusto/clusters@2025-02-14)
* **Resource**: Microsoft.Kusto/clusters
* **ApiVersion**: 2025-02-14
* **Output**: [FollowerDatabaseListResult](#followerdatabaselistresult)

## Function listLanguageExtensions (Microsoft.Kusto/clusters@2025-02-14)
* **Resource**: Microsoft.Kusto/clusters
* **ApiVersion**: 2025-02-14
* **Output**: [LanguageExtensionsList](#languageextensionslist)

## Function listPrincipals (Microsoft.Kusto/clusters/databases@2025-02-14)
...
* **value**: [CalloutPolicy](#calloutpolicy)[] (Required): The CalloutPolicy items on this page
...
* **publicNetworkAccess**: 'Disabled' | 'Enabled' | 'SecuredByPerimeter' | string: Public network access to the cluster is enabled by default. When disabled, only private endpoint connection to the cluster is allowed
...
* **dataFormat**: 'APACHEAVRO' | 'AVRO' | 'AZMONSTREAM' | 'CSV' | 'JSON' | 'MULTIJSON' | 'ORC' | 'PARQUET' | 'PSV' | 'RAW' | 'SCSV' | 'SINGLEJSON' | 'SOHSV' | 'TSV' | 'TSVE' | 'TXT' | 'W3CLOGFILE' | string: The data format of the message. Optionally the data format can be added to each message.
...
* **databaseRouting**: 'Multi' | 'Single' | string: Indication for database routing information from the data connection, by default only database routing information is allowed
* **dataFormat**: 'APACHEAVRO' | 'AVRO' | 'AZMONSTREAM' | 'CSV' | 'JSON' | 'MULTIJSON' | 'ORC' | 'PARQUET' | 'PSV' | 'RAW' | 'SCSV' | 'SINGLEJSON' | 'SOHSV' | 'TSV' | 'TSVE' | 'TXT' | 'W3CLOGFILE' | string: The data format of the message. Optionally the data format can be added to each message.
* **eventGridResourceId**: string: The resource ID where the event grid is configured to send events.
* **eventHubResourceIdForManagedIdentity**: string (Required): The resource ID of the event hub that is subscribed to the storage account events.
* **ignoreFirstRecord**: bool: A Boolean value that, if set to true, indicates that ingestion should ignore the first record of every file
* **managedIdentityObjectId**: string (ReadOnly): The object ID of managedIdentityResourceId
* **managedIdentityResourceId**: string (Required): The resource ID of a managed identity (system or user assigned) to be used to authenticate with event hub and storage account.
* **mappingRuleName**: string: The mapping rule to be used to ingest the data. Optionally the mapping information can be added to each message.
* **provisioningState**: 'Canceled' | 'Creating' | 'Deleting' | 'Failed' | 'Moving' | 'Running' | 'Succeeded' | string (ReadOnly): The provisioned state of the resource.
* **storageAccountResourceIdForManagedIdentity**: string (Required): The resource ID of the storage account where the data resides.
* **tableName**: string: The table where the data should be ingested. Optionally the table information can be added to each message.
...
* **databaseRouting**: 'Multi' | 'Single' | string: Indication for database routing information from the data connection, by default only database routing information is allowed
* **dataFormat**: 'APACHEAVRO' | 'AVRO' | 'AZMONSTREAM' | 'CSV' | 'JSON' | 'MULTIJSON' | 'ORC' | 'PARQUET' | 'PSV' | 'RAW' | 'SCSV' | 'SINGLEJSON' | 'SOHSV' | 'TSV' | 'TSVE' | 'TXT' | 'W3CLOGFILE' | string: The data format of the message. Optionally the data format can be added to each message.
* **eventHubResourceIdForManagedIdentity**: string (Required): The resource ID of the event hub to be used to create a data connection.
* **eventSystemProperties**: string[]: System properties of the event hub
* **managedIdentityObjectId**: string (ReadOnly): The object ID of the managedIdentityResourceId
* **managedIdentityResourceId**: string (Required): The resource ID of a managed identity (system or user assigned) to be used to authenticate with event hub.
* **mappingRuleName**: string: The mapping rule to be used to ingest the data. Optionally the mapping information can be added to each message.
* **provisioningState**: 'Canceled' | 'Creating' | 'Deleting' | 'Failed' | 'Moving' | 'Running' | 'Succeeded' | string (ReadOnly): The provisioned state of the resource.
* **retrievalStartDate**: string: When defined, the data connection retrieves existing Event hub events created since the Retrieval start date. It can only retrieve events retained by the Event hub, based on its retention period.
* **tableName**: string: The table where the data should be ingested. Optionally the table information can be added to each message.
...
* **userIdentity**: string: The user assigned identity (ARM resource id) that has access to the key. The identity must have 'Get', 'Wrap Key', and 'Unwrap Key' permissions on the Key Vault key, or be assigned the 'Key Vault Crypto Service Encryption User' role.

## LanguageExtension
### Properties
* **languageExtensionCustomImageName**: string: The sandbox custom image name that should be enabled as the active language extension. Sandbox custom image is a cluster sub resource. When this property is set, LanguageExtensionImageName should be set to 'PythonCustomImage'.
...
### Properties
* **nextLink**: string: The link to the next page of resources.
