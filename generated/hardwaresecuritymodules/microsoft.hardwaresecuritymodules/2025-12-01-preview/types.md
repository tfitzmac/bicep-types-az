# Microsoft.HardwareSecurityModules @ 2025-12-01-preview

## Resource Microsoft.HardwareSecurityModules/cloudHsmClusters@2025-12-01-preview
...
## Resource Microsoft.HardwareSecurityModules/cloudHsmClusters/privateEndpointConnections@2025-12-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-12-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.HardwareSecurityModules/dedicatedHSMs@2025-12-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-12-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.HardwareSecurityModules/paymentHsmClusters@2025-12-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-12-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **location**: string (Required): The geo-location where the resource lives
* **name**: string {minLength: 3, maxLength: 23, pattern: "^[a-zA-Z0-9-]{3,23}$"} (Required, DeployTimeConstant): The resource name
* **properties**: [PaymentHsmClusterProperties](#paymenthsmclusterproperties): Properties of the Payment HSM Cluster
* **sku**: [PaymentHsmClusterSku](#paymenthsmclustersku): SKU details
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **tags**: [TrackedResourceTags](#trackedresourcetags): Resource tags.
* **type**: 'Microsoft.HardwareSecurityModules/paymentHsmClusters' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.HardwareSecurityModules/paymentHsmClusters/privateEndpointConnections@2025-12-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-12-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string: Modified whenever there is a change in the state of private endpoint connection.
...
* **properties**: [PrivateEndpointConnectionProperties](#privateendpointconnectionproperties): Resource properties.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.HardwareSecurityModules/paymentHsmClusters/privateEndpointConnections' (ReadOnly, DeployTimeConstant): The resource type
...
* **name**: 'Standard B10' | 'Standard_B1' | 'Standard_B10v2' | 'Standard_B15v2' | 'Standard_B1v2' | 'Standard_B20v2' | 'Standard_B5v2' | string (Required): Sku name of the Cloud HSM Cluster
...
### Properties
* **activationState**: 'Active' | 'Failed' | 'NotActivated' | 'NotDefined' | 'Unknown' | string (ReadOnly): State of security domain activation
* **applicationTrustedIssuer**: string (Required, WriteOnly): The application trusted issuer for the Payment HSM Cluster
* **autoGeneratedDomainNameLabelScope**: 'NoReuse' | 'ResourceGroupReuse' | 'SubscriptionReuse' | 'TenantReuse' | string: The Payment HSM Cluster's auto-generated Domain Name Label Scope
* **hsms**: [PaymentHsmProperties](#paymenthsmproperties)[] (ReadOnly): An array of Payment HSM Cluster's HSMs
* **managementTrustedIssuer**: string (Required, WriteOnly): The management trusted issuer for the Payment HSM Cluster
* **privateEndpointConnections**: [PaymentHsmClusterPrivateEndpointConnection](#paymenthsmclusterprivateendpointconnection)[] (ReadOnly): List of private endpoint connection resources
* **provisioningState**: 'Canceled' | 'Deleting' | 'Failed' | 'Provisioning' | 'Succeeded' | 'Updating' | string (ReadOnly): The Payment HSM Cluster's provisioningState
* **publicNetworkAccess**: 'Disabled' | string: The Payment HSM Cluster public network access
* **statusMessage**: string (ReadOnly): Payment HSM Cluster status message

## PaymentHsmClusterSku
### Properties
* **capacity**: int: Sku capacity
* **family**: 'B' | string (Required): Sku family of the Payment HSM Cluster
* **name**: 'Payments_v2' | string (Required): Sku name of the Payment HSM Cluster

## PaymentHsmProperties
### Properties
* **appFqdn**: string: App FQDN of the Payment HSM
* **mgmtFqdn**: string: Mgmt FQDN of the Payment HSM
* **state**: 'ConfiguringSlb' | 'Degraded' | 'DelayedDeletion' | 'Deleting' | 'DeletingSlbEntry' | 'Deploying' | 'Failed' | 'InitialProvisioning' | 'Relocating' | 'Started' | 'Starting' | 'Unknown' | 'Updating' | string: The Payment HSM State.
* **stateMessage**: string: The Payment HSM State message
