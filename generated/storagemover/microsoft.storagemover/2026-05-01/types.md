# Microsoft.StorageMover @ 2026-05-01

## Resource Microsoft.StorageMover/storageMovers@2026-05-01
...
## Resource Microsoft.StorageMover/storageMovers/agents@2026-05-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.StorageMover/storageMovers/connections@2026-05-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string {pattern: "^[A-Za-z0-9][A-Za-z0-9_-]{0,20}"} (Required, DeployTimeConstant): The resource name
* **properties**: [ConnectionProperties](#connectionproperties) (Required): Connection properties.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.StorageMover/storageMovers/connections' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.StorageMover/storageMovers/endpoints@2026-05-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.StorageMover/storageMovers/projects@2026-05-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.StorageMover/storageMovers/projects/jobDefinitions@2026-05-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.StorageMover/storageMovers/projects/jobDefinitions/jobRuns@2026-05-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
### Properties
* **accessKeyUri**: string: The Azure Key Vault secret URI which stores the username. Use empty string to clean-up existing value.
* **secretKeyUri**: string: The Azure Key Vault secret URI which stores the password. Use empty string to clean-up existing value.
* **type**: 'AzureKeyVaultS3WithHMAC' | 'AzureKeyVaultSmb' | string (Required): The Credentials type.
...
### Properties
* **connectionStatus**: 'Approved' | 'Disconnected' | 'Pending' | 'Rejected' | 'Stale' | string (ReadOnly): The connection status.
* **description**: string: A description for the Connection.
* **jobList**: string[]: List of job definitions associated with this connection.
* **privateEndpointName**: string (ReadOnly): The PrivateEndpointName associated with the connection.
* **privateEndpointResourceId**: string (ReadOnly): The privateEndpoint resource Id
* **privateLinkServiceId**: string (Required): The PrivateLinkServiceId for the connection.
* **provisioningState**: 'Canceled' | 'Deleting' | 'Failed' | 'Succeeded' | string (ReadOnly): The provisioning state of this resource.
...
* **endpointKind**: 'Source' | 'Target' | string: The Endpoint resource kind source or target.
* **provisioningState**: 'Canceled' | 'Deleting' | 'Failed' | 'Succeeded' | string (ReadOnly): The provisioning state of this resource.
...
#### Properties
* **allowedStorageAccounts**: string[]: Full ARM resource IDs of partner-tenant storage accounts that are allowed
...
* **enableCrossTenantTransfer**: bool: Opt-in flag enabling this endpoint to be used as one side of a cross-tenant
...
* **nfsVersion**: 'NFSauto' | 'NFSv3' | 'NFSv4' | 'NFSv4_1' | string: The NFS protocol version.
* **sourceType**: 'FSX-EFS' | 'NfsMount' | string: Source type to differentiate NFSMount and FSX-SMB endpoints. Default is NFSMount.
...
* **sourceType**: 'FSX-SMB' | 'SmbMount' | string: Source type to differentiate SMBMount and FSX-SMB endpoints. Default is SMBMount.
...
* **connections**: string[]: List of connections associated to this job
* **copyMode**: 'Additive' | 'Mirror' | string (Required): Strategy to use for copy.
* **crossTenantEndpointResourceId**: string: Full ARM resource ID of the cross-tenant (foreign) endpoint. On the
source-tenant copy this is the TARGET endpoint; on the
target-tenant copy this is the SOURCE endpoint.
* **crossTenantEndpointTenantId**: string: The Azure AD tenant ID of the cross-tenant source endpoint. Required when
`isCrossTenantJob` is true. Cannot be modified after the Job Definition is
created.
* **dataIntegrityValidation**: 'None' | 'SaveFileMD5' | 'SaveVerifyFileMD5' | string: The checksum validation mode for the job definition.
...
* **isCrossTenantJob**: bool: Indicates that this Job Definition is a cross-tenant job where the
...
created.
* **jobType**: 'CloudToCloud' | 'OnPremToCloud' | 'OnPremToCloudAgentLess' | string: The type of the Job.
...
* **moverSyncedUntil**: string: The last time the mover was synchronized.
* **preservePermissions**: bool: Boolean to preserve permissions or not.
* **provisioningState**: 'Canceled' | 'Deleting' | 'Failed' | 'Succeeded' | string (ReadOnly): The provisioning state of this resource.
* **schedule**: [ScheduleInfo](#scheduleinfo): Schedule information for the Job Definition.
...
* **syncMode**: string: The synchronization mode for the Job Definition.
...
* **scheduledExecutionTime**: string (ReadOnly): Scheduled execution time. Null if Trigger type is manual.
...
### Properties
* **code**: string: Error code of the given entry.
* **message**: string: Warning message of the given entry.
* **target**: string: Target of the given error entry.
...
## ScheduleInfo
### Properties
* **cronExpression**: string: Optional CRON expression for advanced scheduling
...
* **frequency**: 'Daily' | 'Hourly' | 'Monthly' | 'None' | 'Onetime' | 'Weekly' | string: Type of schedule — Monthly, Weekly, or Daily
* **isActive**: bool: Whether the schedule is currently active
* **repeatInterval**: string: Repeat interval used for sub-daily schedules.
