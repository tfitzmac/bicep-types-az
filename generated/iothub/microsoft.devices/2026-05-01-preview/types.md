# Microsoft.Devices @ 2026-05-01-preview

## Resource Microsoft.Devices/IotHubs@2026-05-01-preview
...
## Resource Microsoft.Devices/IotHubs/certificates@2026-05-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Devices/IotHubs/eventHubEndpoints/ConsumerGroups@2026-05-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Devices/iotHubs/privateEndpointConnections@2026-05-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Function listkeys (Microsoft.Devices/IotHubs/IotHubKeys@2026-05-01-preview)
...
## Function listkeys (Microsoft.Devices/IotHubs@2026-05-01-preview)
...
## IotHubDetails
### Properties
* **gatewayVersion**: 'V1' | 'V2' | string: The IoT hub Gateway version.
...
* **deviceHostName**: string (ReadOnly): The name of the device host. Supports secure connections over TLS 1.3.
* **deviceRegistry**: [DeviceRegistry](#deviceregistry): Represents properties related to the Azure Device Registry (ADR).
...
* **enableDataResidency**: bool: This property when set to true, will enable data residency, thus, disabling disaster recovery.
...
* **iotHubDetails**: [IotHubDetails](#iothubdetails) (ReadOnly): Set of additional read-only properties for the IoT hub.
* **ipFilterRules**: [IpFilterRule](#ipfilterrule)[]: The IP filter rules.
* **ipVersion**: 'ipv4' | 'ipv4ipv6' | 'ipv6' | string: This property specifies the IP Version the hub is currently utilizing.
...
* **rootCertificate**: [RootCertificateProperties](#rootcertificateproperties): This property store root certificate related information
...
* **serviceHostName**: string (ReadOnly): The name of the service host. Supports secure connections over TLS 1.3.
...
### Properties
* **authenticationType**: 'identityBased' | 'keyBased' | string: Method used to authenticate against the cosmos DB sql container endpoint
* **containerName**: string (Required): The name of the cosmos DB sql container in the cosmos DB database.
* **databaseName**: string (Required): The name of the cosmos DB database in the cosmos DB account.
* **endpointUri**: string (Required): The url of the cosmos DB account. It must include the protocol https://
* **id**: string (ReadOnly): Id of the cosmos DB sql container endpoint
* **identity**: [ManagedIdentity](#managedidentity): Managed identity properties of routing cosmos DB container endpoint.
...
## RoutingEndpoints
### Properties
* **cosmosDBSqlContainers**: [RoutingCosmosDBSqlApiProperties](#routingcosmosdbsqlapiproperties)[]: The list of Cosmos DB container endpoints that IoT hub routes messages to, based on the routing rules.
...
* **eventStreams**: [RoutingEventStreamProperties](#routingeventstreamproperties)[]: The list of event stream endpoints that IoT hub routes messages to, based on the routing rules.
...
### Properties
* **authenticationType**: 'identityBased' | string: Method used to authenticate against the event stream endpoint
* **endpointUri**: string (Required): The url of the underlying event hub namespace of the event stream endpoint. It must include the protocol sb://
* **entityPath**: string (Required): Event hub name on the event hub namespace
* **eventStreamId**: string: The unique GUID of the target event stream under the workspace.
* **id**: string (ReadOnly): Id of the event stream endpoint
* **identity**: [ManagedIdentity](#managedidentity): Managed identity properties of routing event stream endpoint.
* **name**: string {pattern: "^[A-Za-z0-9-._]{1,64}$"} (Required): The name that identifies this endpoint. The name can only include alphanumeric characters, periods, underscores, hyphens and has a maximum length of 64 characters. The following names are reserved:  events, fileNotifications, $default. Endpoint names must be unique across endpoint types.
* **sourceId**: string: The unique GUID of the custom source for the event stream.
* **workspaceId**: string: The unique GUID of the target Microsoft Fabric workspace for the event stream endpoint.
