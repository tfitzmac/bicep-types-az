# Microsoft.Databricks @ 2025-08-01-preview

## Resource Microsoft.Databricks/accessConnectors@2025-08-01-preview
...
## Resource Microsoft.Databricks/workspaces@2025-08-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-08-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Databricks/workspaces/privateEndpointConnections@2025-08-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-08-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Databricks/workspaces/privateLinkResources@2025-08-01-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-08-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Databricks/workspaces/virtualNetworkPeerings@2025-08-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-08-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
### Properties
* **complianceStandards**: ('CANADA_PROTECTED_B' | 'CYBER_ESSENTIAL_PLUS' | 'FEDRAMP_HIGH' | 'HIPAA' | 'HITRUST' | 'IRAP_PROTECTED' | 'ISMAP' | 'K_FSI' | 'NONE' | 'PCI_DSS' | string)[]: Compliance standards associated with the workspace.
* **value**: 'Disabled' | 'Enabled' | string
...
* **customPrivateSubnetName**: [WorkspaceCustomStringParameter](#workspacecustomstringparameter) (Required): The name of the Private Subnet within the Virtual Network
* **customPublicSubnetName**: [WorkspaceCustomStringParameter](#workspacecustomstringparameter) (Required): The name of a Public Subnet within the Virtual Network
* **customVirtualNetworkId**: [WorkspaceCustomStringParameter](#workspacecustomstringparameter) (Required): The ID of a Virtual Network where this Databricks Cluster should be created
