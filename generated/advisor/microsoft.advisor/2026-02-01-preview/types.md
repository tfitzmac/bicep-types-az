# Microsoft.Advisor @ 2026-02-01-preview

## Resource Microsoft.Advisor/advisorScore@2026-02-01-preview (ReadOnly)
...
## Resource Microsoft.Advisor/assessments@2026-02-01-preview
* **Valid Scope(s)**: Subscription
### Properties
* **apiVersion**: '2026-02-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Advisor/configurations@2026-02-01-preview
...
## Resource Microsoft.Advisor/metadata@2026-02-01-preview (ReadOnly)
...
## Resource Microsoft.Advisor/recommendations@2026-02-01-preview (ReadOnly)
...
## Resource Microsoft.Advisor/recommendations/suppressions@2026-02-01-preview
* **Valid Scope(s)**: Unknown
### Properties
* **apiVersion**: '2026-02-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Advisor/resiliencyReviews@2026-02-01-preview (ReadOnly)
* **Valid Scope(s)**: Subscription
### Properties
* **apiVersion**: '2026-02-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Advisor/triageRecommendations@2026-02-01-preview (ReadOnly)
...
## Resource Microsoft.Advisor/triageResources@2026-02-01-preview (ReadOnly)
* **Valid Scope(s)**: Extension
### Properties
* **apiVersion**: '2026-02-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
* **completionType**: string: The type of recommendation completion, which is either MarkedByUser or SystemVerified
...
* **createdTime**: string: The created time of the recommendation.
...
* **lastRefreshed**: string: The most recent time Advisor evaluated the recommendation for validity (re-ingested).
* **lastUpdated**: string: The most recent time the recommendation state changed (manual or automated).
...
* **postponedUntilDateTime**: string: The time the Recommendation was postponed until.
* **potentialBenefits**: string: The potential benefit of implementing recommendation.
* **recommendationDismissReason**: 'AnAlternativeSolutionIsAlreadyInPlace' | 'ExcessiveCostInvestmentRequired' | 'ImplementationStepsAreUnclear' | 'IncompatibleWithTheCurrentConfiguration' | 'Other' | 'RiskIsAcceptable' | 'TooComplexOrImpracticalToImplement' | string: The reason the Recommendation was dismissed.
* **recommendationStatus**: 'Completed' | 'Dismissed' | 'New' | 'Postponed' | string: The state of the Recommendation
...
* **suppressionId**: string: The single snoozed or dismissed rule for the recommendation.
