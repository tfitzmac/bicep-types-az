# Microsoft.AzureStackHCI @ 2026-10-15-preview

## Resource Microsoft.AzureStackHCI/clusters@2026-10-15-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-10-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.AzureStackHCI/clusters/arcSettings@2026-10-15-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-10-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AzureStackHCI/clusters/arcSettings/extensions@2026-10-15-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-10-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AzureStackHCI/clusters/deploymentSettings@2026-10-15-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-10-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AzureStackHCI/clusters/jobs@2026-10-15-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-10-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AzureStackHCI/clusters/publishers@2026-10-15-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-10-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AzureStackHCI/clusters/publishers/offers@2026-10-15-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-10-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AzureStackHCI/clusters/publishers/offers/skus@2026-10-15-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-10-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AzureStackHCI/clusters/securitySettings@2026-10-15-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-10-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AzureStackHCI/clusters/updates@2026-10-15-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-10-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AzureStackHCI/clusters/updates/updateRuns@2026-10-15-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-10-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AzureStackHCI/clusters/updateSummaries@2026-10-15-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-10-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AzureStackHCI/clusters/volumes@2026-10-15-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-10-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string {pattern: "^[a-zA-Z0-9-_]{3,63}$"} (Required, DeployTimeConstant): The resource name
* **properties**: [ClusterVolumeProperties](#clustervolumeproperties): The resource-specific properties for this resource.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.AzureStackHCI/clusters/volumes' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.AzureStackHCI/devicePools@2026-10-15-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-10-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AzureStackHCI/edgeDevices@2026-10-15-preview
...
## Resource Microsoft.AzureStackHCI/edgeDevices/jobs@2026-10-15-preview
* **Valid Scope(s)**: Unknown
* **Discriminator**: kind
...
## Resource Microsoft.AzureStackHCI/edgeMachines@2026-10-15-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-10-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AzureStackHCI/edgeMachines/deploymentSettings@2026-10-15-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-10-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string {pattern: "^[a-zA-Z0-9-]{3,24}$"} (Required, DeployTimeConstant): The resource name
* **properties**: [EdgeMachineDeploymentSettingProperties](#edgemachinedeploymentsettingproperties): The resource-specific properties for this resource.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.AzureStackHCI/edgeMachines/deploymentSettings' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.AzureStackHCI/edgeMachines/disks@2026-10-15-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-10-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AzureStackHCI/edgeMachines/disks/jobs@2026-10-15-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-10-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AzureStackHCI/edgeMachines/disks/privilegedJobs@2026-10-15-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-10-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AzureStackHCI/edgeMachines/gpus@2026-10-15-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-10-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AzureStackHCI/edgeMachines/gpus/jobs@2026-10-15-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-10-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AzureStackHCI/edgeMachines/jobs@2026-10-15-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-10-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AzureStackHCI/edgeMachines/networkAdapters@2026-10-15-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-10-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AzureStackHCI/edgeMachines/networkAdapters/jobs@2026-10-15-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-10-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AzureStackHCI/edgeMachines/proxyConfigurations@2026-10-15-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-10-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: 'default' (Required, DeployTimeConstant): The resource name
* **properties**: [ProxyConfigurationProperties](#proxyconfigurationproperties) (ReadOnly): The resource-specific properties for this resource.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.AzureStackHCI/edgeMachines/proxyConfigurations' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.AzureStackHCI/edgeMachines/securitySettings@2026-10-15-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-10-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string {pattern: "^[a-zA-Z0-9-]{3,24}$"} (Required, DeployTimeConstant): The resource name
* **properties**: [EdgeMachineSecurityProperties](#edgemachinesecurityproperties): The resource-specific properties for this resource.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.AzureStackHCI/edgeMachines/securitySettings' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.AzureStackHCI/edgeMachines/updates@2026-10-15-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-10-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AzureStackHCI/edgeMachines/volumes@2026-10-15-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-10-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AzureStackHCI/locations/osImages@2026-10-15-preview (ReadOnly)
...
## Resource Microsoft.AzureStackHCI/locations/platformUpdates@2026-10-15-preview (ReadOnly)
* **Valid Scope(s)**: Subscription
### Properties
* **apiVersion**: '2026-10-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AzureStackHCI/locations/updateContents@2026-10-15-preview (ReadOnly)
* **Valid Scope(s)**: Subscription
### Properties
* **apiVersion**: '2026-10-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AzureStackHCI/locations/validatedSolutionRecipes@2026-10-15-preview (ReadOnly)
* **Valid Scope(s)**: Subscription
### Properties
* **apiVersion**: '2026-10-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
### HciConfigureLocalAvailabilityZoneJobProperties
#### Properties
* **jobType**: 'ConfigureLocalAvailabilityZone' (Required): Job Type to support polymorphic resource.
* **localAvailabilityZoneConfiguration**: [LocalAvailabilityZoneConfiguration](#localavailabilityzoneconfiguration) (Required): Configuration for local availability zones including naming prefix and zone-to-node mappings.
...
* **localAvailabilityZoneCount**: int (ReadOnly): Number of local availability zones configured in the cluster.
...
## ClusterVolumeConfiguration
### Properties
* **placementMode**: 'auto' | 'infrastructure' | 'manual' | 'reserved' | string: Placement mode for the volume.

## ClusterVolumeProperties
### Properties
* **configuration**: [ClusterVolumeConfiguration](#clustervolumeconfiguration): The authoritative desired configuration for the cluster volume. Contains only the properties that can be set by the caller.
* **provisioningState**: 'Accepted' | 'Canceled' | 'Connected' | 'Creating' | 'Deleted' | 'Deleting' | 'DisableInProgress' | 'Disconnected' | 'Error' | 'Failed' | 'InProgress' | 'Moving' | 'NotSpecified' | 'PartiallyConnected' | 'PartiallySucceeded' | 'Provisioning' | 'Succeeded' | 'Updating' | string (ReadOnly): Provisioning state of the cluster volume resource.
* **reportedProperties**: [ClusterVolumeReportedProperties](#clustervolumereportedproperties) (ReadOnly): The actual state of the cluster volume as reported by the cluster.

## ClusterVolumeReportedProperties
### Properties
* **clusterResourceId**: string (ReadOnly): Cluster resource GUID for a PDR-backed volume when applicable.
* **faultDomainAwareness**: 'Chassis' | 'Drive' | 'Enclosure' | 'Rack' | 'Server' | 'Unknown' | string (ReadOnly): Fault domain level for placement.
* **fileSystem**: string (ReadOnly): Filesystem type (NTFS, ReFS, CSVFS_NTFS, CSVFS_ReFS).
* **id**: string (ReadOnly): Volume GUID. Primary identifier for the cluster volume.
* **isDedupEnabled**: bool (ReadOnly): Whether data deduplication is enabled.
* **isEncrypted**: bool (ReadOnly): Whether BitLocker encryption is enabled.
* **isIntegrityEnabled**: bool (ReadOnly): Whether ReFS integrity streams are enabled.
* **media**: 'Disk' | 'Journal' | 'SCM' | 'SSD' | 'Unknown' | string (ReadOnly): Dominant media type for the volume.
* **name**: string (ReadOnly): User-visible volume label.
* **path**: string (ReadOnly): Cluster volume mount path. This can be a CSV path or device path depending on the backing storage.
* **placementMode**: 'auto' | 'infrastructure' | 'manual' | 'reserved' | string (ReadOnly): Placement mode for the volume.
* **provisioningType**: 'Fixed' | 'Thin' | string (ReadOnly): Provisioning mode for the volume.
* **resiliency**: 'DualParity' | 'MRT' | 'Simple' | 'SingleParity' | 'ThreeWayMirror' | 'TwoWayMirror' | 'Unknown' | string (ReadOnly): Volume resiliency type.
* **server**: string (ReadOnly): Current owner node for the cluster volume when applicable.
* **sizeInBytes**: int (ReadOnly): Total cluster volume size in bytes.
* **sizeRemainingInBytes**: int (ReadOnly): Free space in bytes.
* **status**: int[] (ReadOnly): Operational status codes for the volume.
* **statusCategory**: 'Healthy' | 'Missing' | 'Others' | 'Unhealthy' | 'Warning' | string (ReadOnly): Health roll-up reported by Windows Health Service.
* **storagePoolName**: string (ReadOnly): Name of the containing storage pool.
* **volumeId**: string (ReadOnly): Volume GUID. Primary identifier for the cluster volume.
...
* **witnessLunId**: string: Witness volume LUN ID (e.g. PURE1234567890ABCDEF). Required when witnessType is ClusterWitnessDisk. Minimum LUN size is 1 GB.
...
## DeploymentStep
### Properties
* **additionalData**: [Metadata](#metadata)[] (ReadOnly): Additional metadata associated with the step.
...
* **percentComplete**: int {minValue: 0, maxValue: 100} (ReadOnly): The progress percentage of the step.
* **recommendedSteps**: string[] (ReadOnly): Recommended steps to resolve failures in this step.
...
* **isSupported**: bool (ReadOnly): Indicates whether the disk manufacturer is supported for the validated solution recipe ring. Defaults to true. Set to false when the SAN vendor is not in the allowed vendor list for the current ring.
...
* **storageType**: 'S2D' | 'SAN' | string (ReadOnly): Storage type of the disk.
...
### Properties
* **eceSecretName**: 'AzureStackLCMUserCredential' | 'DefaultARBApplication' | 'LocalAdminCredential' | 'WitnessStorageKey' | 'chapCredential' | 'mutualChapCredential' | string: Secret name expected for Enterprise Cloud Engine (ECE) deployment.
...
## EdgeMachineDeploymentConfiguration
### Properties
* **scaleUnits**: [EdgeMachineScaleUnits](#edgemachinescaleunits)[] (Required): The list of deployment data.
* **version**: string: Deployment template version.

## EdgeMachineDeploymentData
### Properties
* **iScsiConfig**: [IscsiConfig](#iscsiconfig): iSCSI configuration for the edge machine.
* **secrets**: [EceDeploymentSecrets](#ecedeploymentsecrets)[]: Protected parameters stored in Key Vault and applied during edge machine node preparation.
* **storageType**: 'S2D' | 'SANFC' | 'SANISCSI' | string (Required): Storage type for the edge machine node.

## EdgeMachineDeploymentSettingProperties
### Properties
* **deploymentConfiguration**: [EdgeMachineDeploymentConfiguration](#edgemachinedeploymentconfiguration) (Required): The deployment configuration for the edge machine.
* **provisioningState**: 'Accepted' | 'Canceled' | 'Connected' | 'Creating' | 'Deleted' | 'Deleting' | 'DisableInProgress' | 'Disconnected' | 'Error' | 'Failed' | 'InProgress' | 'Moving' | 'NotSpecified' | 'PartiallyConnected' | 'PartiallySucceeded' | 'Provisioning' | 'Succeeded' | 'Updating' | string (ReadOnly): The provisioning state of the deployment setting resource.
* **reportedProperties**: [EceReportedProperties](#ecereportedproperties) (ReadOnly): Deployment status reported from the edge machine.
...
* **storageInitiators**: [StorageInitiator](#storageinitiator)[] (ReadOnly): Storage fabric initiator ports (iSCSI or Fibre Channel) discovered on the edge machine.
...
### Properties
* **deploymentData**: [EdgeMachineDeploymentData](#edgemachinedeploymentdata) (Required): Deployment data to configure the edge machine.

## EdgeMachineSecurityComplianceStatus
### Properties
* **encryptionAtRestStatus**: 'Compliant' | 'NonCompliant' | 'Pending' | string (ReadOnly): Encryption at rest compliance status.
* **fipsStatus**: 'Compliant' | 'NonCompliant' | 'Pending' | string (ReadOnly): FIPS compliance status.
* **secureBootStatus**: 'Compliant' | 'NonCompliant' | 'Pending' | string (ReadOnly): Secure Boot compliance status.
* **securityBaselineStatus**: 'Compliant' | 'NonCompliant' | 'Pending' | string (ReadOnly): Security baseline compliance status.
* **seLinuxPolicyStatus**: 'Compliant' | 'NonCompliant' | 'Pending' | string (ReadOnly): SELinux policy compliance status.

## EdgeMachineSecurityProperties
### Properties
* **lastSyncTimestamp**: string (ReadOnly): Most recent synchronization timestamp in UTC.
* **provisioningState**: 'Accepted' | 'Canceled' | 'Connected' | 'Creating' | 'Deleted' | 'Deleting' | 'DisableInProgress' | 'Disconnected' | 'Error' | 'Failed' | 'InProgress' | 'Moving' | 'NotSpecified' | 'PartiallyConnected' | 'PartiallySucceeded' | 'Provisioning' | 'Succeeded' | 'Updating' | string (ReadOnly): The provisioning state of the resource.
* **registrationTimestamp**: string (ReadOnly): First synchronization timestamp in UTC.
* **securityComplianceStatus**: [EdgeMachineSecurityComplianceStatus](#edgemachinesecuritycompliancestatus) (ReadOnly): Compliance status values synchronized from Guest Configuration.
...
## HardwareProfile
### Properties
* **architecture**: 'amd64' | 'arm64' | string (ReadOnly): CPU architecture of the machine, for example amd64 or arm64.
* **cpuCores**: int (ReadOnly): Number of cpu cores in the machine
* **cpuSockets**: int (ReadOnly): Number of cpu sockets in the machine
* **logicalCoreCount**: int (ReadOnly): Number of logical (SMT/hyper-threaded) cores in the machine, synchronized from Arc Machine DetectedProperties.
...
### Properties
* **addressPrefix**: string: Address prefix in CIDR notation.
* **networkAdapterName**: string: Name of the iSCSI network adapter.
* **targetPortalAddresses**: [IscsiTargetPortalAddress](#iscsitargetportaladdress)[]: Target portal addresses reachable through this adapter.
* **vlanId**: int: VLAN ID associated with the iSCSI network adapter.

## IscsiAdapterProperties
### Properties
* **bandwidthPercentageIscsi**: int: iSCSI bandwidth percentage.
* **jumboPacket**: int: Jumbo frame size in bytes.
* **priorityValue8021ActionIscsi**: int: 802.1p priority value for iSCSI traffic.

## IscsiChapSettings
### Properties
* **chapType**: 'Bidirectional' | 'NoChap' | 'OneWay' | string: The CHAP authentication mode to use.

## IscsiConfig
### Properties
* **chapSettings**: [IscsiChapSettings](#iscsichapsettings): CHAP authentication settings.
* **initiatorIqn**: string: iSCSI Qualified Name of the initiator.
* **iScsiNetworkConfig**: [IscsiNetworkConfig](#iscsinetworkconfig): iSCSI network configuration.

## IscsiNetworkConfig
### Properties
* **adapterIPConfig**: [IscsiAdapterIPConfig](#iscsiadapteripconfig)[]: Per-adapter IP configuration for the iSCSI network adapters.
* **adapterProperties**: [IscsiAdapterProperties](#iscsiadapterproperties): Common adapter properties applied to all iSCSI network adapters.

## IscsiTargetPortalAddress
### Properties
* **ipAddress**: string: IP address of the iSCSI target portal.
* **nextHop**: string: Next hop IP address used to reach the target portal.
...
* **status**: 'Completed' | 'Failed' | 'InProgress' | 'NotStarted' | 'Skipped' | string (Required, ReadOnly): Status of the stage.
...
## LocalAvailabilityZoneConfiguration
### Properties
* **prefix**: string {pattern: "^[a-zA-Z0-9-]{1,8}$"} (Required): Naming prefix used to generate local availability zone names (Prefix1..PrefixN).
* **zones**: [LocalAvailabilityZoneEntry](#localavailabilityzoneentry)[] {minLength: 1, maxLength: 8} (Required): Array of zone-to-node mappings. Each entry specifies the nodes belonging to one local availability zone. Maximum 8 zones allowed. Each zone must contain at least one node. Every cluster node must be assigned to exactly one zone.

## LocalAvailabilityZoneEntry
### Properties
* **nodes**: string[] (Required): List of node names assigned to this local availability zone. All cluster nodes must appear exactly once across all zone entries.
...
## Metadata
### Properties
* **key**: string (Required): The key of the metadata entry.
* **value**: string (Required): The value of the metadata entry.
...
## OsImageProperties
### Properties
* **architecture**: 'amd64' | 'arm64' | string: Represents the CPU architecture of an OS image, for example amd64 or arm64.
...
* **solutionType**: 'AzureLinux' | 'HCI' | string: The solution type (OS family) of the OS image, for example AzureLinux or HCI.
...
* **gpgPubKey**: string: GPG Public Key used for package verification
* **imageHash**: string: Hash of the OS package downloaded
* **operationType**: 'Provision' | 'ReImage' | 'Reset' | 'Update' | string: Operation sub type of OS Provisioning
* **osImageLocation**: string: Location of the operating system image.
* **osName**: string: Name of the operating system.
* **osType**: string: Type of the operating system.
* **osVersion**: string: Version of the operating system.
...
### Properties
* **architecture**: 'amd64' | 'arm64' | string: CPU architecture of the device, for example amd64 or arm64.
...
## ProvisionOsVolumeConfiguration
### Properties
* **configuration**: [VolumeDetails](#volumedetails)[]: List of volume details.

## ProxyConfigurationDetail
### Properties
* **bypassList**: string[]: List of addresses or patterns that should bypass the proxy.
* **connectionUri**: string: Connection URI of the proxy server. Required when isEnabled is true.
* **isEnabled**: bool: Whether the proxy should be active on the device.
* **port**: string: Port number of the proxy server. Required when isEnabled is true.

## ProxyConfigurationProperties
### Properties
* **configurationState**: 'Drifted' | 'InSync' | string (ReadOnly): Indicates whether desiredConfiguration and reportedConfiguration are in sync.
* **desiredConfiguration**: [ProxyConfigurationDetail](#proxyconfigurationdetail) (ReadOnly): The intended proxy configuration as set from the cloud.
Updated at Apply job creation time. Seeded from webProxy in
TargetDeviceConfiguration when the EdgeMachine first reaches Purposed.
* **provisioningState**: 'Accepted' | 'Canceled' | 'Connected' | 'Creating' | 'Deleted' | 'Deleting' | 'DisableInProgress' | 'Disconnected' | 'Error' | 'Failed' | 'InProgress' | 'Moving' | 'NotSpecified' | 'PartiallyConnected' | 'PartiallySucceeded' | 'Provisioning' | 'Succeeded' | 'Updating' | string (ReadOnly): Provisioning state of the proxy configuration resource.
* **reportedConfiguration**: [ProxyConfigurationReportedDetail](#proxyconfigurationreporteddetail) (ReadOnly): The actual proxy configuration last reported by the device via the RP data path.

## ProxyConfigurationReportedDetail
### Properties
* **bypassList**: string[] (ReadOnly): Bypass list as reported by the device.
* **connectionUri**: string (ReadOnly): Connection URI as reported by the device.
* **isEnabled**: bool (ReadOnly): Whether the proxy is currently active on the device, as reported.
* **lastReportedTimestamp**: string (ReadOnly): UTC timestamp of the last device report received by the RP.
* **port**: string (ReadOnly): Port number as reported by the device.
...
* **remoteSupportProvisioningState**: 'Failed' | 'GrantInProgress' | 'None' | 'PartiallySucceeded' | 'RevokeInProgress' | 'Succeeded' | string (ReadOnly): Remote Support Provisioning State
...
## StorageInitiator
### Properties
* **ethernetAdapterMacAddress**: string (ReadOnly): MAC address of the Ethernet adapter the iSCSI initiator is bound to. Populated for iSCSI initiators only; matches EdgeMachineNicDetail.macAddress.
* **ethernetAdapterName**: string (ReadOnly): Name of the Ethernet adapter the iSCSI initiator is bound to. Populated for iSCSI initiators only; matches EdgeMachineNicDetail.adapterName.
* **initiatorIdentifier**: string (Required, ReadOnly): Node identifier of the initiator. IQN for iSCSI or node WWN (WWNN) for Fibre Channel. Corresponds to the NodeAddress reported by Get-InitiatorPort.
* **initiatorType**: 'FibreChannel' | 'Unknown' | 'iSCSI' | string (Required, ReadOnly): Transport type of the initiator port.
* **operationalStatus**: string (ReadOnly): Operational status of the initiator port as reported by the host. Corresponds to OperationalStatus from Get-InitiatorPort.
* **portWorldWideName**: string (ReadOnly): Fibre Channel port World Wide Name (WWPN). Populated for FibreChannel initiators only; corresponds to the PortAddress reported by Get-InitiatorPort.

## StorageProfile
### Properties
* **localAvailabilityZoneName**: string (ReadOnly): Local availability zone name assigned to this edge machine after a ConfigureLocalAvailabilityZone job succeeds.
* **poolableDisksCount**: int (ReadOnly): Number of storage disks in the device with $CanPool as true.
...
* **volume**: [ProvisionOsVolumeConfiguration](#provisionosvolumeconfiguration): Volume configuration.
...
* **state**: 'AdditionalContentRequired' | 'DownloadFailed' | 'Downloading' | 'HasPrerequisite' | 'HealthCheckExpired' | 'HealthCheckFailed' | 'HealthChecking' | 'InstallationFailed' | 'Installed' | 'Installing' | 'InstallingPerSchedule' | 'Invalid' | 'NotApplicableBecauseAnotherUpdateIsInProgress' | 'Obsolete' | 'PendingOEMValidation' | 'PreparationFailed' | 'Preparing' | 'Ready' | 'ReadyToInstall' | 'Recalled' | 'ScanFailed' | 'ScanInProgress' | 'ScheduledToInstall' | string: Represents the current state of the update as it relates to this stamp. This includes phases such as preparation, installation, scanning, and error handling, providing insight into the update's progress and any issues encountered.
...
* **updateRunType**: 'Install' | 'PrepareIntoInstall' | 'PrepareOnly' | 'Unknown' | string: Differentiates the purpose of an update run so that clients can represent it correctly.
...
## VolumeDetails
### Properties
* **diskName**: string: Name of the disk on which the volume resides.
* **fileSystem**: 'NTFS' | 'ReFS' | 'ext4' | 'fat' | 'fat32' | 'vfat' | 'xfs' | string: File system type to format the volume with.
* **name**: string: Name of the volume.
* **path**: string: Mount path for the volume.
* **sizeInBytes**: string: Size of the volume in bytes.
