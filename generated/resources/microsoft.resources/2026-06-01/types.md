# Microsoft.Resources @ 2026-06-01

## Resource Microsoft.Resources/deployments@2026-06-01
...
* **configHash**: string (ReadOnly): The extension configuration hash. Can be used to distinguish different configurations that have the same config ID.
...
* **symbolicNamePath**: string[]: The symbolic name path to the resource in the deployment template, including nested deployment(s) and extension if applicable.
