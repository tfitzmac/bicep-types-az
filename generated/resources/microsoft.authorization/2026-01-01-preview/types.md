...
## Resource Microsoft.Authorization/dataPolicyManifests@2026-01-01-preview (ReadOnly)
* **Valid Scope(s)**: Tenant
### Properties
* **apiVersion**: '2026-01-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string (Required, DeployTimeConstant): The resource name
* **properties**: [DataPolicyManifestProperties](#datapolicymanifestproperties) (ReadOnly): The resource-specific properties for this resource.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.Authorization/dataPolicyManifests' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.Authorization/policyAssignments@2026-01-01-preview
...
## Resource Microsoft.Authorization/policyDefinitions@2026-01-01-preview
...
## Resource Microsoft.Authorization/policyDefinitions/versions@2026-01-01-preview
* **Valid Scope(s)**: Tenant (ReadOnly), ManagementGroup, Subscription
### Properties
* **apiVersion**: '2026-01-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Authorization/policyEnrollments@2026-01-01-preview
* **Valid Scope(s)**: Unknown
### Properties
* **apiVersion**: '2026-01-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Authorization/policyExemptions@2026-01-01-preview
* **Valid Scope(s)**: Unknown
### Properties
* **apiVersion**: '2026-01-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Authorization/policySetDefinitions@2026-01-01-preview
* **Valid Scope(s)**: Tenant (ReadOnly), ManagementGroup, Subscription
### Properties
* **apiVersion**: '2026-01-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Authorization/policySetDefinitions/versions@2026-01-01-preview
* **Valid Scope(s)**: Tenant (ReadOnly), ManagementGroup, Subscription
### Properties
* **apiVersion**: '2026-01-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Authorization/variables@2026-01-01-preview
...
## Resource Microsoft.Authorization/variables/values@2026-01-01-preview
* **Valid Scope(s)**: ManagementGroup, Subscription
### Properties
* **apiVersion**: '2026-01-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Alias
### Properties
* **defaultMetadata**: [AliasPathMetadata](#aliaspathmetadata): The default alias path metadata. Applies to the default path and to any alias path that doesn't have metadata.
...
## AliasPathMetadata
### Properties
* **attributes**: 'Modifiable' | 'None' | string: The attributes of the token that the alias path is referring to.
* **type**: 'Any' | 'Array' | 'Boolean' | 'Integer' | 'NotSpecified' | 'Number' | 'Object' | 'String' | string: The type of the token that the alias path is referring to.

## AliasPattern
### Properties
* **phrase**: string: The alias pattern phrase.
* **type**: 'Extract' | 'NotSpecified': The pattern for an alias path.
...
### Properties
* **custom**: [DataManifestCustomResourceFunctionDefinition](#datamanifestcustomresourcefunctiondefinition)[]: An array of data manifest custom resource definitions.
...
* **selfServeExemptionSettings**: [SelfServeExemptionSettings](#selfserveexemptionsettings): The self-serve exemption settings for the policy assignment.
...
### Properties
* **assignmentScopeValidation**: 'Default' | 'DoNotValidate' | string: The option whether to validate the enrollment is at or under the assignment scope.
* **description**: string: The description of the policy enrollment.
* **displayName**: string: The display name of the policy enrollment.
* **metadata**: any: The policy enrollment metadata. Metadata is an open ended object and is typically a collection of key value pairs.
* **policyAssignmentId**: string (Required): The ID of the policy assignment that is being enrolled.
* **policyAssignmentInstanceId**: string {minLength: 36, maxLength: 36, pattern: "^[0-9a-fA-F]{8}-([0-9a-fA-F]{4}-){3}[0-9a-fA-F]{12}$"} (ReadOnly): The policy assignment instance ID associated with this enrollment.
...
* **policyDefinitionReferenceIds**: string[]: The policy definition reference IDs for policy definitions in an assigned policy set definition.
...
* **kind**: 'groupPrincipalId' | 'policyDefinitionReferenceId' | 'resourceLocation' | 'resourceType' | 'resourceWithoutLocation' | 'userPrincipalId' | string: The selector kind.
* **notIn**: string[]: The list of values to filter out.

## SelfServeExemptionSettings
### Properties
* **enabled**: bool: Indicates whether self-serve exemption is enabled.
* **policyDefinitionReferenceIds**: string[]: The policy definition reference IDs for self-serve exemption.
