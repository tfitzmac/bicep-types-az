...
## Resource Microsoft.Network/expressRouteCircuits/peerings/peerConnections@2018-10-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2018-10-01' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): A unique read-only string that changes whenever the resource is updated.
...
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string (Required, DeployTimeConstant): The resource name
* **properties**: [HubVirtualNetworkConnectionProperties](#hubvirtualnetworkconnectionproperties) (ReadOnly): Properties of the hub virtual network connection.
...
## Resource Microsoft.Network/vpnGateways/vpnConnections/vpnLinkConnections@2018-10-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2018-10-01' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): A unique read-only string that changes whenever the resource is updated.
...
## Resource Microsoft.Network/vpnSites/vpnSiteLinks@2018-10-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2018-10-01' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): A unique read-only string that changes whenever the resource is updated.
...
* **cipher**: 'gcm-aes-128' | 'gcm-aes-256' | string: Mac security cipher.
...
* **priority**: int {minValue: 100, maxValue: 65000}: Priority of the Firewall Policy Rule resource.
...
#### Properties
* **action**: [FirewallPolicyNatRuleAction](#firewallpolicynatruleaction): The action type of a Nat rule.
...
### Properties
* **priority**: int {minValue: 100, maxValue: 65000}: Priority of the Firewall Policy Rule Group resource.
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating' | string (ReadOnly): The provisioning state of the firewall policy rule group resource.
...
### Properties
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating' | string (ReadOnly): The provisioning state of the radius client root certificate resource.
...
### Properties
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating' | string (ReadOnly): The provisioning state of the radius server root certificate resource.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating' | string (ReadOnly): The provisioning state of the P2S VPN server configuration resource.
...
### Properties
* **peerAsn**: int {minValue: 1, maxValue: 4294967295}: Peer ASN.
...
* **provisioningState**: 'Deleting' | 'Failed' | 'Succeeded' | 'Updating' | string (ReadOnly): The provisioning state of the resource.
* **virtualRouterAsn**: int {minValue: 1, maxValue: 4294967295}: VirtualRouter ASN.
