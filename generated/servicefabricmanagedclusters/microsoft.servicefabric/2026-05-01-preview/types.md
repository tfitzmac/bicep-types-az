...
## Resource Microsoft.ServiceFabric/managedClusters@2026-05-01-preview
...
## Resource Microsoft.ServiceFabric/managedClusters/applications@2026-05-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ServiceFabric/managedClusters/applications/services@2026-05-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ServiceFabric/managedClusters/applicationTypes@2026-05-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ServiceFabric/managedClusters/applicationTypes/versions@2026-05-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ServiceFabric/managedClusters/nodeTypes@2026-05-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Function listFaultSimulation (Microsoft.ServiceFabric/managedClusters@2026-05-01-preview)
* **Resource**: Microsoft.ServiceFabric/managedClusters
* **ApiVersion**: 2026-05-01-preview
* **Output**: [FaultSimulationListResult](#faultsimulationlistresult)

## Function listFaultSimulation (Microsoft.ServiceFabric/managedClusters/nodeTypes@2026-05-01-preview)
...
* **serviceTypeHealthPolicyMap**: [ApplicationHealthPolicyServiceTypeHealthPolicyMap](#applicationhealthpolicyservicetypehealthpolicymap): The map with service type health policy per service type name. The map is empty by default.
...
* **parameters**: [ApplicationResourcePropertiesParameters](#applicationresourcepropertiesparameters): List of application parameters with overridden values from their default values specified in the application manifest.
...
## ApplicationResourcePropertiesParameters
### Properties
### Additional Properties
...
## ApplicationTypeVersionResourceTags
### Properties
### Additional Properties
* **Additional Properties Type**: string
...
## FaultSimulation
### Properties
* **details**: [FaultSimulationDetails](#faultsimulationdetails): Fault simulation details
* **endTime**: string: The end time of the fault simulation.
* **simulationId**: string: unique identifier for the fault simulation.
* **startTime**: string: The start time of the fault simulation.
* **status**: 'Active' | 'Done' | 'StartFailed' | 'Starting' | 'StopFailed' | 'Stopping' | string: Fault simulation status

## FaultSimulationConstraints
### Properties
* **expirationTime**: string: The absolute expiration timestamp (UTC) after which this fault simulation should be stopped if it's still active.

## FaultSimulationContent
* **Discriminator**: faultKind

### Base Properties
* **constraints**: [FaultSimulationConstraints](#faultsimulationconstraints): Constraints for Fault Simulation action.
* **force**: bool: Force the action to go through without any check on the cluster.

### ZoneFaultSimulationContent
#### Properties
* **faultKind**: 'Zone' (Required): The kind of fault to be simulated.
...
* **value**: [FaultSimulation](#faultsimulation)[] (Required): The FaultSimulation items on this page
...
* **publicIPAddressConfiguration**: [PublicIPAddressConfiguration](#publicipaddressconfiguration): The public IP address configuration of the network interface.
...
* **enableOutboundOnlyNodeTypes**: bool: Enable the creation of node types with only outbound traffic enabled. If set, a separate load balancer backend pool will be created for node types with inbound traffic enabled. Can only be set at the time of cluster creation.
...
* **skipManagedNsgAssignment**: bool: Determines whether to skip the assignment of the managed network security group (SF-NSG) to the cluster subnet when using a bring-your-own virtual network (BYOVNET) configuration. The default value is false.
...
* **operationId**: string: Current or latest asynchronous operation identifier on the node type.
* **operationStatus**: 'Aborted' | 'Canceled' | 'Created' | 'Failed' | 'Started' | 'Succeeded' | string (ReadOnly): Current or latest asynchronous operation status on the node type
* **status**: 'Active' | 'Done' | 'StartFailed' | 'Starting' | 'StopFailed' | 'Stopping' | string: Fault simulation status
...
* **dataDiskType**: 'PremiumV2_LRS' | 'Premium_LRS' | 'Premium_ZRS' | 'StandardSSD_LRS' | 'StandardSSD_ZRS' | 'Standard_LRS' | string: Managed data disk type. Specifies the storage account type for the managed disk
...
* **enableResilientEphemeralOsDisk**: bool: Specifies whether the node type should use a resilient ephemeral OS disk when using a supported SKU size. A resilient ephemeral OS disk provides improved reliability for ephemeral OS disks by enabling full caching.
...
* **isOutboundOnly**: bool: Specifies the node type should be configured for only outbound traffic and not inbound traffic.
...
* **proxyAgentSettings**: [ProxyAgentSettings](#proxyagentsettings): Specifies the settings for the proxy agent on the node type.
* **scaleInPolicy**: [ScaleInPolicy](#scaleinpolicy): Specifies the scale in policy for the node type, which will be used when scale in happens on the cluster. If not specified, the default is Default which means the platform will decide which nodes to remove during scale in.
...
* **vmInstanceCount**: int {minValue: -1, maxValue: 2147483647} (Required): The number of nodes in the node type. **Values:** -1 - Use when auto scale rules are configured or sku.capacity is defined 0 - Not supported >0 - Use for manual scale.
...
* **zoneBalance**: bool: Setting this to true allows stateless node types to scale out without equal distribution across zones.
...
## NodeTypeSku
### Properties
* **capacity**: int {minValue: 1, maxValue: 2147483647} (Required): The number of nodes in the node type. If present in request it will override properties.vmInstanceCount.
* **name**: string: The sku name. Name is internally generated and is used in auto-scale scenarios. Property does not allow to be changed to other values than generated. To avoid deployment errors please omit the property.
* **tier**: string: Specifies the tier of the node type. Possible Values: **Standard**
...
* **partitionScheme**: 'Named' (Required): Enumerates the ways that a service can be partitioned.

### SingletonPartitionScheme
#### Properties
* **partitionScheme**: 'Singleton' (Required): Enumerates the ways that a service can be partitioned.
...
should be split between the partition ‘Count’
* **partitionScheme**: 'UniformInt64Range' (Required): Enumerates the ways that a service can be partitioned.
...
* **imds**: [HostEndpointSettings](#hostendpointsettings): Specifies the IMDS endpoint settings while creating the virtual machine or virtual machine scale set.
* **keyIncarnationId**: int: Increasing the value of this property allows users to reset the key used for securing communication channel between guest and host.
* **wireServer**: [HostEndpointSettings](#hostendpointsettings): Specifies the Wire Server endpoint settings while creating the virtual machine or virtual machine scale set.
...
## ScaleInPolicy
### Properties
* **mode**: 'Default' | 'NewestNodeFirst' | 'OldestNodeFirst' | string: The scale in policy mode for a node type.
...
#### Properties
* **kind**: 'AddRemoveIncrementalNamedPartition' (Required): Enumerates the ways that a service can be partitioned.
...
#### Properties
* **kind**: 'ScalePartitionInstanceCount' (Required): Enumerates the ways that a service can be partitioned.
...
#### Properties
* **kind**: 'AveragePartitionLoadTrigger' (Required): Enumerates the ways that a service can be partitioned.
...
#### Properties
* **kind**: 'AverageServiceLoadTrigger' (Required): Enumerates the ways that a service can be partitioned.
* **lowerLoadThreshold**: int (Required): The lower limit of the load below which a scale in operation should be performed.
* **metricName**: string (Required): The name of the metric for which usage should be tracked.
* **scaleInterval**: string (Required): The period in seconds on which a decision is made whether to scale or not. This property should come in ISO 8601 format "hh:mm:ss".
* **upperLoadThreshold**: int (Required): The upper limit of the load beyond which a scale out operation should be performed.
...
* **networkIdentifier**: string: Specifies the resource id of the service endpoint to be used in the cluster.
...
* **diskType**: 'PremiumV2_LRS' | 'Premium_LRS' | 'Premium_ZRS' | 'StandardSSD_LRS' | 'StandardSSD_ZRS' | 'Standard_LRS' | string (Required): Managed data disk type. Specifies the storage account type for the managed disk
