...
## Resource Microsoft.ManagedIdentity/identities@2025-05-31-preview (ReadOnly)
...
## Resource Microsoft.ManagedIdentity/userAssignedIdentities@2025-05-31-preview
...
## Resource Microsoft.ManagedIdentity/userAssignedIdentities/federatedIdentityCredentials@2025-05-31-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-05-31-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
### Properties
* **providers**: string[]: List of resource providers or resource providers with resource types that this identity can be assigned to (case-insensitive). Examples: 'Microsoft.Compute', 'Microsoft.Storage/Accounts', 'Microsoft.Network/VirtualNetworks'.
...
* **claimsMatchingExpression**: [ClaimsMatchingExpression](#claimsmatchingexpression): Object for defining the allowed identifiers of external identities. Either 'subject' or 'claimsMatchingExpression' must be defined, but not both. Introduced in 2025-01-31-preview.
...
### Properties
* **assignmentRestrictions**: [AssignmentRestrictions](#assignmentrestrictions): Restrictions on which resource providers this identity can be assigned to.
* **clientId**: string {minLength: 36, maxLength: 36, pattern: "^[0-9a-fA-F]{8}-([0-9a-fA-F]{4}-){3}[0-9a-fA-F]{12}$"} (ReadOnly): The id of the app associated with the identity. This is a random generated UUID by MSI.
