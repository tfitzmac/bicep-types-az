# Microsoft.VirtualMachineImages @ 2025-10-01

## Resource Microsoft.VirtualMachineImages/imageTemplates@2025-10-01
...
## Resource Microsoft.VirtualMachineImages/imageTemplates/runOutputs@2025-10-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-10-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.VirtualMachineImages/imageTemplates/triggers@2025-10-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-10-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## DataDisk
### Properties
* **sizeGB**: int {minValue: 0}: Size of the data disk in GB.
...
* **replicationMode**: 'Full' | 'Shallow' | string: Describes replication mode for distribution in Azure Compute Gallery. Omit to use the default (Full).
...
### Properties
* **additionalDataDisks**: [DataDisk](#datadisk)[]: Optional array of additional data disks to be added to the image.
...
* **workload**: [ImageTemplatePropertiesOptimizeWorkload](#imagetemplatepropertiesoptimizeworkload): Optimization is applied on the image for specific workloads.
...
### Properties
* **scriptUri**: string: URI of the script to be run for workload optimization. It can be a github link, SAS URI for Azure Storage, etc
* **sha256Checksum**: string: SHA256 checksum of the script provided in the scriptUri field
* **state**: 'Disabled' | 'Enabled': Enabling this field will optimize vm images for specific workloads.
