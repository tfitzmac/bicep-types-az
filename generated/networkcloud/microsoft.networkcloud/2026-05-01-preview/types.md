# Microsoft.NetworkCloud @ 2026-05-01-preview

## Resource Microsoft.NetworkCloud/accessBridges@2026-05-01-preview
...
* **name**: 'Bastion' | 'PrivateVault' | 'StorageDashboard' | string (Required, DeployTimeConstant): The resource name
* **properties**: [AccessBridgeProperties](#accessbridgeproperties) (Required): The list of the resource properties.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **tags**: [TrackedResourceTags](#trackedresourcetags): Resource tags.
* **type**: 'Microsoft.NetworkCloud/accessBridges' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.NetworkCloud/bareMetalMachines@2026-05-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): "If etag is provided in the response body, it may also be provided as a header per the normal etag convention.  Entity tags are used for comparing two or more entities from the same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields.")
...
## Resource Microsoft.NetworkCloud/cloudServicesNetworks@2026-05-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): "If etag is provided in the response body, it may also be provided as a header per the normal etag convention.  Entity tags are used for comparing two or more entities from the same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields.")
...
## Resource Microsoft.NetworkCloud/clusterManagers@2026-05-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): "If etag is provided in the response body, it may also be provided as a header per the normal etag convention.  Entity tags are used for comparing two or more entities from the same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields.")
...
* **kind**: 'AzureLocal' | 'Nexus' | string: The kind of the cluster manager.
* **location**: string (Required): The geo-location where the resource lives
* **name**: string {pattern: "^([a-zA-Z0-9][a-zA-Z0-9-_]{0,28}[a-zA-Z0-9])$"} (Required, DeployTimeConstant): The resource name
...
## Resource Microsoft.NetworkCloud/clusters@2026-05-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): "If etag is provided in the response body, it may also be provided as a header per the normal etag convention.  Entity tags are used for comparing two or more entities from the same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields.")
...
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **identity**: [ManagedServiceIdentity](#managedserviceidentity): The managed service identities assigned to this resource.
* **kind**: 'AzureLocal' | 'Nexus' | string: The type (kind) of the cluster. When specified, the value must exactly match the kind configured on the cluster manager that manages the cluster. If omitted, the service will default the value to the kind value of the cluster manager.
* **location**: string (Required): The geo-location where the resource lives
* **name**: string {pattern: "^([a-zA-Z0-9][a-zA-Z0-9-_]{0,28}[a-zA-Z0-9])$"} (Required, DeployTimeConstant): The resource name
...
## Resource Microsoft.NetworkCloud/clusters/bareMetalMachineKeySets@2026-05-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): "If etag is provided in the response body, it may also be provided as a header per the normal etag convention.  Entity tags are used for comparing two or more entities from the same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields.")
...
## Resource Microsoft.NetworkCloud/clusters/bmcKeySets@2026-05-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): "If etag is provided in the response body, it may also be provided as a header per the normal etag convention.  Entity tags are used for comparing two or more entities from the same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields.")
...
## Resource Microsoft.NetworkCloud/clusters/metricsConfigurations@2026-05-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): "If etag is provided in the response body, it may also be provided as a header per the normal etag convention.  Entity tags are used for comparing two or more entities from the same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields.")
...
## Resource Microsoft.NetworkCloud/kubernetesClusters@2026-05-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): "If etag is provided in the response body, it may also be provided as a header per the normal etag convention.  Entity tags are used for comparing two or more entities from the same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields.")
...
## Resource Microsoft.NetworkCloud/kubernetesClusters/agentPools@2026-05-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): "If etag is provided in the response body, it may also be provided as a header per the normal etag convention.  Entity tags are used for comparing two or more entities from the same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields.")
...
## Resource Microsoft.NetworkCloud/kubernetesClusters/features@2026-05-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): "If etag is provided in the response body, it may also be provided as a header per the normal etag convention.  Entity tags are used for comparing two or more entities from the same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields.")
...
## Resource Microsoft.NetworkCloud/kubernetesVersions@2026-05-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): "If etag is provided in the response body, it may also be provided as a header per the normal etag convention.  Entity tags are used for comparing two or more entities from the same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields.")
...
* **location**: string (Required): The geo-location where the resource lives
* **name**: string {pattern: "^default$"} (Required, DeployTimeConstant): The resource name
* **properties**: [KubernetesVersionProperties](#kubernetesversionproperties) (Required): The list of the resource properties.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **tags**: [TrackedResourceTags](#trackedresourcetags): Resource tags.
* **type**: 'Microsoft.NetworkCloud/kubernetesVersions' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.NetworkCloud/l2Networks@2026-05-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): "If etag is provided in the response body, it may also be provided as a header per the normal etag convention.  Entity tags are used for comparing two or more entities from the same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields.")
...
## Resource Microsoft.NetworkCloud/l3Networks@2026-05-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): "If etag is provided in the response body, it may also be provided as a header per the normal etag convention.  Entity tags are used for comparing two or more entities from the same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields.")
...
## Resource Microsoft.NetworkCloud/racks@2026-05-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): "If etag is provided in the response body, it may also be provided as a header per the normal etag convention.  Entity tags are used for comparing two or more entities from the same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields.")
...
## Resource Microsoft.NetworkCloud/rackSkus@2026-05-01-preview (ReadOnly)
...
## Resource Microsoft.NetworkCloud/storageAppliances@2026-05-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): "If etag is provided in the response body, it may also be provided as a header per the normal etag convention.  Entity tags are used for comparing two or more entities from the same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields.")
...
## Resource Microsoft.NetworkCloud/trunkedNetworks@2026-05-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): "If etag is provided in the response body, it may also be provided as a header per the normal etag convention.  Entity tags are used for comparing two or more entities from the same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields.")
...
## Resource Microsoft.NetworkCloud/virtualMachines@2026-05-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): "If etag is provided in the response body, it may also be provided as a header per the normal etag convention.  Entity tags are used for comparing two or more entities from the same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields.")
...
## Resource Microsoft.NetworkCloud/virtualMachines/consoles@2026-05-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): "If etag is provided in the response body, it may also be provided as a header per the normal etag convention.  Entity tags are used for comparing two or more entities from the same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields.")
...
## Resource Microsoft.NetworkCloud/volumes@2026-05-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): "If etag is provided in the response body, it may also be provided as a header per the normal etag convention.  Entity tags are used for comparing two or more entities from the same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields.")
...
### Properties
* **fqdn**: string (ReadOnly): The fully qualified domain name used to describe the certificate name for the endpoint.
* **ipv4Address**: string (ReadOnly): The IPv4 address associated with the endpoint.
* **ipv6Address**: string (ReadOnly): The IPv6 address associated with the endpoint.
* **name**: string (ReadOnly): The name that identifies the type of endpoint (for example VIP or host).

## AccessBridgeProperties
### Properties
* **detailedStatus**: 'Degraded' | 'Failed' | 'Running' | string (ReadOnly): The detailed status reported by the access bridge.
* **detailedStatusMessage**: string (ReadOnly): The descriptive message that accompanies the detailed status.
* **endpoints**: [AccessBridgeEndpoint](#accessbridgeendpoint)[] (ReadOnly): The observed endpoints that clients should use to reach the access bridge.
...
* **networkId**: string (Required): The resource ID of the internal network in a layer 3 isolation domain containing the IP subnets to use.
* **protocol**: 'TCP' | 'UDP' | string (ReadOnly): The protocol advertised by the access bridge endpoints.
* **provisioningState**: 'Accepted' | 'Canceled' | 'Failed' | 'Provisioning' | 'Succeeded' | string (ReadOnly): The provisioning state of the access bridge.
* **securityRules**: [AccessBridgeSecurityRule](#accessbridgesecurityrule)[]: The list of security rules enforced by the access bridge.

## AccessBridgeSecurityRule
### Properties
* **description**: string: The user provided value describing this rule.
* **direction**: 'Inbound' | 'Outbound' | string (Required): The direction of allowed network traffic based on the rule.
* **ipv4Addresses**: string[]: The set of IPv4 addresses permitted as the source or destination of the security rule. For as single address, utilize a /32 (CIDR notation). One or both Ipv4Addresses and Ipv6Addresses must be specified. Example formats: 10.10.10.10-10.10.10.20 or 10.10.10.10/24.
* **ipv6Addresses**: string[]: The set of IPv6 addresses permitted as the source or destination of the security rule. For as single address, utilize a /128 (CIDR notation). One or both Ipv4Addresses and Ipv6Addresses must be specified. Example formats: 2001:db8:abcd::1-2001:db8:abcd::ff or 2001:db8:abcd::1/64.
* **port**: string (Required): The source or destination port or port range. Example 24562 or 24562-24570.
...
### Properties
* **logLevel**: 'Default' | 'Nexus' | string: The log level for the monitoring configuration status of the bare metal machine.
* **metricsLevel**: 'Default' | 'Nexus' | string: The metrics level for the monitoring configuration status of the bare metal machine.
...
* **bmcIpv4Address**: string (ReadOnly): The IPv4 address of the BMC interface for the bare metal machine.
* **bmcIpv6Address**: string (ReadOnly): The IPv6 address of the BMC interface for the bare metal machine.
...
* **monitoringConfigurationStatus**: [BareMetalMachineMonitoringConfigurationStatus](#baremetalmachinemonitoringconfigurationstatus) (ReadOnly): The monitoring configuration status of the bare metal machine.
...
* **status**: 'Available' | 'ExpandingVolume' | 'ExpansionFailed' | 'Initializing' | 'None' | 'Repairing' | string (ReadOnly): The status of the storage allocation for the cloud services network.
...
* **relayConfiguration**: [ClusterManagerRelayConfiguration](#clustermanagerrelayconfiguration) (ReadOnly): The relay configuration for the cluster manager.
...
### Properties
* **relayNamespaceId**: string: The resource ID of the Azure relay namespace managed by the cluster manager.
...
* **lastSuccessfulVersionUpdateTime**: string (ReadOnly): The date and time of the end of the last successful version update for the cluster.
* **managedCredentials**: string[] (ReadOnly): The list of credentials that are managed for the cluster and can be rotated on-demand.
* **managedResourceGroupConfiguration**: [ManagedResourceGroupConfiguration](#managedresourcegroupconfiguration): The configuration of the managed resource group associated with the resource.
...
* **commandOutputType**: 'BareMetalMachineRunCommand' | 'BareMetalMachineRunDataExtracts' | 'BareMetalMachineRunDataExtractsRestricted' | 'BareMetalMachineRunReadCommands' | 'ClusterSupportAdministrativeActions' | 'StorageRunReadCommands' | string: The type of command output for the override.
...
### Properties
* **provisioningState**: 'Accepted' | 'Canceled' | 'Failed' | 'Succeeded' | string (ReadOnly): The provisioning state of the Kubernetes version resource.
* **values**: [KubernetesVersionValue](#kubernetesversionvalue)[] (ReadOnly): The list of available Kubernetes versions.

## KubernetesVersionValue
### Properties
* **description**: string (ReadOnly): Additional description for the Kubernetes version.
* **version**: string (ReadOnly): The Kubernetes version identifier.
...
* **deploymentType**: 'AzureLocal' | 'Nexus' | string (ReadOnly): The deployment type supported by the rack SKU.
...
### Properties
* **definitionUpdateMode**: 'Automatic' | 'None' | string: The definition update mode for runtime protection.
* **enforcementLevel**: 'Audit' | 'Disabled' | 'OnDemand' | 'Passive' | 'RealTime' | string: The mode of operation for runtime protection.

## RuntimeProtectionStatus
### Properties
* **agentHealthStatus**: 'Healthy' | 'Unhealthy' | string (ReadOnly): The runtime protection agent health status.
* **agentHealthStatusIssues**: string[] (ReadOnly): The runtime protection agent health status issues, if present.
* **agentLicenseStatus**: 'Licensed' | 'Unlicensed' | string (ReadOnly): The runtime protection agent license status.
...
* **definitionUpdateMode**: 'Automatic' | 'None' | string (ReadOnly): The definition update mode for runtime protection.
* **enforcementLevel**: 'Audit' | 'Disabled' | 'OnDemand' | 'Passive' | 'RealTime' | string (ReadOnly): The enforcement level set for the runtime protection on the bare metal machine.
...
### Properties
* **model**: string: The model of the expansion shelf.
* **version**: string: The version of the expansion shelf.

## StorageApplianceMonitoringConfigurationStatus
### Properties
* **logLevel**: 'Default' | 'Nexus' | string: The log level for the monitoring configuration status of the storage appliance.
* **metricsLevel**: 'Default' | 'Nexus' | string: The metrics level for the monitoring configuration status of the storage appliance.
...
* **detailedStatusMessage**: string (ReadOnly): The descriptive message about the current detailed status.
* **expansionShelves**: [StorageApplianceExpansionShelf](#storageapplianceexpansionshelf)[] (ReadOnly): The list of expansion shelves connected to the storage appliance.
...
* **monitoringConfigurationStatus**: [StorageApplianceMonitoringConfigurationStatus](#storageappliancemonitoringconfigurationstatus) (ReadOnly): The monitoring configuration status of the storage appliance.
...
* **assignedStorageApplianceId**: string (ReadOnly): The assigned resource ID of the storage appliance that hosts the volume.
