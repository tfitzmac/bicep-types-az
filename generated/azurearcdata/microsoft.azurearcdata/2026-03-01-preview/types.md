# Microsoft.AzureArcData @ 2026-03-01-preview

## Resource Microsoft.AzureArcData/dataControllers@2026-03-01-preview
...
## Resource Microsoft.AzureArcData/dataControllers/activeDirectoryConnectors@2026-03-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AzureArcData/postgresInstances@2026-03-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **extendedLocation**: [ExtendedLocation](#extendedlocation): The extendedLocation of the resource.
...
## Resource Microsoft.AzureArcData/sqlManagedInstances@2026-03-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **extendedLocation**: [ExtendedLocation](#extendedlocation): The extendedLocation of the resource.
...
## Resource Microsoft.AzureArcData/sqlManagedInstances/failoverGroups@2026-03-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AzureArcData/sqlServerEsuLicenses@2026-03-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AzureArcData/sqlServerInstances@2026-03-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AzureArcData/sqlServerInstances/availabilityGroups@2026-03-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AzureArcData/sqlServerInstances/databases@2026-03-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.AzureArcData/sqlServerLicenses@2026-03-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
### Properties
* **keyName**: string: Unique attribute name.
* **keyValue**: string: Attribute value.
...
* **jobs**: [DatabaseMigrationJobsItem](#databasemigrationjobsitem)[]: Migration jobs/actual data movement/data migrations associated with this database related information.
...
* **targetRecommendationGenerationTime**: string (ReadOnly): The UTC timestamp in ISO 8601 format indicating when the latest target recommendations were generated for this database. This value is set as part of a successful RunTargetRecommendation job and is independent of when the migration readiness results were uploaded (assessmentUploadTime).

## DatabaseMigrationJobsItem
### Properties
* **additionalAttributes**: [AdditionalMigrationJobAttributes](#additionalmigrationjobattributes)[]
* **endTime**: string: Time when migration job reached terminal state.
* **initiatedFrom**: 'ADS' | 'Azure Arc' | 'DMS-CLI' | 'DMS-PS' | 'DMS-Portal' | 'DMS-SDK' | 'Other' | 'SSMA' | 'SSMS' | string: To indicate the client from which the migration is initiated from e.g. Azure Arc, DMS-Azure Portal/PS/CLI for additional tracking.
* **lastError**: string: Last error if any associated with this migration job.
* **migrationMode**: 'LogShipping' | 'Logical' | 'MILink' | 'Other' | 'Unknown' | string: Mode/type of migration.
* **migrationTrackingId**: string: Reference identifier for tracking purposes/optional link to system initiating this migration. e.g. Arc MI link job id, DMS resource id.
* **startTime**: string: Time when migration job was started.
* **status**: 'Cancelled' | 'Failed' | 'InProgress' | 'InProgressWithWarnings' | 'NotStarted' | 'Successful' | 'Unknown' | string: Status of the migration job.
* **targetResourceId**: string: Resource Id of the target SQL resource for this migration job.
* **targetType**: 'AzureSqlDatabase' | 'AzureSqlManagedInstance' | 'AzureSqlVirtualMachine' | string: Type of target in Azure this database is being migrated to.
...
* **maxIops**: int: maximum IO requirements/s (IOPS).
...
* **targetResourceId**: string: Resource Id of the created or selected target SQL resource for migration.
* **targetSelectedTime**: string: The last time when the target resource was selected for migration.

## MigrationAssessment
### Properties
* **assessmentUploadTime**: string (ReadOnly): The time when Migration Assessment Report upload was last performed.
* **assessmentViewedTime**: string: The time when this migration assessment was last viewed.
...
* **targetRecommendationGenerationTime**: string (ReadOnly): The UTC timestamp in ISO 8601 format indicating when the latest target recommendations were generated for this SQL Server instance. This value is set as part of a successful RunTargetRecommendation job and is independent of when the migration readiness results were uploaded (assessmentUploadTime).
...
### Properties
* **comfortFactor**: int: Buffer (percentage) to consider while SKU sizing to account for issues such as seasonal usage, short performance history, and likely increases in future usage - This buffer is applied on top of the performance metrics. Default is 100 (percent).
* **costOptions**: [CostOptionSelectedValues](#costoptionselectedvalues): Selected cost option value.
* **currency**: string: currency to calculate prices - Default is USD.
* **discountPercentage**: int: flat discount percentage to apply for the price - Default is 0
...
* **strategy**: string: Minimize cost or Migrate to PaaS. - to evaluate based on the recommended strategy. Default is Migrate to PaaS
* **targetLocation**: string: The target location for Azure SQL SKU for migration. Default is West US.
...
* **version**: 'SQL Server 2012' | 'SQL Server 2014' | 'SQL Server 2016' | string (Required): The SQL Server version the license covers.
...
* **discoverySource**: 'ADS' | 'Azure Arc' | 'Azure Migrate' | 'DMS-CLI' | 'DMS-PS' | 'DMS-Portal' | 'DMS-SDK' | 'Import' | 'Other' | 'SSMA' | 'SSMS' | string: Indicates the discovery agent or client for this instance.
* **edition**: 'Business Intelligence' | 'Developer' | 'Enterprise' | 'Evaluation' | 'Express' | 'Standard Developer' | 'Standard' | 'Unknown' | 'Web' | string: SQL Server edition.
* **failoverCluster**: [FailoverCluster](#failovercluster): Failover Cluster Instance properties.
* **hostType**: 'AWS Kubernetes Service' | 'AWS VMWare Virtual Machine' | 'AWS Virtual Machine' | 'Azure Kubernetes Service' | 'Azure VMWare Virtual Machine' | 'Azure Virtual Machine' | 'Container' | 'GCP Kubernetes Service' | 'GCP VMWare Virtual Machine' | 'GCP Virtual Machine' | 'Hyper-V Virtual Machine' | 'Other' | 'Physical Server' | 'Virtual Machine' | string: Type of host for Azure Arc SQL Server
...
* **migration**: [Migration](#migration): Migration related configuration and status.
...
* **status**: 'Connected' | 'Disconnected' | 'Discovered' | 'Registered' | 'Unknown' | string (ReadOnly): The cloud connectivity status.
