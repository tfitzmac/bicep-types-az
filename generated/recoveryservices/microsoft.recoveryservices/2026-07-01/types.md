...
## Resource Microsoft.RecoveryServices/locations/deletedVaults@2026-07-01 (ReadOnly)
...
* **properties**: [DeletedVaultProperties](#deletedvaultproperties) (ReadOnly): The resource-specific properties for this resource.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.RecoveryServices/locations/deletedVaults' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.RecoveryServices/vaults@2026-07-01
...
## Resource Microsoft.RecoveryServices/vaults/certificates@2026-07-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.RecoveryServices/vaults/extendedInformation@2026-07-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string: etag for the resource.
...
## Resource Microsoft.RecoveryServices/vaults/operationResults@2026-07-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.RecoveryServices/vaults/privateLinkResources@2026-07-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
### Properties
* **durationInDays**: int {minValue: 30, maxValue: 36135}: Duration in days. Required when type is TimeBased, omitted when AsPerPolicy.
* **type**: 'AsPerPolicy' | 'TimeBased' | string: Immutability type. 'AsPerPolicy' inherits duration from backup policy; 'TimeBased' requires explicit durationInDays.

## ImmutabilitySettings
### Properties
* **configuration**: [ImmutabilityConfiguration](#immutabilityconfiguration): Immutability configuration of the vault — selects whether immutability is
...
### Properties
* **status**: 'Disabled' | 'Enabled' | 'Invalid' | string: The status of region of choice settings - Enabled or Disabled.
...
* **regionOfChoiceSettings**: [RegionOfChoiceSettings](#regionofchoicesettings): Region of choice settings for this vault.
