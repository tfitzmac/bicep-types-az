# Microsoft.Batch @ 2025-06-01

## Resource Microsoft.Batch/batchAccounts@2025-06-01
...
## Resource Microsoft.Batch/batchAccounts/applications@2025-06-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-06-01' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Batch/batchAccounts/applications/versions@2025-06-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-06-01' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): The ETag of the resource, used for concurrency statements.
...
## Resource Microsoft.Batch/batchAccounts/detectors@2025-06-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-06-01' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): The ETag of the resource, used for concurrency statements.
...
## Resource Microsoft.Batch/batchAccounts/networkSecurityPerimeterConfigurations@2025-06-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-06-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Batch/batchAccounts/pools@2025-06-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-06-01' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): The ETag of the resource, used for concurrency statements.
...
## Resource Microsoft.Batch/batchAccounts/privateEndpointConnections@2025-06-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-06-01' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): The ETag of the resource, used for concurrency statements.
...
## Resource Microsoft.Batch/batchAccounts/privateLinkResources@2025-06-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-06-01' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): The ETag of the resource, used for concurrency statements.
...
### Properties
* **identityReference**: [ComputeNodeIdentityReference](#computenodeidentityreference): The reference of one of the pool identities to encrypt Disk. This identity will be used to access the KeyVault.
...
### Properties
* **id**: string (Required): The ARM resource id of the disk encryption set. The resource should be in the same subscription as the Batch account.
...
* **mode**: 'Audit' | 'Enforce' | string: Specifies the access control policy execution mode.
...
## IPTag
### Properties
* **ipTagType**: string: Example: FirstPartyUsage.
* **tag**: string: Example: SQL.
...
## ManagedDisk
### Properties
* **diskEncryptionSet**: [DiskEncryptionSetParameters](#diskencryptionsetparameters): Specifies the customer managed disk encryption set resource id for the managed disk. It can be set only in UserSubscription mode.
...
## ProxyAgentSettings
### Properties
* **enabled**: bool: Specifies whether Metadata Security Protocol feature should be enabled on the virtual machine or virtual machine scale set. Default is False.
* **imds**: [HostEndpointSettings](#hostendpointsettings): Settings for the IMDS endpoint.
* **wireServer**: [HostEndpointSettings](#hostendpointsettings): Settings for the WireServer endpoint.
...
* **ipFamilies**: ('IPv4' | 'IPv6' | string)[]: IP families are used to determine single-stack or dual-stack pools. For single-stack, the expected value is IPv4. For dual-stack, the expected values are IPv4 and IPv6.
* **ipTags**: [IPTag](#iptag)[]: IP Tags that will applied to new Public IPs that Batch creates.
...
* **proxyAgentSettings**: [ProxyAgentSettings](#proxyagentsettings): Specifies ProxyAgent settings while creating the virtual machine.
...
### Properties
* **jobDefaultOrder**: 'CreationTime' | 'None' | string: The order for scheduling tasks from different jobs with the same priority.
...
### Properties
* **diskEncryptionSet**: [DiskEncryptionSetParameters](#diskencryptionsetparameters): Specifies the customer managed disk encryption set resource id for the managed disk that is used for Customer Managed Key encrypted ConfidentialVM OS Disk and VMGuest blob. It can be set only in UserSubscription mode.
