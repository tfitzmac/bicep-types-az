# Microsoft.StorageSync @ 2025-12-01

## Resource Microsoft.StorageSync/storageSyncServices@2025-12-01
...
## Resource Microsoft.StorageSync/storageSyncServices/privateEndpointConnections@2025-12-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-12-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.StorageSync/storageSyncServices/registeredServers@2025-12-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-12-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.StorageSync/storageSyncServices/syncGroups@2025-12-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-12-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.StorageSync/storageSyncServices/syncGroups/cloudEndpoints@2025-12-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-12-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.StorageSync/storageSyncServices/syncGroups/serverEndpoints@2025-12-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-12-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.StorageSync/storageSyncServices/workflows@2025-12-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-12-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
* **changeEnumerationIntervalDays**: int {minValue: 1, maxValue: 20}: The interval for enumerating changes on the cloud endpoint.
...
* **serverEndpointProvisioningStatus**: [ServerEndpointProvisioningStatus](#serverendpointprovisioningstatus) (ReadOnly): Server Endpoint provisioning status
...
* **inProgressLargeFilePath**: string (ReadOnly): Path of large file currently in progress
* **inProgressLargeFilePercentComplete**: int {minValue: 0, maxValue: 100} (ReadOnly): Percent complete (0-100) of large file currently in progress
* **inProgressLargeFileSizeBytes**: int {minValue: 0} (ReadOnly): Size in bytes of large file currently in progress
* **isRemainingFinal**: bool (ReadOnly): Whether the remaining counts are final
* **perItemErrorCount**: int {minValue: 0} (ReadOnly): Per item error count
* **recentItemsPerSecond**: int (ReadOnly): Recent throughput in items per second
* **recentMegabytesPerSecond**: int (ReadOnly): Recent throughput in megabytes per second
* **remainingDeleteCount**: int {minValue: 0} (ReadOnly): Remaining delete count (if totals are final)
* **remainingDirectoryCount**: int {minValue: 0} (ReadOnly): Remaining directory count (if totals are final)
* **remainingFileCount**: int {minValue: 0} (ReadOnly): Remaining file count (if totals are final)
* **remainingLogicalSizeBytes**: int {minValue: 0} (ReadOnly): Remaining logical size in bytes (if totals are final)
...
* **warning**: 'BlockedByLargeFile' | 'NoWarning' | string (ReadOnly): Warning type (if any)
