# Microsoft.DevOpsInfrastructure @ 2026-07-03-preview

## Resource Microsoft.DevOpsInfrastructure/pools@2026-07-03-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-03-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## DevOpsAzureSku
### Properties
* **linuxNvmePath**: string: The mount path for the NVMe striped volume on Linux (e.g., '/mnt/azure_nvme_temp'). Defaults to '/mnt/azure_nvme_temp' when not specified.
* **name**: string (Required): The Azure SKU name of the machines in the pool.
* **vmSizes**: [VmSize](#vmsize)[]: Specifies VM sizes for instance-mix allocation.
* **windowsNvmeDrive**: string: The drive letter for the NVMe striped volume on Windows (e.g., 'N'). Defaults to 'N' when not specified.
...
## Organization
### Properties
* **alias**: string: An alias to reference the Azure DevOps pool name.
...
#### Properties
* **alias**: string: An alias to reference the Azure DevOps pool name.
* **description**: string: An extra description to add to the Azure DevOps pool.
...
* **updateDescription**: bool: Determines whether the service updates the Azure DevOps pool description.
...
* **ephemeralType**: 'Automatic' | 'CacheDisk' | 'NVMeDisk' | 'ResourceDisk' | string: The ephemeral type of the image.
* **isEphemeral**: bool (ReadOnly): Read only. Determines if the image is ephemeral.
* **provisioningScriptEntryPoint**: string: The provisioning script entry point for this image.
* **provisioningScriptManagedIdentityClientId**: string: The managed identity client ID used to access provisioning script content for this image.
* **provisioningScriptShouldRestart**: bool: Determines whether the machine should be restarted after provisioning script execution for this image.
* **provisioningScriptStorageAccountResourceId**: string: The ARM resource ID of the storage account hosting provisioning scripts for this image.
...
* **runtimeConfiguration**: [RuntimeConfiguration](#runtimeconfiguration): The runtime configuration of the pool.
