# Microsoft.SignalRService @ 2025-12-01-preview

## Resource Microsoft.SignalRService/webPubSub@2025-12-01-preview
...
## Resource Microsoft.SignalRService/webPubSub/customCertificates@2025-12-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-12-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.SignalRService/webPubSub/customDomains@2025-12-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-12-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.SignalRService/webPubSub/hubs@2025-12-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-12-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.SignalRService/webPubSub/persistentStorages@2025-12-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-12-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string (Required, DeployTimeConstant): The resource name
* **properties**: [PersistentStorageProperties](#persistentstorageproperties) (Required): Properties of a persistent storage.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.SignalRService/webPubSub/persistentStorages' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.SignalRService/webPubSub/privateEndpointConnections@2025-12-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-12-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.SignalRService/webPubSub/replicas@2025-12-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-12-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.SignalRService/webPubSub/replicas/sharedPrivateLinkResources@2025-12-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-12-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.SignalRService/webPubSub/sharedPrivateLinkResources@2025-12-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-12-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Function listKeys (Microsoft.SignalRService/webPubSub@2025-12-01-preview)
...
## ChatSettings
### Properties
* **mode**: string: Enable or disable the chat feature.
* **persistentStorage**: [ResourceReference](#resourcereference): Reference to the the persistent storage for perisisting chat states.
...
* **groupPresenceEvents**: [GroupPresenceEventFilters](#grouppresenceeventfilters): The group presence events that this event handler is concerned with. Group presence events are triggered when connections join or leave groups in the hub. If the value is null, no presence events will be sent to this event handler.
...
### Properties
* **eventNames**: ('joined' | 'left' | string)[] (Required): The concerning event names. Valid values are "joined", "left". If the value is null or empty, no presence events will be sent to the event handler.
* **groupFilters**: string[]: The group filters. Only events from these groups will be sent to the event handler. Each element is a pattern that may match multiple groups. If null or empty, events from all groups will be sent (subject to eventNames).
...
### Properties
* **provisioningState**: 'Canceled' | 'Creating' | 'Deleting' | 'Failed' | 'Moving' | 'Running' | 'Succeeded' | 'Unknown' | 'Updating' | string (ReadOnly): Provisioning state of the resource.
* **storageAccount**: [ResourceReference](#resourcereference) (Required): Reference to the storage account to be used for persistent storage.
...
* **chat**: [ChatSettings](#chatsettings): The chat settings for the hub.
