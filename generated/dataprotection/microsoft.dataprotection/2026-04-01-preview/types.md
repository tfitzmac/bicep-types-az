# Microsoft.DataProtection @ 2026-04-01-preview

## Resource Microsoft.DataProtection/backupVaults@2026-04-01-preview
...
## Resource Microsoft.DataProtection/backupVaults/backupInstances@2026-04-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.DataProtection/backupVaults/backupInstances/operationResults@2026-04-01-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.DataProtection/backupVaults/backupInstances/recoveryPoints@2026-04-01-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.DataProtection/backupVaults/backupJobs@2026-04-01-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.DataProtection/backupVaults/backupPolicies@2026-04-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.DataProtection/backupVaults/backupResourceGuardProxies@2026-04-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.DataProtection/backupVaults/deletedBackupInstances@2026-04-01-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.DataProtection/backupVaults/operationResults@2026-04-01-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.DataProtection/locations/deletedVaults@2026-04-01-preview (ReadOnly)
* **Valid Scope(s)**: Subscription
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string (Required, DeployTimeConstant): The resource name
* **properties**: [DeletedBackupVault](#deletedbackupvault) (ReadOnly): The resource-specific properties for this resource.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.DataProtection/locations/deletedVaults' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.DataProtection/resourceGuards@2026-04-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **eTag**: string: Optional ETag.
...
## Resource Microsoft.DataProtection/resourceGuards/deleteProtectedItemRequests@2026-04-01-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.DataProtection/resourceGuards/deleteResourceGuardProxyRequests@2026-04-01-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.DataProtection/resourceGuards/disableSoftDeleteRequests@2026-04-01-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.DataProtection/resourceGuards/getBackupSecurityPINRequests@2026-04-01-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.DataProtection/resourceGuards/updateProtectedItemRequests@2026-04-01-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.DataProtection/resourceGuards/updateProtectionPolicyRequests@2026-04-01-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
#### Properties
* **autoProtectionSettings**: [BlobBackupRuleBasedAutoProtectionSettings](#blobbackuprulebasedautoprotectionsettings) (Required): AutoProtection settings
* **objectType**: 'AdlsBlobBackupDatasourceParametersForAutoProtection' (Required): Type of the specific object - used for deserializing

### BlobBackupDatasourceParametersForAutoProtection
#### Properties
* **autoProtectionSettings**: [BlobBackupRuleBasedAutoProtectionSettings](#blobbackuprulebasedautoprotectionsettings) (Required): AutoProtection settings
* **objectType**: 'BlobBackupDatasourceParametersForAutoProtection' (Required): Type of the specific object - used for deserializing
...
#### Properties
* **backupSolutionType**: 'LogicalBackup' | 'PhysicalBackup' | string: Type of backup taken, Logical/Physical
* **objectType**: 'PostgreSqlFlexibleServerBackupDatasourceParameters' (Required): Type of the specific object - used for deserializing
...
### Properties
* **mode**: 'Exclude' | string (Required): Exclude removes candidates (after inclusion)
* **objectType**: string (Required): Type of the specific object - used for deserializing
* **pattern**: string (Required): The string pattern to evaluate against container names. For now this accepts literal strings only (no wildcards or regex).
* **type**: 'Prefix' | string (Required): Pattern type: Prefix, only pattern type supported for now.

## BlobBackupRuleBasedAutoProtectionSettings
### Properties
* **enabled**: bool (Required): Flag to enable whether auto protection.
* **objectType**: string (Required): Type of the specific object - used for deserializing
* **rules**: [BlobBackupAutoProtectionRule](#blobbackupautoprotectionrule)[]: Rules are evaluated in the order provided. Inclusion adds candidates; exclusion removes candidates.
...
* **isVaultProtectedByResourceGuard**: bool (ReadOnly): Is vault protected by resource guard
* **monitoringSettings**: [MonitoringSettings](#monitoringsettings): Monitoring Settings
* **originalBackupVaultId**: string (Required, ReadOnly): Resource Id of the original backup vault
* **originalBackupVaultName**: string (Required, ReadOnly): Resource name of the original backup vault
* **originalBackupVaultResourcePath**: string (Required, ReadOnly): Resource path of the original backup vault
* **provisioningState**: 'Failed' | 'Provisioning' | 'Succeeded' | 'Unknown' | 'Updating' | string (ReadOnly): Provisioning state of the BackupVault resource
* **replicatedRegions**: string[]: List of replicated regions for Backup Vault
* **resourceDeletionInfo**: [ResourceDeletionInfo](#resourcedeletioninfo) (Required, ReadOnly): Deletion info for the tracked resource (Backup Vault)
* **resourceGuardOperationRequests**: string[]: ResourceGuardOperationRequests on which LAC check will be performed
* **resourceMoveDetails**: [ResourceMoveDetails](#resourcemovedetails) (ReadOnly): Resource move details for backup vault
* **resourceMoveState**: 'CommitFailed' | 'CommitTimedout' | 'CriticalFailure' | 'Failed' | 'InProgress' | 'MoveSucceeded' | 'PartialSuccess' | 'PrepareFailed' | 'PrepareTimedout' | 'Unknown' | string (ReadOnly): Resource move state for backup vault
* **secureScore**: 'Adequate' | 'Maximum' | 'Minimum' | 'None' | 'NotSupported' | string (ReadOnly): Secure Score of Backup Vault
...
### Properties
* **deleteActivityId**: string (ReadOnly): Delete activity ID for troubleshooting the deletion of the tracked resource
* **deletionTime**: string (ReadOnly): Specifies time of deletion for the tracked resource (Backup Vault)
* **scheduledPurgeTime**: string (ReadOnly): Specifies the scheduled purge time for the tracked resource (Backup Vault)
