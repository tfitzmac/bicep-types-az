# Microsoft.ContainerService @ 2025-02-02-preview

## Resource Microsoft.ContainerService/locations/guardrailsVersions@2025-02-02-preview (ReadOnly)
...
## Resource Microsoft.ContainerService/locations/meshRevisionProfiles@2025-02-02-preview (ReadOnly)
* **Valid Scope(s)**: Subscription
### Properties
* **apiVersion**: '2025-02-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerService/locations/safeguardsVersions@2025-02-02-preview (ReadOnly)
* **Valid Scope(s)**: Subscription
### Properties
* **apiVersion**: '2025-02-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerService/managedClusters@2025-02-02-preview
...
## Resource Microsoft.ContainerService/managedClusters/agentPools@2025-02-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-02-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerService/managedClusters/agentPools/machines@2025-02-02-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-02-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerService/managedClusters/loadBalancers@2025-02-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-02-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerService/managedClusters/maintenanceConfigurations@2025-02-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-02-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerService/managedClusters/meshUpgradeProfiles@2025-02-02-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-02-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerService/managedClusters/namespaces@2025-02-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-02-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **eTag**: string (ReadOnly): Unique read-only string used to implement optimistic concurrency. The eTag value will change when the resource is updated. Specify an if-match or if-none-match header with the eTag value for a subsequent request to enable optimistic concurrency per the normal etag convention.
...
* **systemData**: [SystemData](#systemdata) (ReadOnly): The system metadata relating to this resource.
* **tags**: [NamespaceTags](#namespacetags): The tags to be persisted on the managed cluster namespace.
* **type**: 'Microsoft.ContainerService/managedClusters/namespaces' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.ContainerService/managedClusters/privateEndpointConnections@2025-02-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-02-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerService/managedClusters/trustedAccessRoleBindings@2025-02-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-02-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerService/managedclustersnapshots@2025-02-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-02-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerService/snapshots@2025-02-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-02-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Function listClusterAdminCredential (Microsoft.ContainerService/managedClusters@2025-02-02-preview)
* **Resource**: Microsoft.ContainerService/managedClusters
* **ApiVersion**: 2025-02-02-preview
* **Output**: [CredentialResults](#credentialresults)

## Function listClusterMonitoringUserCredential (Microsoft.ContainerService/managedClusters@2025-02-02-preview)
* **Resource**: Microsoft.ContainerService/managedClusters
* **ApiVersion**: 2025-02-02-preview
* **Output**: [CredentialResults](#credentialresults)

## Function listClusterUserCredential (Microsoft.ContainerService/managedClusters@2025-02-02-preview)
* **Resource**: Microsoft.ContainerService/managedClusters
* **ApiVersion**: 2025-02-02-preview
* **Output**: [CredentialResults](#credentialresults)

## Function listCredential (Microsoft.ContainerService/managedClusters/accessProfiles@2025-02-02-preview)
...
## Function listCredential (Microsoft.ContainerService/managedClusters/namespaces@2025-02-02-preview)
* **Resource**: Microsoft.ContainerService/managedClusters/namespaces
* **ApiVersion**: 2025-02-02-preview
* **Output**: [CredentialResults](#credentialresults)
...
* **transitEncryption**: 'None' | 'WireGuard' | string: This can be enabled only on Cilium-based clusters. If not specified, the default value is None.
...
## ScaleProfile
### Properties
* **autoscale**: any: Specifications on how to auto-scale the VirtualMachines agent pool within a predefined size range.
