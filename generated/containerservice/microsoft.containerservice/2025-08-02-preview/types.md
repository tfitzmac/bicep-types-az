# Microsoft.ContainerService @ 2025-08-02-preview
...
## Resource Microsoft.ContainerService/nodeCustomizations/versions@2025-08-02-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-08-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
* **version**: string {pattern: "^(?![.-])[A-Za-z0-9_.-]{1,63}$"}: The client-provided version of the node customization.
