...
## Resource Microsoft.ContainerService/preparedImageSpecifications@2026-03-02-preview
...
## Resource Microsoft.ContainerService/preparedImageSpecifications/versions@2026-03-02-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-03-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string {minLength: 1, maxLength: 63, pattern: "^(?![.-])[A-Za-z0-9_.-]{1,63}$"} (Required, DeployTimeConstant): The resource name
...
* **version**: string {pattern: "^(?![.-])[A-Za-z0-9_.-]{1,63}$"}: The client-provided version of the prepared image specification.
