# Microsoft.ContainerService @ 2026-09-02-preview

## Resource Microsoft.ContainerService/aiManagers@2026-09-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-09-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.ContainerService/aiManagers/customAIModels@2026-09-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-09-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **eTag**: string (ReadOnly): If eTag is provided in the response body, it may also be provided as a header per the normal etag convention.  Entity tags are used for comparing two or more entities from the same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields.
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string {minLength: 1, maxLength: 63, pattern: "^[a-z0-9]([-a-z0-9]*[a-z0-9])?$"} (Required, DeployTimeConstant): The resource name
* **properties**: [CustomAIModelProperties](#customaimodelproperties): The resource-specific properties for this resource.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.ContainerService/aiManagers/customAIModels' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.ContainerService/aiManagers/modelSources@2026-09-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-09-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **eTag**: string (ReadOnly): If eTag is provided in the response body, it may also be provided as a header per the normal etag convention.  Entity tags are used for comparing two or more entities from the same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields.
...
## Resource Microsoft.ContainerService/aiManagers/namespaces@2026-09-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-09-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **eTag**: string (ReadOnly): If eTag is provided in the response body, it may also be provided as a header per the normal etag convention.  Entity tags are used for comparing two or more entities from the same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields.
...
## Resource Microsoft.ContainerService/aiManagers/namespaces/modelDeployments@2026-09-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-09-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **eTag**: string (ReadOnly): If eTag is provided in the response body, it may also be provided as a header per the normal etag convention.  Entity tags are used for comparing two or more entities from the same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields.
...
## Resource Microsoft.ContainerService/locations/aiModels@2026-09-02-preview (ReadOnly)
...
## Function listAccessKeys (Microsoft.ContainerService/aiManagers/namespaces@2026-09-02-preview)
...
## Function listCredential (Microsoft.ContainerService/aiManagers@2026-09-02-preview)
* **Resource**: Microsoft.ContainerService/aiManagers
* **ApiVersion**: 2026-09-02-preview
* **Output**: [CredentialResults](#credentialresults)

## Function listCredential (Microsoft.ContainerService/aiManagers/namespaces@2026-09-02-preview)
* **Resource**: Microsoft.ContainerService/aiManagers/namespaces
* **ApiVersion**: 2026-09-02-preview
* **Output**: [CredentialResults](#credentialresults)
...
## BaseModelReference
### Properties
* **config**: [BaseModelReferenceConfig](#basemodelreferenceconfig): The verbatim `config.json` of the base model, supplied by the user. Required if the base model is not publicly accessible on HuggingFace.  For more information on CustomAIModel configuration see https://aka.ms/aks/aim-customaimodel.
* **id**: string (Required): The HuggingFace `<org>/<repo>` id of the base model, e.g. `meta-llama/Llama-2-7b-chat`. Immutable after creation.
* **totalWeightSizeBytes**: int: The total size of the model weights in bytes. eg `28000000000`. Required if the base model is not publicly accessible on HuggingFace.

## BaseModelReferenceConfig
### Properties
### Additional Properties
...
* **managedIdentity**: [ManagedIdentityCredential](#managedidentitycredential): A user-assigned managed identity the platform authenticates as. Required for `MicrosoftFoundry` sources and
...
### Properties
* **baseModel**: [BaseModelReference](#basemodelreference) (Required): The base model this custom model was trained from (id + config.json). Immutable after creation.
* **description**: string {maxLength: 250}: Optional. Free-form description of the model. Mutable.
* **modelId**: string (Required): The model identifier, interpreted per the referenced ModelSource type.
...
* **modelSourceResourceId**: string (Required): Azure resource id of the ModelSource to use when pulling artifacts. Used to determine model location and access. Immutable after creation.
* **provisioningState**: 'Canceled' | 'Creating' | 'Deleting' | 'Failed' | 'Succeeded' | 'Updating' | string (ReadOnly): The status of the last operation.
* **spec**: [CustomAIModelSpec](#customaimodelspec) (ReadOnly): Read-only. Platform-resolved specification of the model.
...
### Properties
* **resourceId**: string (Required): The Azure resource id of the user-assigned managed identity to authenticate with. Only user-assigned identities are supported.
...
### Properties
* **projectResourceId**: string (Required): The ARM resource id of the Foundry project. The scope on which the referenced managed identity must hold the `Foundry User` role. The account and endpoint host are derived from this id.
...
### Properties
* **modelResourceId**: string (Required): Full Azure resource ID of the model to deploy. Immutable after creation.
* **modelSourceResourceId**: string: Full Azure resource ID of a `ModelSource` to use when pulling artifacts for this deployment. Immutable after creation.
...
### Properties
* **credential**: [CredentialValue](#credentialvalue): Credential the platform uses to authenticate to the source. Optional for public sources (e.g. ungated Hugging Face models).
* **description**: string: An optional, free-form description of the source.
* **microsoftFoundry**: [MicrosoftFoundrySource](#microsoftfoundrysource): Microsoft Foundry project reference. Required when `sourceType` is `MicrosoftFoundry`; must be omitted otherwise. Immutable after creation.
* **provisioningState**: 'Canceled' | 'Failed' | 'Succeeded' | string (ReadOnly): The status of the last operation.
* **sourceType**: 'HuggingFace' | 'MicrosoftFoundry' | string (Required): Model source type. Constrains the legal authentication kinds. Immutable after creation.
