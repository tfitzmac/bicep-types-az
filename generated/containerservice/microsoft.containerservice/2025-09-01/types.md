# Microsoft.ContainerService @ 2025-09-01

## Resource Microsoft.ContainerService/locations/meshRevisionProfiles@2025-09-01 (ReadOnly)
...
## Resource Microsoft.ContainerService/managedClusters@2025-09-01
...
## Resource Microsoft.ContainerService/managedClusters/agentPools@2025-09-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-09-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerService/managedClusters/agentPools/machines@2025-09-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-09-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerService/managedClusters/maintenanceConfigurations@2025-09-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-09-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerService/managedClusters/managedNamespaces@2025-09-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-09-01' (ReadOnly, DeployTimeConstant): The resource api version
* **eTag**: string (ReadOnly): Unique read-only string used to implement optimistic concurrency. The eTag value will change when the resource is updated. Specify an if-match or if-none-match header with the eTag value for a subsequent request to enable optimistic concurrency per the normal eTag convention.
...
## Resource Microsoft.ContainerService/managedClusters/meshUpgradeProfiles@2025-09-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-09-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerService/managedClusters/privateEndpointConnections@2025-09-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-09-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerService/managedClusters/trustedAccessRoleBindings@2025-09-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-09-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerService/snapshots@2025-09-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-09-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Function listClusterAdminCredential (Microsoft.ContainerService/managedClusters@2025-09-01)
* **Resource**: Microsoft.ContainerService/managedClusters
* **ApiVersion**: 2025-09-01
* **Output**: [CredentialResults](#credentialresults)

## Function listClusterMonitoringUserCredential (Microsoft.ContainerService/managedClusters@2025-09-01)
* **Resource**: Microsoft.ContainerService/managedClusters
* **ApiVersion**: 2025-09-01
* **Output**: [CredentialResults](#credentialresults)

## Function listClusterUserCredential (Microsoft.ContainerService/managedClusters@2025-09-01)
* **Resource**: Microsoft.ContainerService/managedClusters
* **ApiVersion**: 2025-09-01
* **Output**: [CredentialResults](#credentialresults)

## Function listCredential (Microsoft.ContainerService/managedClusters/accessProfiles@2025-09-01)
...
## Function listCredential (Microsoft.ContainerService/managedClusters/managedNamespaces@2025-09-01)
...
* **osSKU**: 'AzureLinux' | 'AzureLinux3' | 'CBLMariner' | 'Ubuntu' | 'Ubuntu2204' | 'Windows2019' | 'Windows2022' | string: Specifies the OS SKU used by the agent pool. The default is Ubuntu if OSType is Linux. The default is Windows2019 when Kubernetes <= 1.24 or Windows2022 when Kubernetes >= 1.25 if OSType is Windows.
...
* **nodeImageVersion**: string (ReadOnly): The version of node image.
* **osSku**: 'AzureLinux' | 'AzureLinux3' | 'CBLMariner' | 'Ubuntu' | 'Ubuntu2204' | 'Windows2019' | 'Windows2022' | string (ReadOnly): Specifies the OS SKU used by the agent pool. The default is Ubuntu if OSType is Linux. The default is Windows2019 when Kubernetes <= 1.24 or Windows2022 when Kubernetes >= 1.25 if OSType is Windows.
