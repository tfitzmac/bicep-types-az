# Microsoft.ContainerService @ 2026-08-02-preview

## Resource Microsoft.ContainerService/aiManagers@2026-08-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-08-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.ContainerService/aiManagers/modelSources@2026-08-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-08-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **eTag**: string (ReadOnly): If eTag is provided in the response body, it may also be provided as a header per the normal etag convention.  Entity tags are used for comparing two or more entities from the same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields.
...
## Resource Microsoft.ContainerService/aiManagers/namespaces@2026-08-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-08-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **eTag**: string (ReadOnly): If eTag is provided in the response body, it may also be provided as a header per the normal etag convention.  Entity tags are used for comparing two or more entities from the same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields.
...
## Resource Microsoft.ContainerService/aiManagers/namespaces/modelDeployments@2026-08-02-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-08-02-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **eTag**: string (ReadOnly): If eTag is provided in the response body, it may also be provided as a header per the normal etag convention.  Entity tags are used for comparing two or more entities from the same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields.
...
## Resource Microsoft.ContainerService/locations/aiModels@2026-08-02-preview (ReadOnly)
...
## Function listAccessKeys (Microsoft.ContainerService/aiManagers/namespaces@2026-08-02-preview)
* **Resource**: Microsoft.ContainerService/aiManagers/namespaces
* **ApiVersion**: 2026-08-02-preview
* **Output**: [NamespaceAccessInfo](#namespaceaccessinfo)

## Function listCredential (Microsoft.ContainerService/aiManagers@2026-08-02-preview)
* **Resource**: Microsoft.ContainerService/aiManagers
* **ApiVersion**: 2026-08-02-preview
* **Output**: [CredentialResults](#credentialresults)

## Function listCredential (Microsoft.ContainerService/aiManagers/namespaces@2026-08-02-preview)
* **Resource**: Microsoft.ContainerService/aiManagers/namespaces
* **ApiVersion**: 2026-08-02-preview
* **Output**: [CredentialResults](#credentialresults)
