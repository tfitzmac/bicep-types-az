# Microsoft.ContainerService @ 2026-01-01

## Resource Microsoft.ContainerService/locations/meshRevisionProfiles@2026-01-01 (ReadOnly)
...
## Resource Microsoft.ContainerService/managedClusters@2026-01-01
...
## Resource Microsoft.ContainerService/managedClusters/agentPools@2026-01-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-01-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerService/managedClusters/agentPools/machines@2026-01-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-01-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerService/managedClusters/agentPools/upgradeProfiles@2026-01-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-01-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerService/managedClusters/maintenanceConfigurations@2026-01-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-01-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerService/managedClusters/managedNamespaces@2026-01-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-01-01' (ReadOnly, DeployTimeConstant): The resource api version
* **eTag**: string (ReadOnly): If eTag is provided in the response body, it may also be provided as a header per the normal etag convention.  Entity tags are used for comparing two or more entities from the same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields.
...
## Resource Microsoft.ContainerService/managedClusters/meshUpgradeProfiles@2026-01-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-01-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerService/managedClusters/privateEndpointConnections@2026-01-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-01-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerService/managedClusters/trustedAccessRoleBindings@2026-01-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-01-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerService/managedClusters/upgradeProfiles@2026-01-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-01-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerService/snapshots@2026-01-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-01-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Function listClusterAdminCredential (Microsoft.ContainerService/managedClusters@2026-01-01)
* **Resource**: Microsoft.ContainerService/managedClusters
* **ApiVersion**: 2026-01-01
* **Output**: [CredentialResults](#credentialresults)

## Function listClusterMonitoringUserCredential (Microsoft.ContainerService/managedClusters@2026-01-01)
* **Resource**: Microsoft.ContainerService/managedClusters
* **ApiVersion**: 2026-01-01
* **Output**: [CredentialResults](#credentialresults)

## Function listClusterUserCredential (Microsoft.ContainerService/managedClusters@2026-01-01)
* **Resource**: Microsoft.ContainerService/managedClusters
* **ApiVersion**: 2026-01-01
* **Output**: [CredentialResults](#credentialresults)

## Function listCredential (Microsoft.ContainerService/managedClusters/accessProfiles@2026-01-01)
...
## Function listCredential (Microsoft.ContainerService/managedClusters/managedNamespaces@2026-01-01)
...
* **osSKU**: 'AzureLinux' | 'AzureLinux3' | 'CBLMariner' | 'Ubuntu' | 'Ubuntu2204' | 'Ubuntu2404' | 'Windows2019' | 'Windows2022' | string: Specifies the OS SKU used by the agent pool. The default is Ubuntu if OSType is Linux. The default is Windows2019 when Kubernetes <= 1.24 or Windows2022 when Kubernetes >= 1.25 if OSType is Windows.
...
* **nodeImageVersion**: string (ReadOnly): The version of node image.
* **osSku**: 'AzureLinux' | 'AzureLinux3' | 'CBLMariner' | 'Ubuntu' | 'Ubuntu2204' | 'Ubuntu2404' | 'Windows2019' | 'Windows2022' | string (ReadOnly): Specifies the OS SKU used by the agent pool. The default is Ubuntu if OSType is Linux. The default is Windows2019 when Kubernetes <= 1.24 or Windows2022 when Kubernetes >= 1.25 if OSType is Windows.
