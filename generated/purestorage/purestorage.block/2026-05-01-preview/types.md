# PureStorage.Block @ 2026-05-01-preview

## Resource PureStorage.Block/reservations@2026-05-01-preview
...
## Resource PureStorage.Block/storagePools@2026-05-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource PureStorage.Block/storagePools/avsStorageContainers@2026-05-01-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource PureStorage.Block/storagePools/avsStorageContainers/volumes@2026-05-01-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource PureStorage.Block/storagePools/avsVms@2026-05-01-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource PureStorage.Block/storagePools/avsVms/avsVmVolumes@2026-05-01-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource PureStorage.Block/storagePools/recoverableVolumeGroups@2026-05-01-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string {minLength: 2, maxLength: 64, pattern: "^[A-Za-z][A-Za-z0-9-]{0,62}[A-Za-z0-9]$"} (Required, DeployTimeConstant): The resource name
* **properties**: [RecoverableVolumeGroupProperties](#recoverablevolumegroupproperties) (ReadOnly): The resource-specific properties for this resource.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'PureStorage.Block/storagePools/recoverableVolumeGroups' (ReadOnly, DeployTimeConstant): The resource type

## Resource PureStorage.Block/storagePools/volumeGroups@2026-05-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource PureStorage.Block/storagePools/volumeGroups/snapshots@2026-05-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
* **properties**: [VolumeGroupSnapshotProperties](#volumegroupsnapshotproperties): The resource-specific properties for this resource.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'PureStorage.Block/storagePools/volumeGroups/snapshots' (ReadOnly, DeployTimeConstant): The resource type

## Resource PureStorage.Block/storagePools/volumeGroups/volumes@2026-05-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Function listConnectionParameters (PureStorage.Block/storagePools/volumeGroups@2026-05-01-preview)
...
## Function listPlatformConsoleActivationCode (PureStorage.Block/storagePools@2026-05-01-preview)
* **Resource**: PureStorage.Block/storagePools
* **ApiVersion**: 2026-05-01-preview
* **Output**: [PlatformConsoleActivationCode](#platformconsoleactivationcode)

## Function listSnapshots (PureStorage.Block/storagePools/volumeGroups@2026-05-01-preview)
* **Resource**: PureStorage.Block/storagePools/volumeGroups
* **ApiVersion**: 2026-05-01-preview
...
* **softDeletion**: [DestroyedStateProperties](#destroyedstateproperties) (ReadOnly): Soft-deletion state of the volume
* **sourceRecoverableVolumeResourceId**: string (WriteOnly): Azure resource ID of the soft-deleted volume to recover within the same volume group
* **sourceSerialNumber**: string (WriteOnly): Serial number of the source volume to import
* **sourceType**: 'none' | 'recoverableVolume' | 'serialNumber' | 'snapshot' | 'volume' | string (WriteOnly): Indicates the source type for volume creation
...
* **sourceVolumeSnapshot**: [VolumeSnapshotSource](#volumesnapshotsource) (WriteOnly): Source volume group snapshot and volume snapshot name to restore from
...
### Properties
* **destroyed**: bool (Required, ReadOnly): If false, the resource is active; if true, the resource has been destroyed
* **destroyedAt**: string (ReadOnly): Date and time at which the resource was destroyed, as an RFC 3339 timestamp
* **eradicationTimestamp**: string (ReadOnly): Date at which the resource will be eradicated and impossible to recover, as an RFC 3339 timestamp
* **previousName**: string (ReadOnly): Name of the resource before it was destroyed
...
### Properties
* **enabled**: bool (Required): Whether this console interface access is enabled

## PlatformConsoleActivationCode
### Properties
* **activationCode**: string {sensitive} (Required): One-time activation code for platform console access
* **expiresAt**: string (Required): Expiry time of the activation code in RFC3339 format
* **username**: string (Required): Username to use when activating the console session

## PlatformConsoleSettings
### Properties
* **api**: [PlatformConsoleAccessSettings](#platformconsoleaccesssettings): API access settings
* **cli**: [PlatformConsoleAccessSettings](#platformconsoleaccesssettings): CLI access settings
* **defaultUsername**: string (ReadOnly): Default username for console access (system-populated)
* **enabled**: bool: Whether platform console access is enabled for the storage pool or not.When enabled is false, all console access is disabled regardless of individual interface settings.
* **gui**: [PlatformConsoleAccessSettings](#platformconsoleaccesssettings): GUI access settings
* **subnets**: [PlatformConsoleSubnet](#platformconsolesubnet)[]: Subnets configured for platform console access

## PlatformConsoleSubnet
### Properties
* **id**: string (Required): Azure resource ID of the subnet
* **managementIpAddress**: string (ReadOnly): Management IP address assigned to the subnet (system-populated)
* **serviceBackendIps**: string[] (ReadOnly): Service backend IP addresses assigned to the subnet (system-populated)
...
### Properties
* **createdAt**: string (ReadOnly): Date and time at which the volume group was created, as an RFC 3339 timestamp
* **performanceParameters**: [PerformanceParameters](#performanceparameters) (ReadOnly): Performance parameters of the volume group
* **protectionParameters**: [ProtectionParameters](#protectionparameters) (ReadOnly): Protection parameters of the volume group
* **provisioningState**: 'Accepted' | 'Canceled' | 'Deleting' | 'Failed' | 'Succeeded' | string (ReadOnly): Provisioning state of the resource
* **softDeletion**: [DestroyedStateProperties](#destroyedstateproperties) (ReadOnly): Soft-deletion state of the recoverable volume group
* **space**: [Space](#space) (ReadOnly): Storage space usage of the volume group
...
* **platformConsoleSettings**: [PlatformConsoleSettings](#platformconsolesettings): Platform console access settings for the storage pool
...
* **provisioningState**: 'Accepted' | 'Canceled' | 'Deleting' | 'Failed' | 'Succeeded' | string (ReadOnly): Provisioning state of the resource
* **sourceRecoverableVolumeGroupResourceId**: string (WriteOnly): Azure resource ID of the soft-deleted volume group to recover
* **sourceSnapshotResourceId**: string (WriteOnly): Azure resource ID of the volume group snapshot to restore from
* **sourceType**: 'none' | 'recoverableVolumeGroup' | 'snapshot' | 'volumeGroup' | string (WriteOnly): Indicates the source type for volume group creation
...
### Properties
* **filter**: string: OData filter expression (e.g. filter=substringof('sna', name) and space/unique gt 1000)
* **orderby**: string: OData order-by expression (e.g. orderby=name asc)
* **skip**: int: Number of results to skip (page offset)
* **top**: int: Maximum number of results to return per page

## VolumeGroupSnapshotPostListResult
### Properties
* **count**: int: Number of snapshots in this response page
* **totalCount**: int: Total number of snapshots
* **value**: [VolumeGroupSnapshot](#volumegroupsnapshot)[] (Required): Array of volume group snapshots

## VolumeGroupSnapshotProperties
### Properties
* **createdAt**: string (ReadOnly): Date and time at which the snapshot was created, as an RFC 3339 timestamp
* **createdByPolicy**: bool (ReadOnly): Whether the snapshot was created by a protection policy
* **provisioningState**: 'Accepted' | 'Canceled' | 'Deleting' | 'Failed' | 'Succeeded' | string (ReadOnly): Provisioning state of the resource
* **softDeletion**: [DestroyedStateProperties](#destroyedstateproperties) (ReadOnly): Soft-deletion state of the snapshot
* **sourceSnapshotResourceId**: string (WriteOnly): Azure resource ID of the source snapshot to recover from; omit for a new manual snapshot
* **space**: [Space](#space) (ReadOnly): Storage space usage of the snapshot
* **volumeSnapshots**: [VolumeSnapshotInfo](#volumesnapshotinfo)[] (ReadOnly): List of individual volume snapshots included in this volume group snapshot; populated on single-get, empty or omitted on list for performance
...
## VolumeSnapshotInfo
### Properties
* **name**: string (Required, ReadOnly): Name of the volume snapshot
* **provisionedSize**: int (ReadOnly): Provisioned size of the volume, in bytes
* **serialNumber**: string (ReadOnly): Serial number of the volume
* **space**: [Space](#space) (ReadOnly): Storage space usage of the volume snapshot

## VolumeSnapshotSource
### Properties
* **volumeGroupSnapshotResourceId**: string (Required, WriteOnly): Azure resource ID of the volume group snapshot containing the desired volume snapshot
* **volumeSnapshotName**: string (Required, WriteOnly): Name of the volume snapshot within the volume group snapshot
