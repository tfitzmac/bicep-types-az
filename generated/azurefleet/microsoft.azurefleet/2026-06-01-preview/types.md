...
## Resource Microsoft.AzureFleet/fleets@2026-06-01-preview
...
* **capacityType**: 'VCpu' | 'VM' | string: Specifies capacity type for Fleet Regular and Spot priority profiles.
...
* **mode**: 'Launch' | 'Managed' | string: Mode of the Fleet.
...
* **vmNamePrefix**: string {pattern: "^[^_\W][\w\-._]{0,64}(?<![-.])$"}: VirtualMachine prefix to be used for the virtual machines launched by Fleet. Can be used only with Launch mode.
* **vmSizesProfile**: [VmSizeProfile](#vmsizeprofile)[] (Required): List of VM sizes supported for Compute Fleet
* **zoneAllocationPolicy**: [ZoneAllocationPolicy](#zoneallocationpolicy): Zone Allocation Policy for Fleet.
...
### Properties
* **distributionStrategy**: 'BestEffortSingleZone' | 'Prioritized' | string (Required): Distribution strategy used for zone allocation policy.
