...
## Resource Microsoft.RecoveryServices/vaults/backupconfig@2026-05-31-preview
...
## Resource Microsoft.RecoveryServices/vaults/backupCrossTenantVaultMappings@2026-05-31-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-31-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string {pattern: "^[A-Za-z][A-Za-z0-9]{1,99}$"} (Required, DeployTimeConstant): The resource name
* **properties**: [CrossTenantVaultMappingProperties](#crosstenantvaultmappingproperties): CrossTenantVaultMapping properties
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.RecoveryServices/vaults/backupCrossTenantVaultMappings' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.RecoveryServices/vaults/backupCrossTenantVaultMappings/backupFabrics/protectionContainers/protectedItems@2026-05-31-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-31-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
* **type**: 'Microsoft.RecoveryServices/vaults/backupCrossTenantVaultMappings/backupFabrics/protectionContainers/protectedItems' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.RecoveryServices/vaults/backupCrossTenantVaultMappings/backupFabrics/protectionContainers/protectedItems/operationResults@2026-05-31-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-31-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **eTag**: string (ReadOnly): Optional ETag.
...
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **tags**: [ProtectedItemResourceTags](#protecteditemresourcetags) (ReadOnly): Resource tags.
* **type**: 'Microsoft.RecoveryServices/vaults/backupCrossTenantVaultMappings/backupFabrics/protectionContainers/protectedItems/operationResults' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.RecoveryServices/vaults/backupCrossTenantVaultMappings/backupFabrics/protectionContainers/protectedItems/recoveryPoints@2026-05-31-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-31-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **eTag**: string (ReadOnly): Optional ETag.
...
* **type**: 'Microsoft.RecoveryServices/vaults/backupCrossTenantVaultMappings/backupFabrics/protectionContainers/protectedItems/recoveryPoints' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.RecoveryServices/vaults/backupCrossTenantVaultMappings/backupJobs@2026-05-31-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-31-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **eTag**: string (ReadOnly): Optional ETag.
...
* **type**: 'Microsoft.RecoveryServices/vaults/backupCrossTenantVaultMappings/backupJobs' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.RecoveryServices/vaults/backupCrossTenantVaultMappings/vaultCredentials/operationResults@2026-05-31-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-31-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string (Required, DeployTimeConstant): The resource name
* **properties**: [VaultCredentialCertificateProperties](#vaultcredentialcertificateproperties) (ReadOnly): The resource-specific properties for this resource.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.RecoveryServices/vaults/backupCrossTenantVaultMappings/vaultCredentials/operationResults' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.RecoveryServices/vaults/backupEncryptionConfigs@2026-05-31-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-31-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **eTag**: string: Optional ETag.
...
## Resource Microsoft.RecoveryServices/vaults/backupEngines@2026-05-31-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-31-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **eTag**: string (ReadOnly): Optional ETag.
...
## Resource Microsoft.RecoveryServices/vaults/backupFabrics/backupProtectionIntent@2026-05-31-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-31-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **eTag**: string: Optional ETag.
...
## Resource Microsoft.RecoveryServices/vaults/backupFabrics/protectionContainers@2026-05-31-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-31-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **eTag**: string: Optional ETag.
...
## Resource Microsoft.RecoveryServices/vaults/backupFabrics/protectionContainers/operationResults@2026-05-31-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-31-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **eTag**: string (ReadOnly): Optional ETag.
...
## Resource Microsoft.RecoveryServices/vaults/backupFabrics/protectionContainers/protectedItems@2026-05-31-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-31-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **eTag**: string: Optional ETag.
...
## Resource Microsoft.RecoveryServices/vaults/backupFabrics/protectionContainers/protectedItems/operationResults@2026-05-31-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-31-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **eTag**: string (ReadOnly): Optional ETag.
...
## Resource Microsoft.RecoveryServices/vaults/backupFabrics/protectionContainers/protectedItems/recoveryPoints@2026-05-31-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-31-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **eTag**: string (ReadOnly): Optional ETag.
...
## Resource Microsoft.RecoveryServices/vaults/backupJobs@2026-05-31-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-31-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **eTag**: string (ReadOnly): Optional ETag.
...
## Resource Microsoft.RecoveryServices/vaults/backupPolicies@2026-05-31-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-31-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **eTag**: string: Optional ETag.
...
## Resource Microsoft.RecoveryServices/vaults/backupPolicies/operationResults@2026-05-31-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-31-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **eTag**: string (ReadOnly): Optional ETag.
...
## Resource Microsoft.RecoveryServices/vaults/backupResourceGuardProxies@2026-05-31-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-31-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **eTag**: string: Optional ETag.
...
## Resource Microsoft.RecoveryServices/vaults/backupstorageconfig@2026-05-31-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-31-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **eTag**: string: Optional ETag.
...
## Resource Microsoft.RecoveryServices/vaults/privateEndpointConnections@2026-05-31-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-05-31-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **eTag**: string: Optional ETag.
...
* **includedDatabases**: [DatabaseInRP](#databaseinrp)[]: List of databases included in recovery point.
...
## CrossTenantVaultMappingProperties
### Properties
* **createdTime**: string (ReadOnly): Timestamp when the mapping was created.
* **mappingName**: string (ReadOnly): Name of the mapping.
...
* **sourceTenantId**: string {minLength: 36, maxLength: 36, pattern: "^[0-9a-fA-F]{8}-([0-9a-fA-F]{4}-){3}[0-9a-fA-F]{12}$"} (ReadOnly): Tenant ID of the source vault for cross-tenant mapping.
* **sourceVaultId**: string (Required): ARM resource ID of the source vault.
...
## DatabaseInRP
### Properties
* **datasourceId**: string: Datasource Id for the database.
* **datasourceName**: string: Datasource name for the database.
...
* **nodesList**: [DistributedNodesInfo](#distributednodesinfo)[]: List of the nodes in case of distributed container.
* **parentName**: string: Parent name of the DB such as Instance or Availability Group.
* **parentProtectedItem**: string: Name of the parent protected item (e.g., SQL Instance name) when this database is protected as part of a parent.
* **parentType**: string: Parent type of protected item, example: for a DB, standalone server or distributed
* **protectedItemDataSourceId**: string: Data ID of the protected item.
* **protectedItemHealthStatus**: 'Healthy' | 'IRPending' | 'Invalid' | 'NotReachable' | 'Unhealthy' | string: Health status of the backup item, evaluated based on last heartbeat received
* **protectedItemType**: 'AzureVmWorkloadSQLDatabase' (Required): backup item type.
* **protectionLevel**: 'Database' | 'DatabaseUnderInstance' | string: Protection type in case protected as part of a parent.
* **protectionState**: 'BackupsSuspended' | 'IRPending' | 'Invalid' | 'Protected' | 'ProtectionError' | 'ProtectionPaused' | 'ProtectionStopped' | string: Backup state of this backup item.
* **protectionStatus**: string (ReadOnly): Backup status of this backup item.
* **serverName**: string: Host/Cluster Name for instance or AG
...
#### Properties
* **childDBNames**: string[]: Name of Child Dbs protected under this parent.
* **extendedInfo**: [AzureVmWorkloadProtectedItemExtendedInfo](#azurevmworkloadprotecteditemextendedinfo): Additional information for this backup item.
* **friendlyName**: string (ReadOnly): Friendly name of the DB represented by this backup item.
* **instanceProtectionReadiness**: 'PartialProtection' | 'ProtectionError' | 'Ready' | 'ScheduleDisabled' | 'Unknown' | string: The state of instance protection.
* **kpisHealths**: [AzureVmWorkloadProtectedItemKpisHealths](#azurevmworkloadprotecteditemkpishealths): Health details of different KPIs
* **lastBackupErrorDetail**: [ErrorDetailAutoGenerated](#errordetailautogenerated): Error details in last backup
* **lastBackupStatus**: 'Healthy' | 'IRPending' | 'Invalid' | 'Unhealthy' | string: Last backup operation status. Possible values: Healthy, Unhealthy.
* **lastBackupTime**: string: Timestamp of the last backup operation on this backup item.
...
* **protectedItemDataSourceId**: string: Data ID of the protected item.
* **protectedItemHealthStatus**: 'Healthy' | 'IRPending' | 'Invalid' | 'NotReachable' | 'Unhealthy' | string: Health status of the backup item, evaluated based on last heartbeat received
* **protectedItemType**: 'AzureVmWorkloadSQLInstance' (Required): backup item type.
* **protectionState**: 'BackupsSuspended' | 'IRPending' | 'Invalid' | 'Protected' | 'ProtectionError' | 'ProtectionPaused' | 'ProtectionStopped' | string: Backup state of this backup item.
* **protectionStatus**: string (ReadOnly): Backup status of this backup item.
* **serverName**: string: Host/Cluster Name for instance or AG
...
* **vmWorkloadPolicyType**: 'Invalid' | 'SnapshotV1' | 'SnapshotV2' | 'Streaming' | string: Type of the protection policy
* **workLoadType**: 'AzureFileShare' | 'AzureSqlDb' | 'Client' | 'Exchange' | 'FileFolder' | 'GenericDataSource' | 'Invalid' | 'SAPAseDatabase' | 'SAPHanaDBInstance' | 'SAPHanaDatabase' | 'SQLDB' | 'SQLDataBase' | 'Sharepoint' | 'SystemState' | 'VM' | 'VMwareVM' | string: Type of workload for the backup management
...
* **aadAuthority**: string: AAD authority URL.
* **aadTenantId**: string {minLength: 36, maxLength: 36, pattern: "^[0-9a-fA-F]{8}-([0-9a-fA-F]{4}-){3}[0-9a-fA-F]{12}$"}: AAD tenant ID of the source vault.
* **authType**: 'AzureActiveDirectory' | string: Authentication type.
...
* **provisioningState**: 'Accepted' | 'Canceled' | 'Deleting' | 'Failed' | 'Provisioning' | 'Succeeded' | 'Updating' | string (ReadOnly): Provisioning state of the vault credential certificate.
* **resourceId**: int: IDM resource ID of the vault.
* **servicePrincipalClientId**: string {minLength: 36, maxLength: 36, pattern: "^[0-9a-fA-F]{8}-([0-9a-fA-F]{4}-){3}[0-9a-fA-F]{12}$"}: Service principal client ID for the vault.
* **servicePrincipalObjectId**: string {minLength: 36, maxLength: 36, pattern: "^[0-9a-fA-F]{8}-([0-9a-fA-F]{4}-){3}[0-9a-fA-F]{12}$"}: Service principal object ID for the vault.
* **serviceResourceId**: string: String form of the IDM resource ID.
