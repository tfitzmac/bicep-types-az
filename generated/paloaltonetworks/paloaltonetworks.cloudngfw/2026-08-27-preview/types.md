# PaloAltoNetworks.Cloudngfw @ 2026-08-27-preview

## Resource PaloAltoNetworks.Cloudngfw/firewalls@2026-08-27-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-08-27-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource PaloAltoNetworks.Cloudngfw/firewalls/customCaptureConfigurations@2026-08-27-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-08-27-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: 'default' (Required, DeployTimeConstant): The resource name
* **properties**: [CustomCaptureConfigurationsProperties](#customcaptureconfigurationsproperties) (Required): The resource-specific properties for this resource.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'PaloAltoNetworks.Cloudngfw/firewalls/customCaptureConfigurations' (ReadOnly, DeployTimeConstant): The resource type

## Resource PaloAltoNetworks.Cloudngfw/firewalls/logIngestionSettings@2026-08-27-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-08-27-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: 'default' (Required, DeployTimeConstant): The resource name
* **properties**: [LogIngestionSettingsProperties](#logingestionsettingsproperties) (Required): The resource-specific properties for this resource.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'PaloAltoNetworks.Cloudngfw/firewalls/logIngestionSettings' (ReadOnly, DeployTimeConstant): The resource type

## Resource PaloAltoNetworks.Cloudngfw/firewalls/metrics@2026-08-27-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-08-27-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource PaloAltoNetworks.Cloudngfw/firewalls/statuses@2026-08-27-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-08-27-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource PaloAltoNetworks.Cloudngfw/globalRulestacks@2026-08-27-preview
...
## Resource PaloAltoNetworks.Cloudngfw/globalRulestacks/certificates@2026-08-27-preview
* **Valid Scope(s)**: Tenant
### Properties
* **apiVersion**: '2026-08-27-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource PaloAltoNetworks.Cloudngfw/globalRulestacks/fqdnlists@2026-08-27-preview
* **Valid Scope(s)**: Tenant
### Properties
* **apiVersion**: '2026-08-27-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource PaloAltoNetworks.Cloudngfw/globalRulestacks/postRules@2026-08-27-preview
* **Valid Scope(s)**: Tenant
### Properties
* **apiVersion**: '2026-08-27-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource PaloAltoNetworks.Cloudngfw/globalRulestacks/prefixlists@2026-08-27-preview
* **Valid Scope(s)**: Tenant
### Properties
* **apiVersion**: '2026-08-27-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource PaloAltoNetworks.Cloudngfw/globalRulestacks/preRules@2026-08-27-preview
* **Valid Scope(s)**: Tenant
### Properties
* **apiVersion**: '2026-08-27-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource PaloAltoNetworks.Cloudngfw/localRulestacks@2026-08-27-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-08-27-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource PaloAltoNetworks.Cloudngfw/localRulestacks/certificates@2026-08-27-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-08-27-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource PaloAltoNetworks.Cloudngfw/localRulestacks/fqdnlists@2026-08-27-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-08-27-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource PaloAltoNetworks.Cloudngfw/localRulestacks/localRules@2026-08-27-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-08-27-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource PaloAltoNetworks.Cloudngfw/localRulestacks/prefixlists@2026-08-27-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-08-27-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Function listAppIds (PaloAltoNetworks.Cloudngfw/globalRulestacks@2026-08-27-preview)
* **Resource**: PaloAltoNetworks.Cloudngfw/globalRulestacks
* **ApiVersion**: 2026-08-27-preview
* **Output**: [ListAppIdResponse](#listappidresponse)

## Function listAppIds (PaloAltoNetworks.Cloudngfw/localRulestacks@2026-08-27-preview)
* **Resource**: PaloAltoNetworks.Cloudngfw/localRulestacks
* **ApiVersion**: 2026-08-27-preview
* **Output**: [ListAppIdResponse](#listappidresponse)

## Function listCountries (PaloAltoNetworks.Cloudngfw/globalRulestacks@2026-08-27-preview)
* **Resource**: PaloAltoNetworks.Cloudngfw/globalRulestacks
* **ApiVersion**: 2026-08-27-preview
* **Output**: [CountriesResponse](#countriesresponse)

## Function listCountries (PaloAltoNetworks.Cloudngfw/localRulestacks@2026-08-27-preview)
* **Resource**: PaloAltoNetworks.Cloudngfw/localRulestacks
* **ApiVersion**: 2026-08-27-preview
* **Output**: [CountriesResponse](#countriesresponse)

## Function listFirewalls (PaloAltoNetworks.Cloudngfw/globalRulestacks@2026-08-27-preview)
* **Resource**: PaloAltoNetworks.Cloudngfw/globalRulestacks
* **ApiVersion**: 2026-08-27-preview
* **Output**: [ListFirewallsResponse](#listfirewallsresponse)

## Function listFirewalls (PaloAltoNetworks.Cloudngfw/localRulestacks@2026-08-27-preview)
* **Resource**: PaloAltoNetworks.Cloudngfw/localRulestacks
* **ApiVersion**: 2026-08-27-preview
* **Output**: [ListFirewallsResponse](#listfirewallsresponse)

## Function listPredefinedUrlCategories (PaloAltoNetworks.Cloudngfw/globalRulestacks@2026-08-27-preview)
* **Resource**: PaloAltoNetworks.Cloudngfw/globalRulestacks
* **ApiVersion**: 2026-08-27-preview
* **Output**: [PredefinedUrlCategoriesResponse](#predefinedurlcategoriesresponse)

## Function listPredefinedUrlCategories (PaloAltoNetworks.Cloudngfw/localRulestacks@2026-08-27-preview)
* **Resource**: PaloAltoNetworks.Cloudngfw/localRulestacks
* **ApiVersion**: 2026-08-27-preview
* **Output**: [PredefinedUrlCategoriesResponse](#predefinedurlcategoriesresponse)
...
* **value**: [Country](#country)[] (Required): The Country items on this page
...
### Properties
* **destinationIpAddress**: string (Required): Destination IPv4 address in dotted format (e.g., 52.39.204.87).
* **destinationPort**: int {minValue: 1, maxValue: 65535} (Required): Destination port number (1-65535). Required.
* **protocol**: 'TCP' | 'UDP' | string (Required): Network protocol — TCP or UDP.
* **sourceIpAddress**: string (Required): Source IPv4 address in dotted format (e.g., 10.0.0.5).
* **sourcePort**: int {minValue: 1, maxValue: 65535}: Source port number (1-65535). Optional — omit to match any source port.

## CustomCaptureConfigurationsProperties
### Properties
* **durationInSec**: int {minValue: 1, maxValue: 180}: Capture duration in seconds (1-180). Required on PUT (input). May be omitted in GET responses while pcapStatus is InProgress because the backend has not finalized echo-back yet; echoed in terminal Success responses.
* **message**: string (ReadOnly): Human-readable status message for display in client UIs (Portal blade, CLI output, etc.). English only. Read-only.
* **nextCheckInSeconds**: int (ReadOnly): Polling-cadence hint in seconds. Set on non-terminal responses (pcapStatus = InProgress) so clients know how long to wait before the next GET. Omitted on terminal responses (Success / Failed). Read-only.
* **pcapDetailReason**: string (ReadOnly): Detailed reason for the current status, populated by PAN. Typically set when pcapStatus is Failed. Read-only.
* **pcapFilter**: [CustomCaptureConfigurationsFilter](#customcaptureconfigurationsfilter)[] {minLength: 1, maxLength: 4}: List of filters to match packets against (1-4 entries). Required on PUT (input). May be omitted in GET responses while pcapStatus is InProgress because the backend has not finalized echo-back yet; echoed in terminal Success responses.
* **pcapStages**: ('Drop' | 'Firewall' | 'Receive' | 'Transmit' | string)[] {minLength: 1, maxLength: 4}: List of firewall stages where packets should be captured (1-4 entries). Required on PUT (input). May be omitted in GET responses while pcapStatus is InProgress because the backend has not finalized echo-back yet; echoed in terminal Success responses.
* **pcapStatus**: 'Failed' | 'InProgress' | 'Success' | string (ReadOnly): Current capture status. Read-only. Clients should poll GET until this is Success or Failed.
* **storageAccountResourceId**: string: ARM resource ID of the customer's storage account where the capture file will be written. Required on PUT (input). May be omitted in GET responses while pcapStatus is InProgress because the backend has not finalized echo-back yet; echoed in terminal Success responses.
...
* **firewallSku**: string: Firewall SKU type, Default will be STANDARD.
...
* **provisioningState**: 'Accepted' | 'Canceled' | 'Creating' | 'Deleted' | 'Deleting' | 'Failed' | 'NotSpecified' | 'Succeeded' | 'Updating' | string (ReadOnly): Provisioning state of the resource.
* **sessionDrainTimeoutInMinutes**: int {minValue: 15, maxValue: 120}: Time in minutes to keep serving existing traffic during scale-in or upgrade events before removing a firewall instance. Can only be set on PUT, not updatable via PATCH, Default will be 15.
...
* **idleTimeoutInMinutes**: int {minValue: 4, maxValue: 100}: Time in minutes an inbound session can stay inactive before termination, Default will be 4.
* **loadDistribution**: 'Default' | 'SourceIP' | string: Hash algorithm used to distribute inbound traffic, Default will be a five-tuple hash.
* **name**: string (Required): Settings name
* **protocol**: 'TCP' | 'UDP' | string (Required): Protocol Type
* **tcpReset**: 'Disabled' | 'Enabled' | string: Send a TCP reset when an inactive inbound session is terminated, Default will be Disabled.
...
* **monitorConfigurationsV2**: [MonitorLogV2](#monitorlogv2): Azure Monitor Log Ingestion (Data Collection Rule) configuration for this destination.
...
* **commonDestination**: [LogDestinationV2](#logdestinationv2): Common destination configurations
* **decryptLogDestination**: [LogDestinationV2](#logdestinationv2): Decrypt destination configurations
...
* **threatLogDestination**: [LogDestinationV2](#logdestinationv2): Threat destination configurations
* **trafficLogDestination**: [LogDestinationV2](#logdestinationv2): Traffic destination configurations
...
## MonitorLogV2
### Properties
* **dcrId**: string (Required): ARM resource ID of the Data Collection Rule (DCR) that governs how these logs are transformed and routed.
* **dcrImmutableId**: string (Required): Immutable ID of the Data Collection Rule (the value that begins with `dcr-`).
* **logIngestionEndpoint**: string (Required): HTTPS logs ingestion endpoint that receives the data (the DCR's logs ingestion endpoint or its Data Collection Endpoint).
* **streamName**: string (Required): DCR input stream that receives the data. For a custom table this is typically `Custom-<TableName>`.
...
* **outboundIdleTimeoutInMinutes**: int {minValue: 4, maxValue: 120}: Time in minutes an outbound source NAT session can stay inactive before termination, Default will be 4.
* **outboundTcpReset**: 'Disabled' | 'Enabled' | string: Send a TCP reset when an inactive outbound source NAT session is terminated, Default will be Enabled.
...
### Properties
* **nextLink**: string: The link to the next page of items
* **value**: [PredefinedUrlCategory](#predefinedurlcategory)[] (Required): The PredefinedUrlCategory items on this page
