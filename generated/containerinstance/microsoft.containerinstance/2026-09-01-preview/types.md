# Microsoft.ContainerInstance @ 2026-09-01-preview

## Resource Microsoft.ContainerInstance/aiAgentsGroups@2026-09-01-preview
...
* **properties**: [AiAgentsGroupProperties](#aiagentsgroupproperties): The resource-specific properties for this resource.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **tags**: [TrackedResourceTags](#trackedresourcetags): Resource tags.
* **type**: 'Microsoft.ContainerInstance/aiAgentsGroups' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.ContainerInstance/containerGroupProfiles@2026-09-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-09-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerInstance/containerGroupProfiles/revisions@2026-09-01-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-09-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerInstance/containerGroups@2026-09-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-09-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerInstance/managedVirtualNodePools@2026-09-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-09-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
* **location**: string (Required): The geo-location where the resource lives
* **name**: string {minLength: 1, maxLength: 63, pattern: "^[a-zA-Z0-9]([a-zA-Z0-9-]*[a-zA-Z0-9])?$"} (Required, DeployTimeConstant): The resource name
* **properties**: [ManagedVirtualNodePoolProperties](#managedvirtualnodepoolproperties): The properties of the managed virtual node pool.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **tags**: [TrackedResourceTags](#trackedresourcetags): Resource tags.
* **type**: 'Microsoft.ContainerInstance/managedVirtualNodePools' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.ContainerInstance/ngroups@2026-09-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-09-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
### Properties
* **managementResourceGroupId**: string (ReadOnly): The ARM resource ID of the management resource group associated with this AiAgentsGroup.
* **networkProfile**: [AiAgentsGroupNetworkProfile](#aiagentsgroupnetworkprofile): The network profile of the AiAgentsGroup.
* **provisioningState**: 'Accepted' | 'Canceled' | 'Deleting' | 'Failed' | 'Succeeded' | 'Updating' | string (ReadOnly): The status of the last operation.
...
* **userAssignedIdentityClientId**: string: The client id of the user-assigned managed identity that has access to the Azure File share.
...
## ManagedVirtualNodePoolContainerGroup
### Properties
* **resourceId**: string (ReadOnly): The Azure resource ID of the container group.
* **state**: string (ReadOnly): The state of the container group.
* **type**: string (ReadOnly): The type of the container group.

## ManagedVirtualNodePoolProperties
### Properties
* **aiAgentGroupResourceId**: string (Required): The Azure resource ID of the AI agents group associated with the node pool. Set at create time and immutable thereafter.
* **aksClusterResourceId**: string (Required): The Azure resource ID of the backing AKS managed cluster. Set at create time and immutable thereafter.
* **containerGroups**: [ManagedVirtualNodePoolContainerGroup](#managedvirtualnodepoolcontainergroup)[] (ReadOnly): The container groups associated with the node pool.
* **managedIdentityResourceId**: string (Required): The Azure resource ID of the user-assigned managed identity used by the node pool. Set at create time and immutable thereafter.
* **maxNodes**: int {minValue: 1}: Maximum number of nodes the pool can scale to.
* **minNodes**: int {minValue: 0}: Minimum number of nodes maintained by the pool.
* **provisioningState**: 'Accepted' | 'Canceled' | 'Deleting' | 'Failed' | 'Succeeded' | 'Updating' | string (ReadOnly): The status of the last provisioning operation on the resource.
* **readyCount**: int (ReadOnly): The number of container groups that are ready in the node pool.
* **subnetResourceId**: string (ReadOnly): The Azure resource ID of the subnet used by container groups in the node pool.
* **targetCount**: int (ReadOnly): The desired number of container groups for the node pool.
...
## SubnetReference
### Properties
* **id**: string (Required): The ARM resource ID of the subnet. The caller must have `Microsoft.Network/virtualNetworks/subnets/join/action` permission on this subnet (enforced via a linked access check at create/update time).
