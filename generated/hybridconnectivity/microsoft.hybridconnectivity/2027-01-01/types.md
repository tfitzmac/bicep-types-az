...
## Resource Microsoft.HybridConnectivity/endpoints@2027-01-01
...
## Resource Microsoft.HybridConnectivity/endpoints/serviceConfigurations@2027-01-01
* **Valid Scope(s)**: Unknown
### Properties
* **apiVersion**: '2027-01-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.HybridConnectivity/publicCloudConnectors@2027-01-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2027-01-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **kind**: 'AWS' | 'GCP' | string (ReadOnly): The kind of the public cloud connector.
...
## Resource Microsoft.HybridConnectivity/solutionConfigurations@2027-01-01
* **Valid Scope(s)**: Unknown
### Properties
* **apiVersion**: '2027-01-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.HybridConnectivity/solutionConfigurations/inventory@2027-01-01 (ReadOnly)
* **Valid Scope(s)**: Unknown
### Properties
* **apiVersion**: '2027-01-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.HybridConnectivity/solutionTypes@2027-01-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2027-01-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Function listCredentials (Microsoft.HybridConnectivity/endpoints@2027-01-01)
...
## Function listIngressGatewayCredentials (Microsoft.HybridConnectivity/endpoints@2027-01-01)
* **Resource**: Microsoft.HybridConnectivity/endpoints
* **ApiVersion**: 2027-01-01
...
## Function listManagedProxyDetails (Microsoft.HybridConnectivity/endpoints@2027-01-01)
* **Resource**: Microsoft.HybridConnectivity/endpoints
* **ApiVersion**: 2027-01-01
...
## GcpCloudProfile
### Properties
* **organizationProperties**: [GcpOrganizationProperties](#gcporganizationproperties): The organization properties of the GCP organization.
* **projectProperties**: [GcpProjectProperties](#gcpprojectproperties): The project properties of the GCP project.

## GcpOrganizationProperties
### Properties
* **excludedFolderIds**: string[]: List of GCP folders which need to be excluded.
* **excludedProjectNumbers**: string[]: List of GCP projects which need to be excluded.
* **managementProjectId**: string (Required): The project Id of the management project under the GCP organization.
* **managementProjectNumber**: string (Required): The project number of the management project under the GCP organization.
* **organizationId**: string (Required): The organization id of the GCP organization.

## GcpProjectProperties
### Properties
* **projectId**: string (Required): The project id of the GCP project.
* **projectNumber**: string (Required): The project number of the GCP project.
...
### Properties
* **awsCloudProfile**: [AwsCloudProfile](#awscloudprofile): Cloud profile for AWS.
* **connectorPrimaryIdentifier**: string (ReadOnly): Connector primary identifier.
* **gcpCloudProfile**: [GcpCloudProfile](#gcpcloudprofile): Cloud profile for GCP.
* **hostType**: 'AWS' | 'GCP' | string (Required): Host cloud the public cloud connector.
* **provisioningState**: 'Canceled' | 'Failed' | 'Succeeded' | string (ReadOnly): The resource provisioning state.
...
* **hostTypes**: ('AWS' | 'GCP' | string)[]: The supported host types for the current solution type.
...
* **hostTypes**: ('AWS' | 'GCP' | string)[] (Required): The supported host types for the current solution setting
