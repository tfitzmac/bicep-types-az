# Microsoft.BillingBenefits @ 2026-06-01

## Resource Microsoft.BillingBenefits/catalogGroups@2026-06-01 (ReadOnly)
...
* **properties**: [CatalogGroupProperties](#cataloggroupproperties) (ReadOnly): The resource-specific properties for this resource.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.BillingBenefits/catalogGroups' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.BillingBenefits/conditionalCredits@2026-06-01
...
## Resource Microsoft.BillingBenefits/conditionalCredits/contributors@2026-06-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-06-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.BillingBenefits/conditionalCredits/transactions@2026-06-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-06-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string {pattern: "^[a-zA-Z0-9_\-\.]+$"} (Required, DeployTimeConstant): The resource name
* **properties**: [TransactionProperties](#transactionproperties) (ReadOnly): Transaction properties
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.BillingBenefits/conditionalCredits/transactions' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.BillingBenefits/credits@2026-06-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-06-01' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): The etag field is *not* required. If it is provided in the response body, it must also be provided as a header per the normal etag convention.  Entity tags are used for comparing two or more entities from the same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields.
...
## Resource Microsoft.BillingBenefits/credits/sources@2026-06-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-06-01' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): The etag field is *not* required. If it is provided in the response body, it must also be provided as a header per the normal etag convention.  Entity tags are used for comparing two or more entities from the same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields.
...
## Resource Microsoft.BillingBenefits/credits/transactions@2026-06-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-06-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
* **properties**: [TransactionProperties](#transactionproperties) (ReadOnly): Transaction properties
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.BillingBenefits/credits/transactions' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.BillingBenefits/discounts@2026-06-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-06-01' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): The etag field is *not* required. If it is provided in the response body, it must also be provided as a header per the normal etag convention.  Entity tags are used for comparing two or more entities from the same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields.
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **identity**: [ManagedServiceIdentityAutoGenerated](#managedserviceidentityautogenerated): Managed service identity (system assigned and/or user assigned identities)
* **kind**: string {pattern: "^[-\w\._,\(\)]+$"}: Metadata used by portal/tooling/etc to render different UX experiences for resources of the same type. E.g. ApiApps are a kind of Microsoft.Web/sites type.  If supported, the resource provider must validate and persist this value.
* **location**: string (Required): The geo-location where the resource lives
* **managedBy**: string: The fully qualified resource ID of the resource that manages this resource. Indicates if this resource is managed by another Azure resource. If this is present, complete mode deployment will not delete the resource if it is removed from the template since it is managed by another resource.
* **name**: string {pattern: "^[a-zA-Z0-9_\-\.]+$"} (Required, DeployTimeConstant): The resource name
...
## Resource Microsoft.BillingBenefits/freeServices@2026-06-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-06-01' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): The etag field is *not* required. If it is provided in the response body, it must also be provided as a header per the normal etag convention.  Entity tags are used for comparing two or more entities from the same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields.
...
* **name**: string {pattern: "^[a-zA-Z0-9_\-\.]+$"} (Required, DeployTimeConstant): The resource name
* **plan**: [Plan](#plan): Plan for the resource.
* **properties**: [FreeServicesProperties](#freeservicesproperties): Free services properties
* **sku**: [Sku](#sku): The resource model definition representing SKU
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **tags**: [TrackedResourceTags](#trackedresourcetags): Resource tags.
* **type**: 'Microsoft.BillingBenefits/freeServices' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.BillingBenefits/maccs@2026-06-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-06-01' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): The etag field is *not* required. If it is provided in the response body, it must also be provided as a header per the normal etag convention.  Entity tags are used for comparing two or more entities from the same requested resource. HTTP/1.1 uses entity tags in the etag (section 14.19), If-Match (section 14.24), If-None-Match (section 14.26), and If-Range (section 14.27) header fields.
...
## Resource Microsoft.BillingBenefits/maccs/contributors@2026-06-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-06-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.BillingBenefits/maccs/transactions@2026-06-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-06-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
* **properties**: [TransactionProperties](#transactionproperties) (ReadOnly): Transaction properties
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.BillingBenefits/maccs/transactions' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.BillingBenefits/reservationOrderAliases@2026-06-01
...
## Resource Microsoft.BillingBenefits/savingsPlanOrderAliases@2026-06-01
* **Valid Scope(s)**: Tenant
### Properties
* **apiVersion**: '2026-06-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.BillingBenefits/savingsPlanOrders@2026-06-01 (ReadOnly)
* **Valid Scope(s)**: Tenant
### Properties
* **apiVersion**: '2026-06-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.BillingBenefits/savingsPlanOrders/savingsPlans@2026-06-01 (ReadOnly)
* **Valid Scope(s)**: Tenant
### Properties
* **apiVersion**: '2026-06-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
* **duration**: 'P1M' | 'P1Y' | 'P3Y' | 'P5Y' | string: Duration for which the benefit is active. Will be in format P{int}M or P{int}Y. Any values representing up to 12 years are valid. Upper limit examples: P144M, P12Y.
...
### Properties
* **name**: string (Required): The capability name (e.g., SelfServiceExchange, Renewability).
* **value**: string (Required): The capability value (e.g., Supported, Not Supported).

## CatalogGroupProperties
### Properties
* **benefitResourceType**: 'ConditionalCredits' | 'Credits' | 'Discounts' | 'FreeServices' | 'Maccs' | 'Reservations' | 'SavingsPlans' | string (Required): The top-level benefit resource type (e.g., maccs, credits, conditionalCredits, discounts, savingsPlans, reservations).
* **capabilities**: [CatalogGroupCapability](#cataloggroupcapability)[]: Capabilities of the catalog group as key-value pairs. Omitted when a benefit type has no defined capabilities.
* **disclaimers**: string[]: Optional disclaimers (legal or eligibility caveats) for the catalog group. Included only when caveats apply.
* **displayName**: string: Display name for the catalog group.
* **icon**: string: The benefit type's icon as JSON-escaped SVG markup. After parsing, the value is a complete `<svg>…</svg>` element.
* **keywords**: string[]: Manifest-sourced array of search terms for this catalog group. Omitted when empty.
...
### Base Properties
* **appliedScopeType**: 'BillingAccount' | 'BillingProfile' | 'Customer' | string: Type of the applied scope for the conditional credit.
...
* **consumed**: [Price](#price) (ReadOnly): Amount of benefit that has been consumed
...
* **productDetails**: [ProductDetailsBase](#productdetailsbase) (ReadOnly): Product details including SKU title, product family, and product type.
* **provisioningState**: 'Canceled' | 'Failed' | 'Pending' | 'Succeeded' | string (ReadOnly): The provisioning state of the resource
...
### Properties
* **appliedOn**: ('Consumption' | 'External' | 'Invoice' | string)[]: Indicates where the credit benefit is applied (e.g., consume, invoice, or external application).
* **appliedPrice**: string: Specifies which price point is used when applying the credit. Known values include "MarketPrice", "UnitPrice", and "BenefitGroupPrice:<groupId>" where <groupId> identifies the benefit group.
* **productFamily**: string: The product family, for example "Azure" or "M365".
* **productType**: string: The type of the product.
* **skuTitle**: string: SKU title of the product

## CreditProperties
### Properties
* **appliedScopeType**: 'BillingAccount' | 'BillingProfile' | 'Customer' | string: Type of the applied scope for the credit.
...
* **customerResourceId**: string (ReadOnly): Customer resource id where the benefit is scoped to.
* **displayName**: string: Display name
* **endAt**: string: End DateTime in UTC.
* **fundingSystemId**: string: Unique identifier (UUID) of the funding lot assigned by the benefit publisher. Used in credit transfer scenarios to trace the originating credit lot.
* **invitationId**: string: Invitation identifier
* **orderId**: string (ReadOnly): Identifier of the $0 transaction created during credit acquisition.
...
* **productDetails**: [CreditProductDetails](#creditproductdetails) (ReadOnly): Product details including SKU title, product kind, offer type, and application details
* **provisioningState**: 'Canceled' | 'Failed' | 'Pending' | 'Succeeded' | string (ReadOnly): Provisioning state
* **reason**: [CreditReason](#creditreason): The reason for the credit. Not required if not applicable.
* **resourceId**: string: Fully-qualified resource identifier of the resource. Format: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BillingBenefits/{benefitType}/{benefitName}.
* **startAt**: string: Start DateTime.
* **status**: 'Active' | 'Canceled' | 'Exhausted' | 'Expired' | 'Failed' | 'NotStarted' | 'Pending' | 'Succeeded' | 'Unknown' | string (ReadOnly): Status of the credit
* **systemId**: string: System identifier

## CreditReason
### Properties
* **code**: string: The reason code for credit.
* **description**: string: The free string description of the credit.
...
* **benefitResourceId**: string (ReadOnly): Fully-qualified identifier of the benefit under applicable benefit list.
* **billingAccountResourceId**: string (ReadOnly): Fully-qualified identifier of the billing account where the benefit is applied.
* **billingProfileResourceId**: string (ReadOnly): Fully-qualified identifier of the billing profile where the benefit is applied.
* **customerResourceId**: string (ReadOnly): Customer resource id where the benefit is scoped to.
* **displayName**: string: This defines a user friendly display name for the discount.
* **endAt**: string: End date of the discount. No duration will be supported. Allowed value is any date greater than or equal to startDate.
* **invitationId**: string: Invitation identifier
* **productCode**: string (Required): This is the catalog UPN for the product.
* **productDetails**: [ProductDetailsBase](#productdetailsbase) (ReadOnly): Product details including SKU title, product family, and product type.
* **provisioningState**: 'Canceled' | 'Failed' | 'Pending' | 'Succeeded' | string (ReadOnly): The state of the resource. Supported values are Pending, Failed, Succeeded, Canceled.
...
### DiscountTypeAzurePromotion
#### Properties
* **discountType**: 'AzurePromotion' (Required): Defines the type of discount. Supported values are ProductFamily, Product, Sku, CustomPrice, and CustomPriceMultiCurrency.
...
* **customerResourceId**: string (ReadOnly): Customer resource id where the benefit is scoped to.
* **displayName**: string: Display name
* **endAt**: string: Expiration date and time of the free services
* **invitationId**: string: Invitation identifier
* **productCode**: string: This is the catalog UPN for the product.
* **productDetails**: [ProductDetailsBase](#productdetailsbase) (ReadOnly): Product details including SKU title, product family, and product type.
* **provisioningState**: 'Canceled' | 'Failed' | 'Pending' | 'Succeeded' | string (ReadOnly): Provisioning state of Free Services as assigned by RPaaS. This indicates the last operation's status. For all practical purposes, this can be ignored. For current status of Free Services resource, refer to FreeServicesStatus.
* **startAt**: string: Date and time when the free services become active
* **status**: 'Active' | 'Canceled' | 'Completed' | 'Pending' | 'Unknown' | string: Current status of the free services
* **systemId**: string: This is the globally unique identifier of the free services which will not change for its lifetime. Generated by the benefit publisher.
...
* **appliedScopeType**: 'BillingAccount' | 'BillingProfile' | 'Customer' | string: Type of the applied scope for the MACC.
...
* **productDetails**: [ProductDetailsBase](#productdetailsbase) (ReadOnly): Product details including SKU title, product family, and product type.
* **provisioningState**: 'Canceled' | 'Failed' | 'Pending' | 'Succeeded' | string (ReadOnly): Provisioning state of MACC as assigned by RPaaS. This indicates the last operation's status. For all practical purposes, this can be ignored. For current status of MACC resource, refer to MaccStatus.
...
* **renewAction**: 'CreateNew' | 'RenewExisting' | string: Represents the renewal action for a reservation to be a new purchase or existing renewal.
* **term**: 'P1M' | 'P1Y' | 'P3Y' | 'P5Y' | string: Represent benefit term in ISO 8601 format.
...
* **renew**: bool: Setting this to true will automatically purchase a new benefit on the expiration date time.
* **renewAction**: 'CreateNew' | 'RenewExisting' | string: Represents the renewal action for a reservation to be a new purchase or existing renewal.
* **renewalPurchaseDateTime**: string (ReadOnly): This is the date-time when the reservation was renewed.
...
* **productFamily**: string: The product family, for example "Azure" or "M365".
* **productType**: string: The type of the product.
* **publisherType**: string: The publisher type of the product, for example "Microsoft" for first-party or a third-party publisher name. Additional values may be introduced in the future.
* **serviceFamily**: string: Grouping of Azure services by core function (e.g., Compute, Databases).
* **skuTitle**: string: SKU title of the product

## TransactionProperties
### Properties
* **amountInBillingCurrency**: [Price](#price): Transaction amount in billing currency.
* **amountInPricingCurrency**: [Price](#price): Transaction amount in pricing currency.
* **billingStatus**: 'Closed' | 'Open' | string: Billing lifecycle status of this transaction.
* **chargeType**: 'Purchase' | 'Refund' | 'Usage' | string: The type of charge for this transaction.
* **date**: string: This is the DateTime when the transaction occurred.
* **invoiceResourceId**: string: Fully-qualified identifier of the invoice.
* **productCode**: string: Catalog UPN for the product associated with this transaction.
* **productDetails**: [TransactionProductDetails](#transactionproductdetails): Product details including SKU title, SKU properties, product family, type, and publisher type.
* **provisioningState**: 'Canceled' | 'Failed' | 'Pending' | 'Succeeded' | string (ReadOnly): Provisioning state of the transaction as assigned by RPaaS. This indicates the last operation's status.
