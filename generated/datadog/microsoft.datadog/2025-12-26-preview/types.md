# Microsoft.Datadog @ 2025-12-26-preview

## Resource Microsoft.Datadog/agreements@2025-12-26-preview
* **Valid Scope(s)**: Subscription
### Properties
* **apiVersion**: '2025-12-26-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Datadog/monitors@2025-12-26-preview
...
* **name**: string {minLength: 2, maxLength: 32, pattern: "^[a-zA-Z0-9_][a-zA-Z0-9_-]+$"} (Required, DeployTimeConstant): The resource name
...
## Resource Microsoft.Datadog/monitors/monitoredSubscriptions@2025-12-26-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-12-26-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Datadog/monitors/singleSignOnConfigurations@2025-12-26-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-12-26-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Datadog/monitors/tagRules@2025-12-26-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-12-26-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Function listApiKeys (Microsoft.Datadog/monitors@2025-12-26-preview)
...
## Function listHosts (Microsoft.Datadog/monitors@2025-12-26-preview)
* **Resource**: Microsoft.Datadog/monitors
* **ApiVersion**: 2025-12-26-preview
* **Output**: [DatadogHostListResponse](#datadoghostlistresponse)

## Function listLinkedResources (Microsoft.Datadog/monitors@2025-12-26-preview)
* **Resource**: Microsoft.Datadog/monitors
* **ApiVersion**: 2025-12-26-preview
* **Output**: [LinkedResourceListResponse](#linkedresourcelistresponse)

## Function listMonitoredResources (Microsoft.Datadog/monitors@2025-12-26-preview)
* **Resource**: Microsoft.Datadog/monitors
* **ApiVersion**: 2025-12-26-preview
...
* **value**: [DatadogApiKey](#datadogapikey)[] (Required): The DatadogApiKey items on this page
...
### Properties
* **nextLink**: string: The link to the next page of items
* **value**: [DatadogHost](#datadoghost)[] (Required): The DatadogHost items on this page
...
### Properties
* **offerId**: string: The offer ID (e.g., "dd_liftr_v3_decoupled").
* **publisherId**: string: The publisher ID (e.g., "datadog1591740804488").
...
### Properties
* **agentRules**: [AgentRules](#agentrules): Set of rules for managing agents for the Monitor resource.
...
* **marketplaceOfferDetails**: [MarketplaceOfferDetails](#marketplaceofferdetails): Details about the marketplace offer associated with the resource.
...
* **sreAgentConfiguration**: [SreAgentConfiguration](#sreagentconfiguration)[] (WriteOnly): SRE Agent configuration to connect to MCP server of Datadog for given organization.
...
### Properties
* **mcpConnectorResourceId**: string (Required): The ARM resource ID of the MCP connector integrated with SRE Agent resource.
