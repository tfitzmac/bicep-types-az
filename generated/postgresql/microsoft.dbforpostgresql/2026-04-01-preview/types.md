# Microsoft.DBforPostgreSQL @ 2026-04-01-preview

## Resource Microsoft.DBforPostgreSQL/flexibleServers@2026-04-01-preview
...
## Resource Microsoft.DBforPostgreSQL/flexibleServers/administrators@2026-04-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.DBforPostgreSQL/flexibleServers/advancedThreatProtectionSettings@2026-04-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.DBforPostgreSQL/flexibleServers/backups@2026-04-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.DBforPostgreSQL/flexibleServers/configurations@2026-04-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.DBforPostgreSQL/flexibleServers/databases@2026-04-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.DBforPostgreSQL/flexibleServers/firewallRules@2026-04-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.DBforPostgreSQL/flexibleServers/ltrBackupOperations@2026-04-01-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.DBforPostgreSQL/flexibleServers/maintenanceEvents@2026-04-01-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string {pattern: "^[A-Z0-9]{4}-[A-Z0-9]{3}$"} (Required, DeployTimeConstant): The resource name
* **properties**: [MaintenanceEventResourceProperties](#maintenanceeventresourceproperties) (ReadOnly): The resource-specific properties for this resource.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.DBforPostgreSQL/flexibleServers/maintenanceEvents' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.DBforPostgreSQL/flexibleServers/majorVersionUpgradePrecheck@2026-04-01-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string {pattern: "^[a-zA-Z0-9-]{3,36}$"} (Required, DeployTimeConstant): The resource name
* **properties**: [MajorVersionUpgradePrecheckResourceProperties](#majorversionupgradeprecheckresourceproperties) (ReadOnly): The resource-specific properties for this resource.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.DBforPostgreSQL/flexibleServers/majorVersionUpgradePrecheck' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.DBforPostgreSQL/flexibleServers/migrations@2026-04-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.DBforPostgreSQL/flexibleServers/privateEndpointConnections@2026-04-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.DBforPostgreSQL/flexibleServers/privateLinkResources@2026-04-01-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.DBforPostgreSQL/flexibleServers/tuningOptions@2026-04-01-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.DBforPostgreSQL/flexibleServers/virtualendpoints@2026-04-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
* **geoBackupFederatedIdentityClientId**: string {minLength: 36, maxLength: 36, pattern: "^[0-9a-fA-F]{8}-([0-9a-fA-F]{4}-){3}[0-9a-fA-F]{12}$"}: Client id of multi-tenant Microsoft Entra application for when it is configured to support geographically redundant backups.
...
* **primaryFederatedIdentityClientId**: string {minLength: 36, maxLength: 36, pattern: "^[0-9a-fA-F]{8}-([0-9a-fA-F]{4}-){3}[0-9a-fA-F]{12}$"}: Client id of multi-tenant Microsoft Entra application.
...
### Properties
* **deferrable**: bool (Required, ReadOnly): A value indicating whether this maintenance event can be rescheduled by the customer.
* **deferralDeadline**: string (ReadOnly): The latest date/time this maintenance event can be postponed to (UTC). Present only when deferrable is true.
* **description**: string (ReadOnly): The human-readable description of the maintenance event.
* **endTime**: string (Required, ReadOnly): The scheduled end time of the maintenance event (UTC).
* **estimatedDowntime**: string (ReadOnly): The estimated downtime as an ISO 8601 duration string (e.g., 'PT60S' = 60 seconds).
* **lastUpdatedTime**: string (ReadOnly): The time this maintenance event record was last updated (UTC).
* **maintenanceEventId**: string (ReadOnly): A service-generated identifier for this maintenance event, assigned by the platform (e.g., 'YL1T-HFG'). The format is not contractual and clients should not attempt to parse or construct this value.
* **maintenanceType**: 'PlannedMaintenance' | string (Required, ReadOnly): The maintenance type (e.g., 'PlannedMaintenance').
* **originalStartTime**: string (Required, ReadOnly): The initial scheduled start time before any reschedule (UTC). Equals startTime when the event has never been rescheduled.
* **rescheduledFrom**: string (ReadOnly): The previous scheduled start time before the most recent reschedule (UTC). Null if the event has never been rescheduled.
* **startTime**: string (Required, ReadOnly): The scheduled start time of the maintenance event (UTC).
* **status**: 'Canceled' | 'Complete' | 'InProgress' | 'Planned' | 'Rescheduled' | string (Required, ReadOnly): The customer-facing status of the maintenance event.
...
* **policyDetails**: [PolicyDetail](#policydetail)[]: Array of policy validation details.
...
## PolicyDetail
### Properties
* **errorCode**: int: The error code if validation failed.
* **errorMessage**: string: The error message if validation failed.
* **passed**: bool: Whether the policy validation passed.
* **policyDescription**: string: Description of what the policy validates.
...
* **errorInfo**: [PrecheckErrorInfo](#precheckerrorinfo)[]: Array of error information.
* **upgradeSequence**: [UpgradeSequence](#upgradesequence): The upgrade sequence information.
...
## UpgradeSequence
### Properties
* **sourceVersion**: '11' | '12' | '13' | '14' | '15' | '16' | '17' | '18' | string: The source PostgreSQL version.
* **targetVersion**: '11' | '12' | '13' | '14' | '15' | '16' | '17' | '18' | string: The target PostgreSQL version.
