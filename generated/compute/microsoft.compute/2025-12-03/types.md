# Microsoft.Compute @ 2025-12-03

## Resource Microsoft.Compute/galleries@2025-12-03
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-12-03' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Compute/galleries/applications@2025-12-03
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-12-03' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Compute/galleries/applications/versions@2025-12-03
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-12-03' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Compute/galleries/images@2025-12-03
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-12-03' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Compute/galleries/images/versions@2025-12-03
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-12-03' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Compute/galleries/inVMAccessControlProfiles@2025-12-03
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-12-03' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Compute/galleries/inVMAccessControlProfiles/versions@2025-12-03
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-12-03' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Compute/galleries/scripts@2025-12-03
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-12-03' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **location**: string (Required): The geo-location where the resource lives
* **name**: string {pattern: "^[a-zA-Z0-9]+([_]?[a-zA-Z0-9]+)*$"} (Required, DeployTimeConstant): The resource name
* **properties**: [GalleryScriptProperties](#galleryscriptproperties): Describes the properties of a gallery Script Definition.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **tags**: [TrackedResourceTags](#trackedresourcetags): Resource tags.
* **type**: 'Microsoft.Compute/galleries/scripts' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.Compute/galleries/scripts/versions@2025-12-03
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-12-03' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
* **properties**: [GalleryScriptVersionProperties](#galleryscriptversionproperties): Describes the properties of a gallery Script Version.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **tags**: [TrackedResourceTags](#trackedresourcetags): Resource tags.
...
* **status**: 'Failed' | 'Succeeded' | 'Unknown' | string (ReadOnly): This property specifies the status of the validationProfile of the image version.
...
* **storageAccountStrategy**: 'DefaultStandard_LRS' | 'PreferStandard_ZRS' | string: Specifies the strategy to be used when selecting the storage account type. Cannot be specified along with storageAccountType, but can be overridden per region by specifying targetRegions[].storageAccountType. This property is not updatable.
* **storageAccountType**: 'PremiumV2_LRS' | 'Premium_LRS' | 'Standard_LRS' | 'Standard_ZRS' | string: Specifies the storage account type to be used to store the image. Cannot be specified along with storageAccountStrategy. This property is not updatable.
...
* **defaultValue**: string: The default value of the parameter, only applies to string types.
* **description**: string: A description to help users understand what this parameter means
* **enumValues**: string[]: A list of permissible values. Only applicable values are from 'enum' values defined in 'GalleryScriptParameter'.
* **maxValue**: string: The minimum value of parameter.
* **minValue**: string: The minimum value of parameter.
* **name**: string (Required): The name of the parameter.
* **required**: bool: Indicates whether this parameter must be passed.
* **type**: 'Boolean' | 'Double' | 'Enum' | 'Int' | 'String' | string: Specifies the type of the Gallery Script parameter. Possible values are: String, Int, Double, Boolean, Enum
...
* **endOfLifeDate**: string: The end of life date of the gallery Script Definition. This property can be used for decommissioning purposes. This property is updatable.
...
### Properties
* **provisioningState**: 'Creating' | 'Deleting' | 'Failed' | 'Migrating' | 'Succeeded' | 'Updating' | string (ReadOnly): The provisioning state, which only appears in the response.
* **publishingProfile**: [GalleryScriptVersionPublishingProfile](#galleryscriptversionpublishingprofile) (Required): The publishing profile of a gallery image version.
* **replicationStatus**: [ReplicationStatus](#replicationstatus) (ReadOnly): This is the replication status of the gallery image version.
* **safetyProfile**: [GalleryScriptVersionSafetyProfile](#galleryscriptversionsafetyprofile): The safety profile of the Gallery Script Version.
...
* **replicaCount**: int: The number of replicas of the Image Version to be created per region. This property would take effect for a region when regionalReplicaCount is not specified. This property is updatable.
* **replicationMode**: 'Full' | 'Shallow' | string: Optional parameter which specifies the mode to be used for replication. This property is not updatable.
* **source**: [ScriptSource](#scriptsource) (Required): The source script from which the Script Version is going to be created.
* **storageAccountStrategy**: 'DefaultStandard_LRS' | 'PreferStandard_ZRS' | string: Specifies the strategy to be used when selecting the storage account type. Cannot be specified along with storageAccountType, but can be overridden per region by specifying targetRegions[].storageAccountType. This property is not updatable.
* **storageAccountType**: 'PremiumV2_LRS' | 'Premium_LRS' | 'Standard_LRS' | 'Standard_ZRS' | string: Specifies the storage account type to be used to store the image. Cannot be specified along with storageAccountStrategy. This property is not updatable.
* **targetExtendedLocations**: [GalleryTargetExtendedLocation](#gallerytargetextendedlocation)[]: The target extended locations where the Image Version is going to be replicated to. This property is updatable.
* **targetRegions**: [TargetRegion](#targetregion)[]: The target regions where the Image Version is going to be replicated to. This property is updatable.
...
## ScriptSource
### Properties
* **parameters**: [GalleryScriptParameter](#galleryscriptparameter)[]: Optional. Any input parameters that needs to passed to the script and are accessed within the script for its execution.
* **scriptLink**: string (Required): Required. The link of the source script, it must be a readable storage blob with SAS URI or publicly accessible URI or managed identity enabled.
