# Microsoft.Compute @ 2026-04-01

## Resource Microsoft.Compute/availabilitySets@2026-04-01
...
## Resource Microsoft.Compute/capacityReservationGroups@2026-04-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Compute/capacityReservationGroups/capacityReservations@2026-04-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Compute/hostGroups@2026-04-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Compute/hostGroups/hosts@2026-04-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Compute/images@2026-04-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Compute/interconnectBlocks@2026-04-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **location**: string (Required): The geo-location where the resource lives
* **name**: string (Required, DeployTimeConstant): The resource name
* **placement**: [Placement](#placement): Placement section specifies the user-defined constraints for Interconnect Block hardware placement. This property cannot be changed once Interconnect Block is provisioned.
* **properties**: [InterconnectBlockProperties](#interconnectblockproperties): Properties of the Interconnect Block.
* **sku**: [Sku](#sku) (Required): SKU of the resource for which capacity needs to be pre-allocated. Both `sku.name` and `sku.capacity` are required at create. After create, only `sku.capacity` can be updated.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **tags**: [TrackedResourceTags](#trackedresourcetags): Resource tags.
* **type**: 'Microsoft.Compute/interconnectBlocks' (ReadOnly, DeployTimeConstant): The resource type
* **zones**: string[]: The availability zones.

## Resource Microsoft.Compute/locations/publishers/artifacttypes/types/versions@2026-04-01 (ReadOnly)
...
## Resource Microsoft.Compute/proximityPlacementGroups@2026-04-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Compute/restorePointCollections@2026-04-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Compute/restorePointCollections/restorePoints@2026-04-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Compute/sshPublicKeys@2026-04-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Compute/virtualMachines@2026-04-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Compute/virtualMachines/diagnosticRunCommands@2026-04-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **location**: string (Required): The geo-location where the resource lives
* **name**: string (Required, DeployTimeConstant): The resource name
* **properties**: [VirtualMachineRunCommandProperties](#virtualmachineruncommandproperties): Describes the properties of a Virtual Machine diagnostic run command.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **tags**: [TrackedResourceTags](#trackedresourcetags): Resource tags.
* **type**: 'Microsoft.Compute/virtualMachines/diagnosticRunCommands' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.Compute/virtualMachines/extensions@2026-04-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Compute/virtualMachines/runCommands@2026-04-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Compute/virtualMachineScaleSets@2026-04-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Compute/virtualMachineScaleSets/extensions@2026-04-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Compute/virtualMachineScaleSets/lifecycleHookEvents@2026-04-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string (Required, DeployTimeConstant): The resource name
* **properties**: [VMScaleSetLifecycleHookEventProperties](#vmscalesetlifecyclehookeventproperties) (ReadOnly): Defines the virtual machine scale set lifecycle hook event properties.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.Compute/virtualMachineScaleSets/lifecycleHookEvents' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.Compute/virtualMachineScaleSets/rollingUpgrades@2026-04-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Compute/virtualMachineScaleSets/virtualMachines@2026-04-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Compute/virtualMachineScaleSets/virtualMachines/diagnosticRunCommands@2026-04-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **tags**: [TrackedResourceTags](#trackedresourcetags): Resource tags.
* **type**: 'Microsoft.Compute/virtualMachineScaleSets/virtualMachines/diagnosticRunCommands' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.Compute/virtualMachineScaleSets/virtualMachines/extensions@2026-04-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Compute/virtualMachineScaleSets/virtualMachines/runCommands@2026-04-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-04-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
### Properties
* **managedDiskProperties**: [ManagedDiskProperties](#manageddiskproperties): Specifies the managed disk properties that can be set at the time of implicit creation of the disk.
...
## AllInstancesDown
### Properties
* **automaticallyApprove**: bool: Specifies if Scheduled Events should be auto-approved when all instances are down.
...
### Properties
* **enabled**: bool: Specifies whether automatic SKU migration should be enabled on the virtual machine scale set. The default value is false.
...
* **sharedSubscriptionIds**: [SubResourceReadOnly](#subresourcereadonly)[] (ReadOnly): List of the subscriptions that the capacity reservation group is shared with. **Note:** Minimum api-version: 2023-09-01. Please refer to https://aka.ms/computereservationsharing for more details.
...
### Properties
* **reservationStateInfo**: [CapacityReservationStateInfo](#capacityreservationstateinfo): The reservation state information for a capacity reservation, this detail is primarily provided for Future capacity reservations. Minimum API version: 2026-04-01.
...
* **disableCapacityReservationAssignment**: bool: Specifies whether the virtual machine is explicitly opted out from being associated with any capacity reservation. When set to true, the virtual machine will not be allowed to implicitly or explicitly associate with any type of capacity reservation and will consume capacity from the publicly available capacity. Minimum api-version: 2026-04-01.
...
### Properties
* **reservationState**: 'Approved' | 'Committed' | 'Declined' | 'FulfillmentFailed' | 'Live' | 'PartiallyFulfilled' | 'Pending' | string: The current state of the capacity reservation.
...
## CapacityReservationUtilizationUsedReservedCountBySubscription
### Properties
...
* **storageFaultDomainAlignment**: 'Aligned' | 'BestEffortAligned' | string: Specifies the storage fault domain alignment type for the disk.
...
## DiffDiskSettings
### Properties
* **enableFullCaching**: bool: Specifies whether or not to enable full caching for this VM which will cache the OS disk locally on the host and make this VM more resilient to storage outages
...
### Properties
* **actionOnDiskDelay**: 'AutomaticReattach' | 'None' | string: Determines how to handle disks with slow I/O.
...
* **name**: string: The disk name.
* **statuses**: [InstanceViewStatus](#instanceviewstatus)[]: The resource status information.
* **storageAlignmentStatus**: 'Aligned' | 'Unaligned' | string: Specifies the storage alignment status for the disk.
...
### Properties
* **extensionFeatureTags**: [ExtensionFeatureTag](#extensionfeaturetag)[]: List of additional metadata properties (e.g., compliance flags, supported features).

## ExtensionFeatureTag
### Properties
* **key**: string (Required): The key of the feature tag.
* **value**: string: The value of the feature tag.

## ExternalHealthPolicy
### Properties
* **enabled**: bool: If true, external health is enabled for this scale set. Cannot be set to true on instances where another health monitoring source is active (ApplicationHealth extension or SLB). Defaults to false.
* **expiryDuration**: string: Defines how long the health status set by External Health API will last on the VM. If a signal is not received/updated within this time, the VM Health will be marked as "unknown". Uses the ISO 8601 format. Minimum: 5 minutes (PT5M), Maximum: 3 hours (PT3H).
* **gracePeriod**: string: Grace period for newly created VMs or when the External Health policy is first applied on VMSS. Uses the ISO 8601 format. Minimum: 5 minutes (PT5M), Maximum: 4 hours (PT4H).

## HardwareProfile
### Properties
* **processorMode**: 'Deterministic' | 'Opportunistic' | string: Specifies the processor mode for the virtual machine or virtual machine scale set. Optional; if omitted, the platform default applies (currently Deterministic). This property can be updated on a running VM or VMSS without deallocation or reboot. Minimum api-version: 2026-04-01.
...
* **useLocalFileRules**: bool: When set to true, instructs the GuestProxyAgent inside the VM to load additional access control rules defined in a local file on the VM.
...
### Properties
* **currentCapacity**: int (ReadOnly): The current capacity allocated for this Interconnect Block.
* **statuses**: [InstanceViewStatus](#instanceviewstatus)[] (ReadOnly): The resource status information.

## InterconnectBlockProfile
### Properties
* **interconnectBlock**: [ApiEntityReference](#apientityreference): Specifies the Interconnect Block resource ID that should be used for allocating the Virtual Machine or Scale Set VM instances provided enough capacity has been reserved.

## InterconnectBlockProperties
### Properties
* **instanceView**: [InterconnectBlockInstanceView](#interconnectblockinstanceview) (ReadOnly): The Interconnect Block instance view.
* **interconnectBlockId**: string (ReadOnly): A unique id (GUID) generated and assigned to the Interconnect Block by the platform which does not change throughout the lifetime of the resource.
* **interconnectGroup**: [ApiEntityReference](#apientityreference) (Required): The Microsoft.Network/interconnectGroups resource that this Interconnect Block is associated with. Required at create and immutable thereafter.
* **provisioningState**: string (ReadOnly): The provisioning state, which only appears in the response.
* **provisioningTime**: string (ReadOnly): The date time when the Interconnect Block was last updated.
* **timeCreated**: string (ReadOnly): Specifies the time at which the Interconnect Block resource was created.
* **virtualMachinesAssociated**: [SubResourceReadOnly](#subresourcereadonly)[] (ReadOnly): A list of all virtual machine resource ids that are associated with the Interconnect Block.

## InterconnectGroupProfile
### Properties
* **interconnectGroup**: [SubResource](#subresource): Reference to the interconnect group resource.
* **subgroups**: [SubResource](#subresource)[]: The list of subgroup references within the interconnect group.

## InterconnectInstanceView
### Properties
* **interconnectSubgroupId**: string (ReadOnly): The ID (GUID) of the Interconnect subgroup in which the Virtual Machine was placed.
...
## LifecycleHook
### Properties
* **defaultAction**: 'Approve' | 'Reject' | string: Specifies the action that will be applied to a target resource in the virtual machine scale set lifecycle hook event if the platform does not receive a response from the customer for the target resource before waitUntil.
* **type**: 'UpgradeAutoOSRollingBatchStarting' | 'UpgradeAutoOSScheduling' | string: Specifies the type of the lifecycle hook.
* **waitDuration**: string: Specifies the time duration a virtual machine scale set lifecycle hook event sent to the customer waits for a response from the customer. It should be in ISO 8601 format.

## LifecycleHooksProfile
### Properties
* **lifecycleHooks**: [LifecycleHook](#lifecyclehook)[]: Specifies the lifecycle hooks configured for the virtual machine scale set.
...
### Properties
* **additionalDiskProperties**: [AdditionalDiskProperties](#additionaldiskproperties): Specifies additional properties for the managed disk that can be set at the time of implicit creation of the disk. This property is not captured for Restore Points.
...
### Properties
* **availabilityPolicy**: [DiskAvailabilityPolicy](#diskavailabilitypolicy): In the case of an availability or connectivity issue with the disk, specify the behavior of your VM.
...
* **diskAccessId**: string: Azure resource Id of the DiskAccess resource for using private endpoints on disks.
...
* **logicalSectorSize**: int: Logical sector size in bytes for Ultra Disks. Supported values are 512 and 4096. 4096 is the default.
* **maxShares**: int {minValue: 1}: The maximum number of VMs that can attach to the disk at the same time. Value greater than one indicates a disk that can be mounted on multiple VMs at the same time. Applies to data disks only.
* **networkAccessPolicy**: 'AllowAll' | 'AllowPrivate' | 'DenyAll' | string: Policy for accessing the disk via network.
* **optimizedForFrequentAttach**: bool: Setting this property to true improves reliability and performance of data disks that are frequently (more than 5 times a day) detached from one virtual machine and attached to another. This property should not be set for disks that are not detached and attached frequently as it causes the disks to not align with the fault domain of the virtual machine.
* **performancePlus**: bool: Set this flag to true to get a boost on the performance target of the disk deployed. This flag can only be set on disk creation time and cannot be disabled after enabled.
...
### Properties
* **enabled**: bool: Specifies whether maxInstancePercentPerZonePolicy should be enabled on the virtual machine scale set.
* **value**: int {maxValue: 100}: Limit on the number of instances in each zone as a percentage of the total capacity of the virtual machine scale set.
...
## NetworkProfile
### Properties
* **interconnectGroupProfile**: [InterconnectGroupProfile](#interconnectgroupprofile): Specifies the interconnect group profile to associate with the virtual machine. Minimum api-version: 2026-03-01.
...
### Properties
* **reimageRecoveryPolicy**: [ReimageRecoveryPolicy](#reimagerecoverypolicy): The configuration parameters used for reimage recovery policy.
* **restartRecoveryPolicy**: [RestartRecoveryPolicy](#restartrecoverypolicy): The configuration parameters used for restart recovery policy.
* **startRecoveryPolicy**: [StartRecoveryPolicy](#startrecoverypolicy): The configuration parameters used for start recovery policy.
...
### Properties
* **enabled**: bool: Specifies whether reimage recovery should be enabled. The default value is false.
...
* **operationRecoverySettings**: [OperationRecoverySettings](#operationrecoverysettings): The configuration parameters used for operation recovery settings.
...
* **zoneAllocationPolicy**: [ZoneAllocationPolicy](#zoneallocationpolicy): The configuration parameters used while performing zone allocation.

## ResiliencyProfile
### Properties
* **zoneMovement**: [ZoneMovement](#zonemovement): Zone movement configuration.
...
### Properties
* **enabled**: bool: Specifies whether restart recovery should be enabled. The default value is false.
...
* **maxUnhealthyUpgradedInstancePercent**: int {maxValue: 100}: The maximum percentage of upgraded virtual machine instances that can be found to be in an unhealthy state. This check will happen after each batch is upgraded. If this percentage is ever exceeded, the rolling update aborts. The default value for this parameter is 20%.
...
## ScheduleProfile
### Properties
* **end**: string: The required end date for Block capacity reservations. Must be after the start date, with a duration of either 1–14 whole days or 3–26 whole weeks. Example: 2025-06-28.
* **minimumCommitmentDays**: int: The minimum number of days that must pass after the start date before a Future capacity reservation can be updated or deleted once it has been committed. Will be populated with a default value if not provided.
* **modifiableUntil**: string (ReadOnly): The date/time until which a Future capacity reservation can be updated or deleted. Read-only.
...
* **automaticSkuMigrationPolicy**: [AutomaticSkuMigrationPolicy](#automaticskumigrationpolicy): Specifies the policy that controls whether the platform may automatically migrate scale set instances to a different VM size from the SKU profile depending on platform demands. When omitted, automatic SKU migration is disabled.
...
## StartRecoveryPolicy
### Properties
* **enabled**: bool: Specifies whether start recovery should be enabled. The default value is false.
...
* **diskApiVersion**: '2025-01-02' | '2026-03-02' | string: Specifies the Disk API version used when applying additionalDiskProperties to managed disks. The value must be in the format YYYY-MM-DD (e.g., "2026-03-02").
...
* **typeHandlerVersion**: string: Specifies the Major.Minor.Patch.Hotfix version of the script handler. Azure platform will deliver the latest Patch.Hotfix version in the Major.Minor series.

## VirtualMachineExtensionImageProperties
### Properties
* **computeRole**: string (Required): The type of role (IaaS or PaaS) this extension supports.
* **extensionFeatureMetadata**: [ExtensionFeatureMetadata](#extensionfeaturemetadata) (ReadOnly): Additional metadata about extension features, including compliance and capability tags.
...
* **releaseCategory**: 'BugFix' | 'CompatibilityUpdate' | 'NewFeature' | 'Other' | 'SecurityFix' | string (ReadOnly): Categorizes the type of change introduced (e.g., BugFix, SecurityFix, CompatibilityUpdate, NewFeature, Other).
* **releaseNotes**: string (ReadOnly): Summary of changes or updates in this extension version.
* **runProfile**: 'Hybrid' | 'LongRunning' | 'Other' | 'RunOnce' | string (ReadOnly): Specifies when and how the extension should be executed.
* **supportsMultipleExtensions**: bool: Whether the handler can support multiple extensions.
* **urgencyLevel**: 'Emergency' | 'Expedited' | 'Regular' | string (ReadOnly): Indicates the urgency level for applying this extension update.
...
* **type**: string: Specifies the type of the extension; an example is "CustomScriptExtension".
* **typeHandlerVersion**: string: Specifies the Major.Minor version of the script handler. Customer is able to specify only the Major.Minor version of an extension, Azure platform will deliver the latest Patch.Hotfix version in the Major.Minor series.
...
* **interconnectInstanceView**: [InterconnectInstanceView](#interconnectinstanceview) (ReadOnly): The Interconnect runtime view of the Virtual Machine. Minimum api-version: 2026-03-01.
...
## VirtualMachineIpTag
### Properties
* **firstPartyServiceTagId**: string: The first party service tag resource identifier associated with the public IP address.
...
* **interconnectBlockProfile**: [InterconnectBlockProfile](#interconnectblockprofile): Specifies information about the Interconnect Block that is used to allocate the Virtual Machine. Minimum api-version: 2026-03-01.
...
* **priority**: 'Low' | 'Regular' | 'Spot' | 'SpotPlus' | string: Specifies the priority for the virtual machine. Minimum api-version: 2019-03-01
* **provisioningState**: string (ReadOnly): The provisioning state, which only appears in the response.
...
* **resiliencyProfile**: [ResiliencyProfile](#resiliencyprofile): Resiliency profile for the virtual machine.
...
### Properties
* **commandId**: string: Specifies a commandId of predefined built-in script. Command IDs available for Linux are listed at https://aka.ms/RunCommandManagedLinux#available-commands, Windows at https://aka.ms/RunCommandManagedWindows#available-commands.
* **galleryScriptReferenceId**: string: The resource ID of a Gallery Script version that needs to be executed. Example ID looks like /subscriptions/{subId}/resourceGroups/{rgName}/providers/Microsoft.Compute/galleries/{galleryName}/scripts/{scriptName}/versions/{version}.
* **script**: string: Specifies the script content to be executed on the VM.
* **scriptShell**: 'Default' | 'Powershell7' | string: Optional. Specify which shell to use for running the script. These values must match those expected by the extension. Currently supported only for Windows VMs, script uses Powershell 7 when specified. Powershell 7 must be already installed on the machine to use Powershell7 parameter value.
...
### Properties
* **processorMode**: 'Deterministic' | 'Opportunistic' | string: Specifies the processor mode for the virtual machine scale set. Optional; if omitted, the platform default applies (currently Deterministic). This property can be updated on a running VMSS without deallocation or reboot. Minimum api-version: 2026-04-01.
...
### Properties
* **defaultVirtualMachineScaleSetInfo**: [DefaultVirtualMachineScaleSetInfo](#defaultvirtualmachinescalesetinfo) (ReadOnly): Indicates the target Virtual Machine ScaleSet properties upon triggering a seamless migration without downtime of the VMs via the ConvertToVirtualMachineScaleSet API.
* **migrateToVirtualMachineScaleSet**: [SubResource](#subresource) (ReadOnly): Specifies the Virtual Machine Scale Set that the Availability Set is migrated to.
...
* **tags**: [VirtualMachineScaleSetNetworkConfigurationTags](#virtualmachinescalesetnetworkconfigurationtags): Resource tags applied to the networkInterface address created by this NetworkInterfaceConfiguration
...
## VirtualMachineScaleSetNetworkConfigurationTags
### Properties
### Additional Properties
* **Additional Properties Type**: string
...
* **interconnectGroupProfile**: [InterconnectGroupProfile](#interconnectgroupprofile): Specifies the interconnect group profile to associate with the scale set. Minimum api-version: 2026-03-01.
* **networkApiVersion**: '2020-11-01' | '2022-11-01' | string: specifies the Microsoft.Network API version used when creating networking resources in the Network Interface Configurations for Virtual Machine Scale Set with orchestration mode 'Flexible'
...
* **externalHealthPolicy**: [ExternalHealthPolicy](#externalhealthpolicy): Specifies the external health policy for the virtual machine scale set.
* **highSpeedInterconnectPlacement**: 'None' | 'Trunk' | string: Specifies the high speed interconnect placement for the virtual machine scale set.
...
* **lifecycleHooksProfile**: [LifecycleHooksProfile](#lifecyclehooksprofile): Specifies the lifecycle hooks profile for the virtual machine scale set.
...
* **skuProfile**: [SkuProfile](#skuprofile): Specifies the sku profile for the virtual machine scale set.
...
* **zonalPlatformFaultDomainAlignMode**: 'Aligned' | 'BestEffortAligned' | 'Unaligned' | string: Specifies the align mode between Virtual Machine Scale Set compute and storage Fault Domain count.
...
* **sku**: [PublicIPAddressSku](#publicipaddresssku): Describes the public IP Sku. It can only be set with OrchestrationMode as Flexible.
* **tags**: [VirtualMachineScaleSetPublicIPAddressConfigurationTags](#virtualmachinescalesetpublicipaddressconfigurationtags): Resource tags applied to the publicIP address created by this PublicIPAddressConfiguration
...
## VirtualMachineScaleSetPublicIPAddressConfigurationTags
### Properties
### Additional Properties
* **Additional Properties Type**: string
...
* **interconnectInstanceView**: [InterconnectInstanceView](#interconnectinstanceview) (ReadOnly): The Interconnect runtime view of the Scale Set VM instance. Minimum api-version: 2026-03-01.
* **maintenanceRedeployStatus**: [MaintenanceRedeployStatus](#maintenanceredeploystatus): The Maintenance Operation status on the virtual machine.
...
### Properties
* **interconnectGroupProfile**: [InterconnectGroupProfile](#interconnectgroupprofile): Specifies the interconnect group profile to associate with the scale set vm instance. Minimum api-version: 2026-03-01.
* **networkInterfaceConfigurations**: [VirtualMachineScaleSetNetworkConfiguration](#virtualmachinescalesetnetworkconfiguration)[]: The list of network configurations.
...
* **interconnectBlockProfile**: [InterconnectBlockProfile](#interconnectblockprofile): Specifies the Interconnect Block related details of a Scale Set. Minimum api-version: 2026-03-01.
* **licenseType**: string: Specifies that the image or disk that is being used was licensed on-premises. <br><br> Possible values for Windows Server operating system are: <br><br> Windows_Client <br><br> Windows_Server <br><br> Possible values for Linux Server operating system are: <br><br> RHEL_BYOS (for RHEL) <br><br> SLES_BYOS (for SUSE) <br><br> For more information, see [Azure Hybrid Use Benefit for Windows Server](https://docs.microsoft.com/azure/virtual-machines/windows/hybrid-use-benefit-licensing) <br><br> [Azure Hybrid Use Benefit for Linux Server](https://docs.microsoft.com/azure/virtual-machines/linux/azure-hybrid-benefit-linux) <br><br> Minimum api-version: 2015-06-15
...
* **priority**: 'Low' | 'Regular' | 'Spot' | 'SpotPlus' | string: Specifies the priority for the virtual machines in the scale set. Minimum api-version: 2017-10-30-preview.
* **scheduledEventsProfile**: [ScheduledEventsProfile](#scheduledeventsprofile): Specifies Scheduled Event related configurations.
...
* **timeCreated**: string (ReadOnly): Specifies the time in which this VM profile for the Virtual Machine Scale Set was created. This value will be added to VMSS Flex VM tags when creating/updating the VMSS VM Profile. Minimum API version for this property is 2023-09-01.
...
* **capacityReservation**: [CapacityReservationProfile](#capacityreservationprofile): Specifies information about the capacity reservation that is used to allocate the virtual machine scale set VM instance. The capacity reservation group is inherited from the parent virtual machine scale set and cannot be changed on the individual scale set VM instance. Minimum api-version: 2026-04-01.
* **diagnosticsProfile**: [DiagnosticsProfile](#diagnosticsprofile): Specifies the boot diagnostic settings state. Minimum api-version: 2015-06-15.
* **hardwareProfile**: [HardwareProfile](#hardwareprofile): Specifies the hardware settings for the virtual machine.
...
* **interconnectBlockProfile**: [InterconnectBlockProfile](#interconnectblockprofile): Specifies the Interconnect Block related details of a Scale Set VM instance. Minimum api-version: 2026-03-01.
...
* **provisioningState**: string (ReadOnly): The provisioning state, which only appears in the response.
* **resilientVMDeletionStatus**: 'Disabled' | 'Enabled' | 'Failed' | 'InProgress' | string: Specifies the resilient VM deletion status for the virtual machine.
* **securityProfile**: [SecurityProfile](#securityprofile): Specifies the Security related profile settings for the virtual machine.
* **storageProfile**: [StorageProfile](#storageprofile): Specifies the storage settings for the virtual machine disks.
* **timeCreated**: string (ReadOnly): Specifies the time at which the Virtual Machine resource was created. Minimum api-version: 2021-11-01.
* **userData**: string: UserData for the VM, which must be base-64 encoded. Customer should not pass any secrets in here. Minimum api-version: 2021-03-01
* **virtualMachineResourceId**: string (ReadOnly): Specifies the ARM resource ID of the standalone virtual machine associated with this VMSS VM. This property is only applicable to Virtual Machine Scale Sets with Flexible orchestration mode. Minimum api-version: 2025-11-01.
...
### Properties
* **priority**: string: Can only be present for a lifecycle hook event of type "UpgradeAutoOSScheduling".
...
### Properties
* **additionalContext**: [VMScaleSetLifecycleHookEventAdditionalContext](#vmscalesetlifecyclehookeventadditionalcontext): Additional key-value pairs set on the lifecycle hook event that gives customer some useful context/data.
...
* **defaultAction**: 'Approve' | 'Reject' | string (ReadOnly): Specify the action that will be applied on the a target resource in the virtual machine scale set lifecycle hook event if the platform does not get a response from the customer for the target resource before waitUntil.
* **maxWaitUntil**: string (ReadOnly): Specifies the exact UTC timestamp in ISO 8601 format till when the customer can delay the lifecycle hook event. The customer will not be allowed to delay the event to a timestamp beyond this.
* **state**: 'Active' | 'Completed' | string (ReadOnly): Specifies the state of the virtual machine scale set lifecycle hook event.
* **targetResources**: [VMScaleSetLifecycleHookEventTargetResource](#vmscalesetlifecyclehookeventtargetresource)[]: List of target resources which are getting processed in the virtual machine scale set lifecycle hook event.
* **timeCreated**: string (ReadOnly): The UTC timestamp in ISO 8601 format at which the platform creates the virtual machine scale set lifecycle hook event entity.
* **type**: 'UpgradeAutoOSRollingBatchStarting' | 'UpgradeAutoOSScheduling' | string: Defines the type or scenario for sending a virtual machine scale set lifecycle hook event to the customer.
...
### Properties
* **actionState**: 'Approved' | 'Rejected' | 'Waiting' | string: State of the lifecycle hook for the target resource. The customer can patch this property to move the lifecycle hook to a terminal state.
* **resource**: [ApiEntityReference](#apientityreference): Specifies the target ARM resource. Currently, this can be a virtual machine scale set resource or an individual virtual machine resource within a VMScaleSet.
...
* **enableVMAgentPlatformUpdates**: bool (ReadOnly): Indicates whether VMAgent Platform Updates are enabled for the Windows Virtual Machine.
...
### Properties
* **maxInstancePercentPerZonePolicy**: [MaxInstancePercentPerZonePolicy](#maxinstancepercentperzonepolicy): The configuration parameters used to limit the number of virtual machines per availability zone in the virtual machine scale set.
* **maxZoneCount**: int: The maximum number of availability zones to use if the ZonePlacementPolicy is 'Auto'. If not specified, all availability zones will be used.

## ZoneMovement
### Properties
* **isEnabled**: bool: Indicates if zone movement is enabled. By default isEnabled is set to false i.e VM can't be moved from one zone to another.
