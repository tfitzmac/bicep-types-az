# Microsoft.HybridContainerService @ 2026-04-01-preview

## Resource Microsoft.HybridContainerService/kubernetesVersions@2026-04-01-preview
...
* **properties**: [KubernetesVersionProfileProperties](#kubernetesversionprofileproperties): The resource-specific properties for this resource.
...
## Resource Microsoft.HybridContainerService/provisionedClusterInstances@2026-04-01-preview
* **Valid Scope(s)**: Unknown
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **extendedLocation**: [ExtendedLocation](#extendedlocation): Extended location pointing to the underlying infrastructure
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: 'default' (Required, DeployTimeConstant): The resource name
* **properties**: [ProvisionedClusterProperties](#provisionedclusterproperties): The resource-specific properties for this resource.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.HybridContainerService/provisionedClusterInstances' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.HybridContainerService/provisionedClusterInstances/agentPools@2026-04-01-preview
* **Valid Scope(s)**: Unknown
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **extendedLocation**: [ExtendedLocation](#extendedlocation): Extended location pointing to the underlying infrastructure
...
* **properties**: [AgentPoolProperties](#agentpoolproperties): The resource-specific properties for this resource.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
...
## Resource Microsoft.HybridContainerService/provisionedClusterInstances/hybridIdentityMetadata@2026-04-01-preview
* **Valid Scope(s)**: Unknown
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: 'default' (Required, DeployTimeConstant): The resource name
* **properties**: [HybridIdentityMetadataProperties](#hybrididentitymetadataproperties): The resource-specific properties for this resource.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
...
## Resource Microsoft.HybridContainerService/provisionedClusterInstances/upgradeProfiles@2026-04-01-preview (ReadOnly)
* **Valid Scope(s)**: Unknown
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: 'default' (Required, DeployTimeConstant): The resource name
* **properties**: [ProvisionedClusterUpgradeProfileProperties](#provisionedclusterupgradeprofileproperties) (ReadOnly): The resource-specific properties for this resource.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
...
## Resource Microsoft.HybridContainerService/skus@2026-04-01-preview
* **Valid Scope(s)**: Unknown
### Properties
* **apiVersion**: '2026-04-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **extendedLocation**: [ExtendedLocation](#extendedlocation): Extended location pointing to the underlying infrastructure
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: 'default' (Required, DeployTimeConstant): The resource name
* **properties**: [VmSkuProfileProperties](#vmskuprofileproperties): The resource-specific properties for this resource.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.HybridContainerService/skus' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.HybridContainerService/virtualNetworks@2026-04-01-preview
...
## Function listAdminKubeconfig (Microsoft.HybridContainerService/provisionedClusterInstances@2026-04-01-preview)
...
## Function listUserKubeconfig (Microsoft.HybridContainerService/provisionedClusterInstances@2026-04-01-preview)
* **Resource**: Microsoft.HybridContainerService/provisionedClusterInstances
* **ApiVersion**: 2026-04-01-preview
* **Output**: [ListCredentialResponse](#listcredentialresponse)
...
* **gpuCountPerNode**: int: The number of gpus attached to a node.
...
* **nodeLabels**: [AgentPoolPropertiesNodeLabels](#agentpoolpropertiesnodelabels): The node labels to be persisted across all nodes in agent pool.
...
* **status**: [AgentPoolProvisioningStatus](#agentpoolprovisioningstatus): The observed status of the agent pool.
...
* **readyReplicas**: [AgentPoolUpdateProfile](#agentpoolupdateprofile)[]: The agent pools that are ready.
...
* **count**: int: Number of control plane nodes. The default value is 1, and the count can be either 2 or odd numbers.
...
## FeaturesStatus
### Properties
* **keyRotationStatus**: [KeyRotationStatus](#keyrotationstatus): The status of workload identity key rotation
...
## KeyRotationStatus
### Properties
* **keyAdditionAt**: string: Timestamp when the new key was added to the system.
* **newKeyActivatedAt**: string: Timestamp when the new key is activated and becomes the primary key.
* **nextScheduledRotation**: string: Timestamp when the next scheduled key rotation will occur.
* **previousKeyExpiresAt**: string: Timestamp for when old public key is rotated out. This breaks static tokens, which must be rotated before this deadline.
* **state**: 'Failed' | 'Pending' | 'Success' | string: The current state of the key rotation operation. Possible values include: 'Pending', 'Failed', 'Success'.
...
### Properties
* **error**: [ListCredentialResponseError](#listcredentialresponseerror): Error listing the kubeconfig credential response.
* **id**: string (ReadOnly): Operation Id
* **name**: string (ReadOnly): Operation Name
* **properties**: [ListCredentialResponseProperties](#listcredentialresponseproperties): Properties of the kubeconfig credential response.
...
* **nodeLabels**: [NamedAgentPoolProfileNodeLabels](#namedagentpoolprofilenodelabels): The node labels to be persisted across all nodes in agent pool.
* **nodeTaints**: string[]: Taints added to new nodes during node pool create and scale. For example, key=value:NoSchedule.
* **osSKU**: 'CBLMariner' | 'Windows2019' | 'Windows2022' | string: Specifies the OS SKU used by the agent pool. The default is CBLMariner if OSType is Linux. The default is Windows2019 when OSType is Windows.
* **osType**: 'Linux' | 'Windows' | string: The particular KubernetesVersion Image OS Type (Linux, Windows)
* **vmSize**: string: The VM sku size of the agent pool node VMs.

## NamedAgentPoolProfileNodeLabels
### Properties
### Additional Properties
* **Additional Properties Type**: string
...
* **networkPolicy**: 'calico' | 'cilium' | string: Network policy used for building Kubernetes network. Possible values include: 'calico'.
...
* **securityProfile**: [SecurityProfile](#securityprofile): The security configuration profile for the provisioned cluster.
...
* **featuresStatus**: [FeaturesStatus](#featuresstatus) (ReadOnly): The status of cluster features.
...
## SecurityProfile
### Properties
* **customCATrustCertificates**: any[] {maxLength: 10}: The list of base64 encoded certificate strings that will be added to the node trust store. At most 10 certificates can be provided.
* **fipsImage**: [SecurityProfileFipsImage](#securityprofilefipsimage): FIPS image settings for the security profile.

## SecurityProfileFipsImage
### Properties
* **enabled**: bool: Indicates whether to enable FIPS image.
...
* **infraVnetProfile**: [VirtualNetworkPropertiesInfraVnetProfile](#virtualnetworkpropertiesinfravnetprofile): Infrastructure network profile for HCI platform
* **ipAddressPrefix**: string: IP Address Prefix of the network
* **provisioningState**: 'Accepted' | 'Canceled' | 'Creating' | 'Deleting' | 'Failed' | 'Pending' | 'Succeeded' | 'Updating' | 'Upgrading' | string (ReadOnly): The provisioning state of the virtual network resource
