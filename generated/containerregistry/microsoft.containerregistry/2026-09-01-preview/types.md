# Microsoft.ContainerRegistry @ 2026-09-01-preview

## Resource Microsoft.ContainerRegistry/registries@2026-09-01-preview
...
## Resource Microsoft.ContainerRegistry/registries/cacheRules@2026-09-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-09-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerRegistry/registries/connectedRegistries@2026-09-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-09-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **identity**: [ManagedServiceIdentity](#managedserviceidentity): The user-assigned managed identity used by the on-prem connected registry to authenticate with the cloud registry for sync operations. Requires authType to be ManagedIdentity.
* **name**: string {minLength: 5, maxLength: 50, pattern: "^[a-zA-Z0-9]*$"} (Required, DeployTimeConstant): The resource name
...
## Resource Microsoft.ContainerRegistry/registries/credentialSets@2026-09-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-09-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerRegistry/registries/exportPipelines@2026-09-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-09-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerRegistry/registries/importPipelines@2026-09-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-09-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerRegistry/registries/packages/archives@2026-09-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-09-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerRegistry/registries/packages/archives/versions@2026-09-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-09-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerRegistry/registries/pipelineRuns@2026-09-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-09-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerRegistry/registries/privateEndpointConnections@2026-09-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-09-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerRegistry/registries/privateLinkResources@2026-09-01-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-09-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerRegistry/registries/replications@2026-09-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-09-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerRegistry/registries/scopeMaps@2026-09-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-09-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerRegistry/registries/tokens@2026-09-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-09-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.ContainerRegistry/registries/webhooks@2026-09-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-09-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Function listCredentials (Microsoft.ContainerRegistry/registries@2026-09-01-preview)
* **Resource**: Microsoft.ContainerRegistry/registries
* **ApiVersion**: 2026-09-01-preview
* **Output**: [RegistryListCredentialsResult](#registrylistcredentialsresult)

## Function listEvents (Microsoft.ContainerRegistry/registries/webhooks@2026-09-01-preview)
...
#### Properties
* **authenticationType**: 'GoogleArtifactRegistry' (Required): Authentication type discriminator.
* **projectNumber**: string {minLength: 5, maxLength: 30, pattern: "^[1-9][0-9]{4,29}$"} (Required): The Google Cloud Platform project that is configured for authentication
...
* **workloadIdentityPool**: string {minLength: 4, maxLength: 32, pattern: "^[a-z][a-z0-9-]{2,30}[a-z0-9]$"} (Required): The Google Cloud platform workload identity pool used for authentication.
* **workloadIdentityProvider**: string {minLength: 4, maxLength: 32, pattern: "^[a-z][a-z0-9-]{2,30}[a-z0-9]$"} (Required): The Google Cloud Platform workload identity provider used for authentication.
...
## CacheRuleProperties
### Properties
* **additionalAuthenticationProperties**: [AdditionalAuthenticationProperties](#additionalauthenticationproperties): Authentication configuration used by the cache rule to access the upstream source repository.
...
* **provisioningState**: 'Canceled' | 'Creating' | 'Deleting' | 'Failed' | 'Succeeded' | 'Updating' | string (ReadOnly): Provisioning state of the resource.
* **registrySyncResult**: [RegistrySyncResult](#registrysyncresult): The result of the connected registry's most recent sync with its parent.
...
### Properties
* **keyVaultUri**: string: They key vault secret uri to obtain the target storage SAS token.
* **storageAccessMode**: 'ManagedIdentity' | 'SasToken' | string: The storage access mode used for the customer storage account.
...
### Properties
* **keyVaultUri**: string: They key vault secret uri to obtain the source storage SAS token.
* **storageAccessMode**: 'ManagedIdentity' | 'SasToken' | string: The storage access mode used for the customer storage account.
...
* **endpointProtocol**: 'IPv4' | 'IPv4AndIPv6' | string: The connectivity protocol for the registry, such as IPv4 or dual stack (IPv4 and IPv6).
...
* **regionalEndpointHostNames**: string[] (ReadOnly): List of host names that will serve registry when RegionalEndpoints is enabled.
* **regionalEndpoints**: 'Disabled' | 'Enabled' | string: Enable per-region endpoints for accessing registry.
...
* **writableCacheRepos**: 'Disabled' | 'Enabled' | string: Whether to allow cache operations that write to repositories in this registry.
* **zoneRedundancy**: 'Disabled' | 'Enabled' | string: Whether or not zone redundancy is enabled for this container registry

## RegistrySyncResult
### Properties
* **lastSuccessfulSyncEndTime**: string: The time that the connected registry's most recent successful sync ended.
* **lastSyncEndTime**: string: The time that the connected registry's most recent sync ended.
* **lastSyncStartTime**: string: The time that the connected registry's most recent sync started.
* **syncState**: 'Failed' | 'NotActivated' | 'Pending' | 'Succeeded' | 'Syncing' | 'TimedOut' | string (Required, ReadOnly): The status of the connected registry's most recent sync.
* **syncTrigger**: 'InitialSync' | 'ManualResync' | 'RecoveryService' | 'SyncTokenUpdate' | string (Required, ReadOnly): The action that triggered the most recent registry sync.
...
### Properties
* **availableGib**: int (ReadOnly): The available disk space in gibibytes (Gib, base-2).
...
* **totalGib**: int (ReadOnly): The total disk space in gibibytes (Gib, base-2).
* **type**: string (ReadOnly): The component of the connected registry corresponding to the status.

## SyncProperties
### Properties
* **authType**: 'ManagedIdentity' | 'SyncToken' | string: The authentication type used for the connected registry to sync with its parent.
...
* **tokenId**: string: The resource ID of the ACR token used to authenticate the connected registry to its parent during sync.
...
* **virtualNetworkSubnetResourceId**: string (Required): Resource ID of a subnet, for example: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{vnetName}/subnets/{subnetName}.
