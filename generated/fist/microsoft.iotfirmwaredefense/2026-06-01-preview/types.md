# Microsoft.IoTFirmwareDefense @ 2026-06-01-preview

## Resource Microsoft.IoTFirmwareDefense/workspaces@2026-06-01-preview
...
## Resource Microsoft.IoTFirmwareDefense/workspaces/firmwares@2026-06-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-06-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.IoTFirmwareDefense/workspaces/firmwares/summaries@2026-06-01-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-06-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: 'BinaryHardening' | 'CVE' | 'CommonVulnerabilitiesAndExposures' | 'CryptoCertificate' | 'CryptoKey' | 'Firmware' | 'PasswordHash' | 'SBOM' | 'UnsafeFunctionCalls' | string (Required, DeployTimeConstant): The resource name
...
## Resource Microsoft.IoTFirmwareDefense/workspaces/usageMetrics@2026-06-01-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-06-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## FunctionCall
### Properties
* **count**: int (Required): The number of calls to this function within a single binary.
...
* **lowCveCount**: int: The total number of low severity CVEs detected
* **mediumCveCount**: int: The total number of medium severity CVEs detected
* **schemaVersion**: string: Schema version of the CVE data for this firmware.
* **summaryType**: 'CVE' (Required): The type of summary.
* **totalCveCount**: int: Total number of CVEs found.
* **unknownCveCount**: int: The total number of unknown severity CVEs detected
...
#### Properties
* **summaryType**: 'PasswordHash' (Required): The type of summary.
* **totalPasswordHashCount**: int: Total number of password hashes found.

### SbomSummaryResource
#### Properties
* **summaryType**: 'SBOM' (Required): The type of summary.
* **totalComponentCount**: int: Total number of SBOM components found.

### UnsafeFunctionCallsSummaryResource
#### Properties
* **summaryType**: 'UnsafeFunctionCalls' (Required): The type of summary.
* **totalFileCount**: int: Total number of files analyzed for unsafe function calls.
* **totalNetworkCallCount**: int: Total number of network calls found.
* **totalUnsafeCallCount**: int: Total number of unsafe function calls found.
* **unsafeCallTotals**: [FunctionCall](#functioncall)[]: Total unsafe function call counts per function across all binaries.
