# Microsoft.IoTFirmwareDefense @ 2025-12-01-preview

## Resource Microsoft.IoTFirmwareDefense/workspaces@2025-12-01-preview
...
## Resource Microsoft.IoTFirmwareDefense/workspaces/firmwares@2025-12-01-preview
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-12-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.IoTFirmwareDefense/workspaces/firmwares/summaries@2025-12-01-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-12-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: 'BinaryHardening' | 'CVE' | 'CommonVulnerabilitiesAndExposures' | 'CryptoCertificate' | 'CryptoKey' | 'Firmware' | 'PasswordHash' | 'SBOM' | string (Required, DeployTimeConstant): The resource name
...
## Resource Microsoft.IoTFirmwareDefense/workspaces/usageMetrics@2025-12-01-preview (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-12-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
