# Microsoft.Discovery @ 2026-06-01

## Resource Microsoft.Discovery/bookshelves@2026-06-01
...
## Resource Microsoft.Discovery/bookshelves/privateEndpointConnections@2026-06-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-06-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Discovery/bookshelves/privateLinkResources@2026-06-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-06-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Discovery/storageContainers@2026-06-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-06-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Discovery/storageContainers/storageAssets@2026-06-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-06-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Discovery/supercomputers@2026-06-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-06-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Discovery/supercomputers/nodePools@2026-06-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-06-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Discovery/tools@2026-06-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-06-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Discovery/workspaces@2026-06-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-06-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Discovery/workspaces/chatModelDeployments@2026-06-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-06-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Discovery/workspaces/privateEndpointConnections@2026-06-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-06-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Discovery/workspaces/privateLinkResources@2026-06-01 (ReadOnly)
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-06-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
## Resource Microsoft.Discovery/workspaces/projects@2026-06-01
* **Valid Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-06-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
...
### Properties
* **capacity**: int {minValue: 1}: Provisioned SKU capacity units for this chat model deployment.
...
* **modelVersion**: string: Provider-published version of the selected model.
* **provisioningState**: 'Accepted' | 'Canceled' | 'Deleting' | 'Failed' | 'Provisioning' | 'Succeeded' | 'Updating' | string (ReadOnly): The status of the last operation.
* **skuName**: string: SKU tier used by this chat model deployment.
...
## NodePoolProperties
### Properties
* **imageCacheLowerThreshold**: int {minValue: 0, maxValue: 100}: The percent of disk usage before which image garbage collection is never run. This cannot be set higher than imageCacheUpperThreshold. The default is 40%
* **imageCacheUpperThreshold**: int {minValue: 0, maxValue: 100}: The percent of disk usage after which image garbage collection is guaranteed to run. The default is 60%
* **maxNodeCount**: int {minValue: 1} (Required): The maximum number of nodes.
* **minNodeCount**: int {minValue: 0}: The minimum number of nodes.
* **osDiskSizeGb**: int {minValue: 30, maxValue: 2048}: The size of the OS disk in GB. If not specified, the default is 120 GB.
* **provisioningState**: 'Accepted' | 'Canceled' | 'Deleting' | 'Failed' | 'Provisioning' | 'Succeeded' | 'Updating' | string (ReadOnly): The status of the last operation.
...
* **mountProtocol**: 'NFS' | string: The protocol to use for mounting the storage store.
...
* **mountProtocol**: 'BlobfuseCaching' | 'NFS' | string: The protocol to use for mounting the storage store.
